...
namespace Win32
{
	extension Win32
	{
		...
		public struct ITaskTrigger : IUnknown
		{
			...
			public HResult GetTriggerString(out char16* ppwszTrigger) mut => VT.GetTriggerString(ref this, out ppwszTrigger);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskTrigger self, out char16* ppwszTrigger) GetTriggerString;
			}
		}
		[CRepr]
		public struct IScheduledWorkItem : IUnknown
		{
			...
			public HResult GetTriggerString(uint16 iTrigger, out char16* ppwszTrigger) mut => VT.GetTriggerString(ref this, iTrigger, out ppwszTrigger);
			...
			public HResult SetComment(char16* pwszComment) mut => VT.SetComment(ref this, pwszComment);
			public HResult GetComment(out char16* ppwszComment) mut => VT.GetComment(ref this, out ppwszComment);
			public HResult SetCreator(char16* pwszCreator) mut => VT.SetCreator(ref this, pwszCreator);
			public HResult GetCreator(out char16* ppwszCreator) mut => VT.GetCreator(ref this, out ppwszCreator);
			...
			public HResult SetAccountInformation(char16* pwszAccountName, char16* pwszPassword) mut => VT.SetAccountInformation(ref this, pwszAccountName, pwszPassword);
			public HResult GetAccountInformation(out char16* ppwszAccountName) mut => VT.GetAccountInformation(ref this, out ppwszAccountName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, uint16 iTrigger, out char16* ppwszTrigger) GetTriggerString;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, char16* pwszComment) SetComment;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, out char16* ppwszComment) GetComment;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, char16* pwszCreator) SetCreator;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, out char16* ppwszCreator) GetCreator;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, char16* pwszAccountName, char16* pwszPassword) SetAccountInformation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScheduledWorkItem self, out char16* ppwszAccountName) GetAccountInformation;
			}
		}
		[CRepr]
		public struct ITask : IScheduledWorkItem
		{
			...
			public HResult SetApplicationName(char16* pwszApplicationName) mut => VT.SetApplicationName(ref this, pwszApplicationName);
			public HResult GetApplicationName(out char16* ppwszApplicationName) mut => VT.GetApplicationName(ref this, out ppwszApplicationName);
			public HResult SetParameters(char16* pwszParameters) mut => VT.SetParameters(ref this, pwszParameters);
			public HResult GetParameters(out char16* ppwszParameters) mut => VT.GetParameters(ref this, out ppwszParameters);
			public HResult SetWorkingDirectory(char16* pwszWorkingDirectory) mut => VT.SetWorkingDirectory(ref this, pwszWorkingDirectory);
			public HResult GetWorkingDirectory(out char16* ppwszWorkingDirectory) mut => VT.GetWorkingDirectory(ref this, out ppwszWorkingDirectory);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, char16* pwszApplicationName) SetApplicationName;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, out char16* ppwszApplicationName) GetApplicationName;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, char16* pwszParameters) SetParameters;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, out char16* ppwszParameters) GetParameters;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, char16* pwszWorkingDirectory) SetWorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITask self, out char16* ppwszWorkingDirectory) GetWorkingDirectory;
		...
		public struct IEnumWorkItems : IUnknown
		{
			...
			public HResult Next(uint32 celt, out char16** rgpwszNames, out uint32 pceltFetched) mut => VT.Next(ref this, celt, out rgpwszNames, out pceltFetched);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IEnumWorkItems self, uint32 celt, out char16** rgpwszNames, out uint32 pceltFetched) Next;
		...
		public struct ITaskScheduler : IUnknown
		{
			...
			public HResult SetTargetComputer(char16* pwszComputer) mut => VT.SetTargetComputer(ref this, pwszComputer);
			public HResult GetTargetComputer(out char16* ppwszComputer) mut => VT.GetTargetComputer(ref this, out ppwszComputer);
			public HResult Enum(out IEnumWorkItems* ppEnumWorkItems) mut => VT.Enum(ref this, out ppEnumWorkItems);
			public HResult Activate(char16* pwszName, in Guid riid, out IUnknown* ppUnk) mut => VT.Activate(ref this, pwszName, riid, out ppUnk);
			public HResult Delete(char16* pwszName) mut => VT.Delete(ref this, pwszName);
			public HResult NewWorkItem(char16* pwszTaskName, in Guid rclsid, in Guid riid, out IUnknown* ppUnk) mut => VT.NewWorkItem(ref this, pwszTaskName, rclsid, riid, out ppUnk);
			public HResult AddWorkItem(char16* pwszTaskName, ref IScheduledWorkItem pWorkItem) mut => VT.AddWorkItem(ref this, pwszTaskName, ref pWorkItem);
			public HResult IsOfType(char16* pwszName, in Guid riid) mut => VT.IsOfType(ref this, pwszName, riid);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszComputer) SetTargetComputer;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, out char16* ppwszComputer) GetTargetComputer;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, out IEnumWorkItems* ppEnumWorkItems) Enum;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszName, in Guid riid, out IUnknown* ppUnk) Activate;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszName) Delete;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszTaskName, in Guid rclsid, in Guid riid, out IUnknown* ppUnk) NewWorkItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszTaskName, ref IScheduledWorkItem pWorkItem) AddWorkItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskScheduler self, char16* pwszName, in Guid riid) IsOfType;
			}
		}
		[CRepr]
		public struct IProvideTaskPage : IUnknown
		{
			...
			public HResult GetPage(TASKPAGE tpType, IntBool fPersistChanges, out HPROPSHEETPAGE phPage) mut => VT.GetPage(ref this, tpType, fPersistChanges, out phPage);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IProvideTaskPage self, TASKPAGE tpType, IntBool fPersistChanges, out HPROPSHEETPAGE phPage) GetPage;
			}
		}
		[CRepr]
