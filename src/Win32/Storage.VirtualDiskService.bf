...
namespace Win32
{
	extension Win32
	{
		...
		public struct VDS_LUN_INFORMATION
		{
			...
			public IntBool m_bCommandQueueing;
		...
		public struct VDS_HINTS
		{
			...
			public IntBool bFastCrashRecoveryRequired;
			public IntBool bMostlyReads;
			public IntBool bOptimizeForSequentialReads;
			public IntBool bOptimizeForSequentialWrites;
			public IntBool bRemapEnabled;
			public IntBool bReadBackVerifyEnabled;
			public IntBool bWriteThroughCachingEnabled;
			public IntBool bHardwareChecksumEnabled;
			public IntBool bIsYankable;
			public int16 sRebuildPriority;
		}
		[CRepr]
		public struct VDS_HINTS2
		{
			...
			public IntBool bHardwareChecksumEnabled;
			public IntBool bIsYankable;
			public IntBool bAllocateHotSpare;
			public IntBool bUseMirroredCache;
			public IntBool bReadCachingEnabled;
			public IntBool bWriteCachingEnabled;
			public IntBool bMediaScanEnabled;
			public IntBool bConsistencyCheckEnabled;
			public VDS_STORAGE_BUS_TYPE BusType;
			public IntBool bReserved1;
			public IntBool bReserved2;
			public IntBool bReserved3;
			public int16 sRebuildPriority;
		}
		[CRepr]
		public struct VDS_SUB_SYSTEM_PROP
		{
			...
			public char16* pwszIdentification;
			public uint32 ulFlags;
			public uint32 ulStripeSizeFlags;
		...
		public struct VDS_LUN_PROP
		{
			...
			public char16* pwszFriendlyName;
			public char16* pwszIdentification;
			public char16* pwszUnmaskingList;
			public uint32 ulFlags;
		...
		{
			public Guid id;
			public char16* pwszIscsiName;
			public char16* pwszFriendlyName;
			public IntBool bChapEnabled;
		}
		[CRepr]
		...
		public struct VDS_POOL_ATTRIBUTES
		{
			...
			public VDS_STORAGE_BUS_TYPE busType;
			public char16* pwszIntendedUsage;
			public IntBool bSpinDown;
			public IntBool bIsThinProvisioned;
			public uint64 ullProvisionedSpace;
			public IntBool bNoSinglePointOfFailure;
		...
		public struct IVdsProviderPrivate : IUnknown
		{
			...
			public HResult OnLoad(char16* pwszMachineName, IUnknown* pCallbackObject) mut => VT.OnLoad(ref this, pwszMachineName, pCallbackObject);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsProviderPrivate self, char16* pwszMachineName, IUnknown* pCallbackObject) OnLoad;
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsProviderPrivate self, IntBool bForceUnload) OnUnload;
			}
		}
		[CRepr]
		...
		public struct IVdsHwProviderStoragePools : IUnknown
		{
			...
			public HResult CreateLunInStoragePool(VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid StoragePoolId, char16* pwszUnmaskingList, VDS_HINTS2* pHints2, IVdsAsync** ppAsync) mut => VT.CreateLunInStoragePool(ref this, type, ullSizeInBytes, StoragePoolId, pwszUnmaskingList, pHints2, ppAsync);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsHwProviderStoragePools self, VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid StoragePoolId, char16* pwszUnmaskingList, VDS_HINTS2* pHints2, IVdsAsync** ppAsync) CreateLunInStoragePool;
		...
		public struct IVdsSubSystem : IUnknown
		{
			...
			public HResult CreateLun(VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid* pDriveIdArray, int32 lNumberOfDrives, char16* pwszUnmaskingList, VDS_HINTS* pHints, IVdsAsync** ppAsync) mut => VT.CreateLun(ref this, type, ullSizeInBytes, pDriveIdArray, lNumberOfDrives, pwszUnmaskingList, pHints, ppAsync);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsSubSystem self, VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid* pDriveIdArray, int32 lNumberOfDrives, char16* pwszUnmaskingList, VDS_HINTS* pHints, IVdsAsync** ppAsync) CreateLun;
		...
		public struct IVdsSubSystem2 : IUnknown
		{
			...
			public HResult CreateLun2(VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid* pDriveIdArray, int32 lNumberOfDrives, char16* pwszUnmaskingList, VDS_HINTS2* pHints2, IVdsAsync** ppAsync) mut => VT.CreateLun2(ref this, type, ullSizeInBytes, pDriveIdArray, lNumberOfDrives, pwszUnmaskingList, pHints2, ppAsync);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsSubSystem2 self, VDS_LUN_TYPE type, uint64 ullSizeInBytes, Guid* pDriveIdArray, int32 lNumberOfDrives, char16* pwszUnmaskingList, VDS_HINTS2* pHints2, IVdsAsync** ppAsync) CreateLun2;
		...
		public struct IVdsSubSystemNaming : IUnknown
		{
			...
			public HResult SetFriendlyName(char16* pwszFriendlyName) mut => VT.SetFriendlyName(ref this, pwszFriendlyName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsSubSystemNaming self, char16* pwszFriendlyName) SetFriendlyName;
			}
		}
		[CRepr]
		public struct IVdsSubSystemIscsi : IUnknown
		{
			...
			public HResult CreateTarget(char16* pwszIscsiName, char16* pwszFriendlyName, IVdsAsync** ppAsync) mut => VT.CreateTarget(ref this, pwszIscsiName, pwszFriendlyName, ppAsync);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsSubSystemIscsi self, char16* pwszIscsiName, char16* pwszFriendlyName, IVdsAsync** ppAsync) CreateTarget;
		...
		public struct IVdsLun : IUnknown
		{
			...
			public HResult SetMask(char16* pwszUnmaskingList) mut => VT.SetMask(ref this, pwszUnmaskingList);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsLun self, char16* pwszUnmaskingList) SetMask;
		...
		public struct IVdsLunNaming : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsLunNaming self, char16* pwszFriendlyName) SetFriendlyName;
			}
		}
		[CRepr]
		...
		public struct IVdsIscsiTarget : IUnknown
		{
			...
			public HResult SetFriendlyName(char16* pwszFriendlyName) mut => VT.SetFriendlyName(ref this, pwszFriendlyName);
			public HResult SetSharedSecret(VDS_ISCSI_SHARED_SECRET* pTargetSharedSecret, char16* pwszInitiatorName) mut => VT.SetSharedSecret(ref this, pTargetSharedSecret, pwszInitiatorName);
			public HResult RememberInitiatorSharedSecret(char16* pwszInitiatorName, VDS_ISCSI_SHARED_SECRET* pInitiatorSharedSecret) mut => VT.RememberInitiatorSharedSecret(ref this, pwszInitiatorName, pInitiatorSharedSecret);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsIscsiTarget self, char16* pwszFriendlyName) SetFriendlyName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsIscsiTarget self, VDS_ISCSI_SHARED_SECRET* pTargetSharedSecret, char16* pwszInitiatorName) SetSharedSecret;
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsIscsiTarget self, char16* pwszInitiatorName, VDS_ISCSI_SHARED_SECRET* pInitiatorSharedSecret) RememberInitiatorSharedSecret;
		...
		public struct IVdsHwProviderPrivate : IUnknown
		{
			...
			public HResult QueryIfCreatedLun(char16* pwszDevicePath, ref VDS_LUN_INFORMATION pVdsLunInformation, out Guid pLunId) mut => VT.QueryIfCreatedLun(ref this, pwszDevicePath, ref pVdsLunInformation, out pLunId);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsHwProviderPrivate self, char16* pwszDevicePath, ref VDS_LUN_INFORMATION pVdsLunInformation, out Guid pLunId) QueryIfCreatedLun;
			}
		}
		[CRepr]
		...
		public struct IVdsAdmin : IUnknown
		{
			...
			public HResult RegisterProvider(Guid providerId, Guid providerClsid, char16* pwszName, VDS_PROVIDER_TYPE type, char16* pwszMachineName, char16* pwszVersion, Guid guidVersionId) mut => VT.RegisterProvider(ref this, providerId, providerClsid, pwszName, type, pwszMachineName, pwszVersion, guidVersionId);
			public HResult UnregisterProvider(Guid providerId) mut => VT.UnregisterProvider(ref this, providerId);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IVdsAdmin self, Guid providerId, Guid providerClsid, char16* pwszName, VDS_PROVIDER_TYPE type, char16* pwszMachineName, char16* pwszVersion, Guid guidVersionId) RegisterProvider;
