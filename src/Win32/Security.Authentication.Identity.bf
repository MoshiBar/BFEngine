...
namespace Win32
{
	extension Win32
	{
		...
		public function bool PSAM_INIT_NOTIFICATION_ROUTINE();
		public function bool PSAM_PASSWORD_FILTER_ROUTINE(ref UNICODE_STRING AccountName, ref UNICODE_STRING FullName, ref UNICODE_STRING Password, bool SetOperation);
		...
		public function int32 CHANGE_PASSWORD_FN_W(out uint16 param0, out uint16 param1, out uint16 param2, out uint16 param3, out uint16 param4, bool param5, uint32 param6, out SecBufferDesc param7);
		public function int32 CHANGE_PASSWORD_FN_A(out int8 param0, out int8 param1, out int8 param2, out int8 param3, out int8 param4, bool param5, uint32 param6, out SecBufferDesc param7);
		...
		public function NTSTATUS PLSA_GET_CREDENTIALS(ref LUID LogonId, uint32 AuthenticationPackage, out uint32 QueryContext, bool RetrieveAllCredentials, ref STRING PrimaryKeyValue, out uint32 PrimaryKeyLength, ref STRING Credentials);
		...
		public function bool PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE(out UNICODE_STRING CredentialName);
		...
		public function NTSTATUS PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS(ref LUID LogonId, uint32 SupplementalCredSize, void* SupplementalCreds, bool Synchronous);
		...
		public function bool PLSA_GET_CALL_INFO(out SECPKG_CALL_INFO Info);
		...
		public function bool PLSA_DELETE_SHARED_MEMORY(void* SharedMem);
		public function NTSTATUS PLSA_GET_APP_MODE_INFO(uint32* UserFunction, uint* Argument1, uint* Argument2, SecBuffer* UserData, bool* ReturnToLsa);
		public function NTSTATUS PLSA_SET_APP_MODE_INFO(uint32 UserFunction, uint Argument1, uint Argument2, SecBuffer* UserData, bool ReturnToLsa);
		public function NTSTATUS PLSA_OPEN_SAM_USER(ref UNICODE_STRING Name, SECPKG_NAME_TYPE NameType, ref UNICODE_STRING Prefix, bool AllowGuest, uint32 Reserved, void** UserHandle);
		...
		public function NTSTATUS PLSA_CRACK_SINGLE_NAME(uint32 FormatOffered, bool PerformAtGC, ref UNICODE_STRING NameInput, UNICODE_STRING* Prefix, uint32 RequestedFormat, out UNICODE_STRING CrackedName, out UNICODE_STRING DnsDomainName, out uint32 SubStatus);
		public function NTSTATUS PLSA_AUDIT_ACCOUNT_LOGON(uint32 AuditId, bool Success, UNICODE_STRING* Source, UNICODE_STRING* ClientName, UNICODE_STRING* MappedName, NTSTATUS Status);
		public function NTSTATUS PLSA_CLIENT_CALLBACK(char8* Callback, uint Argument1, uint Argument2, ref SecBuffer Input, out SecBuffer Output);
		...
		public function NTSTATUS PLSA_CHECK_PROTECTED_USER_BY_TOKEN(Handle UserToken, out bool ProtectedUser);
		public function NTSTATUS PLSA_QUERY_CLIENT_REQUEST(void** ClientRequest, uint32 QueryType, void** ReplyBuffer);
		public function NTSTATUS CredReadFn(ref LUID LogonId, uint32 CredFlags, char16* TargetName, uint32 Type, uint32 Flags, out ENCRYPTED_CREDENTIALW* Credential);
		...
		public function NTSTATUS CrediUnmarshalandDecodeStringFn(char16* MarshaledString, out uint8* Blob, out uint32 BlobSize, out uint8 IsFailureFatal);
		...
		public function NTSTATUS SpChangeAccountPasswordFn(ref UNICODE_STRING pDomainName, ref UNICODE_STRING pAccountName, ref UNICODE_STRING pOldPassword, ref UNICODE_STRING pNewPassword, bool Impersonating, out SecBufferDesc pOutput);
		...
		public function NTSTATUS PKSEC_REFERENCE_LIST_ENTRY(ref KSEC_LIST_ENTRY Entry, uint32 Signature, bool RemoveNoRef);
		...
		public function NTSTATUS KspSetPagingModeFn(bool PagingMode);
		public function NTSTATUS KspSerializeAuthDataFn(void* pvAuthData, out uint32 Size, void** SerializedData);
		public function IntBool SSL_EMPTY_CACHE_FN_A(char8* pszTargetName, uint32 dwFlags);
		public function IntBool SSL_EMPTY_CACHE_FN_W(char16* pszTargetName, uint32 dwFlags);
		public function IntBool SSL_CRACK_CERTIFICATE_FN(out uint8 pbCertificate, uint32 cbCertificate, IntBool VerifySignature, out X509Certificate* ppCertificate);
		...
		public struct POLICY_AUDIT_LOG_INFO
		{
			...
			public bool AuditLogFullShutdownInProgress;
		...
		public struct SecPkgCred_ClientCertPolicy
		{
			...
			public IntBool fCheckRevocationFreshnessTime;
			public uint32 dwRevocationFreshnessTime;
			public IntBool fOmitUsageCheck;
			public char16* pwszSslCtlStoreName;
			public char16* pwszSslCtlIdentifier;
		}
		[CRepr]
		...
		public struct SecPkgContext_CertInfo
		{
			...
			public char16* pwszSubjectName;
			public uint32 cbIssuerName;
			public char16* pwszIssuerName;
		...
		public struct X509Certificate
		{
			...
			public char8* pszIssuer;
			public char8* pszSubject;
		...
		public struct SL_AD_ACTIVATION_INFO
		{
			...
			public char16* pwszProductKey;
			public char16* pwszActivationObjectName;
		}
		[CRepr]
		...
		public struct ICcgDomainAuthCredentials : IUnknown
		{
			...
			public HResult GetPasswordCredentials(char16* pluginInput, out char16* domainName, out char16* username, out char16* password) mut => VT.GetPasswordCredentials(ref this, pluginInput, out domainName, out username, out password);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ICcgDomainAuthCredentials self, char16* pluginInput, out char16* domainName, out char16* username, out char16* password) GetPasswordCredentials;
			}
		}
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS LsaRemoveAccountRights(void* PolicyHandle, PSID AccountSid, bool AllRights, UNICODE_STRING* UserRights, uint32 CountOfRights);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS LsaSetForestTrustInformation(void* PolicyHandle, ref UNICODE_STRING TrustedDomainName, ref LSA_FOREST_TRUST_INFORMATION ForestTrustInfo, bool CheckOnly, out LSA_FOREST_TRUST_COLLISION_INFORMATION* CollisionInfo);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool SystemFunction036(void* RandomBuffer, uint32 RandomBufferLength);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditSetSystemPolicy(AUDIT_POLICY_INFORMATION* pAuditPolicy, uint32 dwPolicyCount);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditSetPerUserPolicy(PSID pSid, AUDIT_POLICY_INFORMATION* pAuditPolicy, uint32 dwPolicyCount);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditQuerySystemPolicy(Guid* pSubCategoryGuids, uint32 dwPolicyCount, out AUDIT_POLICY_INFORMATION* ppAuditPolicy);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditQueryPerUserPolicy(PSID pSid, Guid* pSubCategoryGuids, uint32 dwPolicyCount, out AUDIT_POLICY_INFORMATION* ppAuditPolicy);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditEnumeratePerUserPolicy(out POLICY_AUDIT_SID_ARRAY* ppAuditSidArray);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditComputeEffectivePolicyBySid(PSID pSid, Guid* pSubCategoryGuids, uint32 dwPolicyCount, out AUDIT_POLICY_INFORMATION* ppAuditPolicy);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditComputeEffectivePolicyByToken(Handle hTokenHandle, Guid* pSubCategoryGuids, uint32 dwPolicyCount, out AUDIT_POLICY_INFORMATION* ppAuditPolicy);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditEnumerateCategories(out Guid* ppAuditCategoriesArray, out uint32 pdwCountReturned);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditEnumerateSubCategories(Guid* pAuditCategoryGuid, bool bRetrieveAllSubCategories, out Guid* ppAuditSubCategoriesArray, out uint32 pdwCountReturned);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditLookupCategoryNameW(in Guid pAuditCategoryGuid, out char16* ppszCategoryName);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditLookupCategoryNameA(in Guid pAuditCategoryGuid, out char8* ppszCategoryName);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditLookupSubCategoryNameW(in Guid pAuditSubCategoryGuid, out char16* ppszSubCategoryName);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditLookupSubCategoryNameA(in Guid pAuditSubCategoryGuid, out char8* ppszSubCategoryName);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditSetSecurity(uint32 SecurityInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditQuerySecurity(uint32 SecurityInformation, out SECURITY_DESCRIPTOR* ppSecurityDescriptor);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditSetGlobalSaclW(char16* ObjectTypeName, ACL* Acl);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditSetGlobalSaclA(char8* ObjectTypeName, ACL* Acl);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditQueryGlobalSaclW(char16* ObjectTypeName, out ACL* Acl);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern bool AuditQueryGlobalSaclA(char8* ObjectTypeName, out ACL* Acl);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void AuditFree(void* Buffer);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AcquireCredentialsHandleW(char16* pszPrincipal, char16* pszPackage, SECPKG_CRED fCredentialUse, void* pvLogonId, void* pAuthData, SEC_GET_KEY_FN pGetKeyFn, void* pvGetKeyArgument, out SecHandle phCredential, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AcquireCredentialsHandleA(char8* pszPrincipal, char8* pszPackage, SECPKG_CRED fCredentialUse, void* pvLogonId, void* pAuthData, SEC_GET_KEY_FN pGetKeyFn, void* pvGetKeyArgument, out SecHandle phCredential, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 FreeCredentialsHandle(ref SecHandle phCredential);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AddCredentialsW(ref SecHandle hCredentials, char16* pszPrincipal, char16* pszPackage, uint32 fCredentialUse, void* pAuthData, SEC_GET_KEY_FN pGetKeyFn, void* pvGetKeyArgument, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AddCredentialsA(ref SecHandle hCredentials, char8* pszPrincipal, char8* pszPackage, uint32 fCredentialUse, void* pAuthData, SEC_GET_KEY_FN pGetKeyFn, void* pvGetKeyArgument, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ChangeAccountPasswordW(ref uint16 pszPackageName, ref uint16 pszDomainName, ref uint16 pszAccountName, ref uint16 pszOldPassword, ref uint16 pszNewPassword, bool bImpersonating, uint32 dwReserved, out SecBufferDesc pOutput);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ChangeAccountPasswordA(ref int8 pszPackageName, ref int8 pszDomainName, ref int8 pszAccountName, ref int8 pszOldPassword, ref int8 pszNewPassword, bool bImpersonating, uint32 dwReserved, out SecBufferDesc pOutput);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 QuerySecurityPackageInfoW(char16* pszPackageName, out SecPkgInfoW* ppPackageInfo);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 QuerySecurityPackageInfoA(char8* pszPackageName, out SecPkgInfoA* ppPackageInfo);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ImportSecurityContextW(char16* pszPackage, ref SecBuffer pPackedContext, void* Token, out SecHandle phContext);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ImportSecurityContextA(char8* pszPackage, ref SecBuffer pPackedContext, void* Token, out SecHandle phContext);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslEnumerateProfilesA(out char8* ProfileList, out uint32 ProfileCount);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslEnumerateProfilesW(out char16* ProfileList, out uint32 ProfileCount);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslGetProfilePackageA(char8* ProfileName, out SecPkgInfoA* PackageInfo);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslGetProfilePackageW(char16* ProfileName, out SecPkgInfoW* PackageInfo);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslInitializeSecurityContextW(SecHandle* phCredential, SecHandle* phContext, char16* pszTargetName, uint32 fContextReq, uint32 Reserved1, uint32 TargetDataRep, SecBufferDesc* pInput, uint32 Reserved2, SecHandle* phNewContext, SecBufferDesc* pOutput, out uint32 pfContextAttr, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SaslInitializeSecurityContextA(SecHandle* phCredential, SecHandle* phContext, char8* pszTargetName, uint32 fContextReq, uint32 Reserved1, uint32 TargetDataRep, SecBufferDesc* pInput, uint32 Reserved2, SecHandle* phNewContext, SecBufferDesc* pOutput, out uint32 pfContextAttr, LARGE_INTEGER* ptsExpiry);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		public static extern uint32 SspiPromptForCredentialsW(char16* pszTargetName, void* pUiInfo, uint32 dwAuthError, char16* pszPackage, void* pInputAuthIdentity, void** ppAuthIdentity, int32* pfSave, uint32 dwFlags);
		[Import("credui.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 SspiPromptForCredentialsA(char8* pszTargetName, void* pUiInfo, uint32 dwAuthError, char8* pszPackage, void* pInputAuthIdentity, void** ppAuthIdentity, int32* pfSave, uint32 dwFlags);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiPrepareForCredRead(void* AuthIdentity, char16* pszTargetName, out uint32 pCredmanCredentialType, out char16* ppszCredmanTargetName);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiPrepareForCredWrite(void* AuthIdentity, char16* pszTargetName, out uint32 pCredmanCredentialType, out char16* ppszCredmanTargetName, out char16* ppszCredmanUserName, out uint8* ppCredentialBlob, out uint32 pCredentialBlobSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool SspiIsAuthIdentityEncrypted(void* EncryptedAuthData);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiEncodeAuthIdentityAsStrings(void* pAuthIdentity, char16** ppszUserName, char16** ppszDomainName, char16** ppszPackedCredentialsString);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiEncodeStringsAsAuthIdentity(char16* pszUserName, char16* pszDomainName, char16* pszPackedCredentialsString, void** ppAuthIdentity);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiCompareAuthIdentities(void* AuthIdentity1, void* AuthIdentity2, bool* SameSuppliedUser, bool* SameSuppliedIdentity);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiUnmarshalAuthIdentity(uint32 AuthIdentityLength, char8* AuthIdentityByteArray, void** ppAuthIdentity);
		[Import("credui.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool SspiIsPromptingNeeded(uint32 ErrorOrNtStatus);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiGetTargetHostName(char16* pszTargetName, out char16* pszHostName);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SspiExcludePackage(void* AuthIdentity, char16* pszPackageName, void** ppNewAuthIdentity);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AddSecurityPackageA(char8* pszPackageName, SECURITY_PACKAGE_OPTIONS* pOptions);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 AddSecurityPackageW(char16* pszPackageName, SECURITY_PACKAGE_OPTIONS* pOptions);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 DeleteSecurityPackageA(char8* pszPackageName);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 DeleteSecurityPackageW(char16* pszPackageName);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		public static extern IntBool SslEmptyCacheA(char8* pszTargetName, uint32 dwFlags);
		[Import("schannel.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SslEmptyCacheW(char16* pszTargetName, uint32 dwFlags);
		[Import("schannel.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void SslGenerateRandomBits(out uint8 pRandomData, int32 cRandomData);
		[Import("schannel.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SslCrackCertificate(out uint8 pbCertificate, uint32 cbCertificate, uint32 dwFlags, out X509Certificate* ppCertificate);
		[Import("schannel.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("tokenbinding.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 TokenBindingDeleteBinding(char16* targetURL);
		[Import("tokenbinding.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("tokenbinding.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 TokenBindingGenerateIDForUri(TOKENBINDING_KEY_PARAMETERS_TYPE keyType, char16* targetUri, out TOKENBINDING_RESULT_DATA* resultData);
		[Import("tokenbinding.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 TokenBindingGetHighestSupportedVersion(out uint8 majorVersion, out uint8 minorVersion);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool GetUserNameExA(EXTENDED_NAME_FORMAT NameFormat, uint8* lpNameBuffer, out uint32 nSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool GetUserNameExW(EXTENDED_NAME_FORMAT NameFormat, char16* lpNameBuffer, out uint32 nSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool GetComputerObjectNameA(EXTENDED_NAME_FORMAT NameFormat, uint8* lpNameBuffer, out uint32 nSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool GetComputerObjectNameW(EXTENDED_NAME_FORMAT NameFormat, char16* lpNameBuffer, out uint32 nSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool TranslateNameA(char8* lpAccountName, EXTENDED_NAME_FORMAT AccountNameFormat, EXTENDED_NAME_FORMAT DesiredNameFormat, uint8* lpTranslatedName, out uint32 nSize);
		[Import("secur32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool TranslateNameW(char16* lpAccountName, EXTENDED_NAME_FORMAT AccountNameFormat, EXTENDED_NAME_FORMAT DesiredNameFormat, char16* lpTranslatedName, out uint32 nSize);
		...
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLInstallProofOfPurchase(void* hSLC, char16* pwszPKeyAlgorithm, char16* pwszPKeyString, uint32 cbPKeySpecificData, uint8* pbPKeySpecificData, out Guid pPkeyId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLConsumeRight(void* hSLC, in Guid pAppId, Guid* pProductSkuId, char16* pwszRightName, void* pvReserved);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetProductSkuInformation(void* hSLC, in Guid pProductSkuId, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetPKeyInformation(void* hSLC, in Guid pPKeyId, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetLicenseInformation(void* hSLC, in Guid pSLLicenseId, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetLicensingStatusInformation(void* hSLC, Guid* pAppID, Guid* pProductSkuId, char16* pwszRightName, out uint32 pnStatusCount, out SL_LICENSING_STATUS* ppLicensingStatus);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetPolicyInformation(void* hSLC, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetPolicyInformationDWORD(void* hSLC, char16* pwszValueName, out uint32 pdwValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetServiceInformation(void* hSLC, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetApplicationInformation(void* hSLC, in Guid pApplicationId, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slcext.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLActivateProduct(void* hSLC, in Guid pProductSkuId, uint32 cbAppSpecificData, void* pvAppSpecificData, SL_ACTIVATION_INFO_HEADER* pActivationInfo, char16* pwszProxyServer, uint16 wProxyPort);
		[Import("slcext.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetServerStatus(char16* pwszServerURL, char16* pwszAcquisitionType, char16* pwszProxyServer, uint16 wProxyPort, out HResult phrStatus);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGenerateOfflineInstallationId(void* hSLC, in Guid pProductSkuId, out char16* ppwszInstallationId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGenerateOfflineInstallationIdEx(void* hSLC, Guid* pProductSkuId, SL_ACTIVATION_INFO_HEADER* pActivationInfo, out char16* ppwszInstallationId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLDepositOfflineConfirmationId(void* hSLC, in Guid pProductSkuId, char16* pwszInstallationId, char16* pwszConfirmationId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLDepositOfflineConfirmationIdEx(void* hSLC, Guid* pProductSkuId, SL_ACTIVATION_INFO_HEADER* pActivationInfo, char16* pwszInstallationId, char16* pwszConfirmationId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetPKeyId(void* hSLC, char16* pwszPKeyAlgorithm, char16* pwszPKeyString, uint32 cbPKeySpecificData, uint8* pbPKeySpecificData, out Guid pPKeyId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLFireEvent(void* hSLC, char16* pwszEventId, in Guid pApplicationId);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLRegisterEvent(void* hSLC, char16* pwszEventId, in Guid pApplicationId, Handle hEvent);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLUnregisterEvent(void* hSLC, char16* pwszEventId, in Guid pApplicationId, Handle hEvent);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetWindowsInformation(char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetWindowsInformationDWORD(char16* pwszValueName, out uint32 pdwValue);
		...
		[Import("slcext.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLAcquireGenuineTicket(void** ppTicketBlob, out uint32 pcbTicketBlob, char16* pwszTemplateId, char16* pwszServerUrl, char16* pwszClientToken);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLSetGenuineInformation(in Guid pQueryId, char16* pwszValueName, SLDATATYPE eDataType, uint32 cbValue, uint8* pbValue);
		[Import("slcext.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetReferralInformation(void* hSLC, SLREFERRALTYPE eReferralType, in Guid pSkuOrAppId, char16* pwszValueName, out char16* ppwszValue);
		[Import("slc.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLGetGenuineInformation(in Guid pQueryId, char16* pwszValueName, SLDATATYPE* peDataType, out uint32 pcbValue, out uint8* ppbValue);
		[Import("api-ms-win-core-slapi-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SLQueryLicenseValueFromApp(char16* valueName, uint32* valueType, void* dataBuffer, uint32 dataSize, out uint32 resultDataSize);
	}
}
