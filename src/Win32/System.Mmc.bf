...
namespace Win32
{
	extension Win32
	{
		...
		public struct MMCBUTTON
		{
			...
			public uint8 fsType;
			public char16* lpButtonText;
			public char16* lpTooltipText;
		}
		[CRepr]
		public struct RESULTDATAITEM
		{
			public uint32 mask;
			public IntBool bScopeItem;
			public int itemID;
			public int32 nIndex;
			public int32 nCol;
			public char16* str;
		...
		{
			public char16* strName;
			public char16* strStatusBarText;
		...
		public struct MMC_RESTORE_VIEW
		{
			...
			public int cookie;
			public char16* pViewType;
			public int32 lViewOptions;
		}
		[CRepr]
		public struct MMC_EXPANDSYNC_STRUCT
		{
			public IntBool bHandled;
			public IntBool bExpanding;
			public int hItem;
		}
		[CRepr]
		...
		{
			public char16* szFontFamilyName;
			public char16* szURLtoEOT;
			public char16* szSymbolString;
		}
		[CRepr]
		public struct MMC_TASK_DISPLAY_BITMAP
		{
			public char16* szMouseOverBitmap;
			public char16* szMouseOffBitmap;
		}
		[CRepr]
		...
		public struct MMC_TASK
		{
			...
			public char16* szText;
			public char16* szHelpString;
			...
			public struct _Anonymous_e__Union
			{
				...
				public char16* szActionURL;
				public char16* szScript;
			}
		}
		[CRepr]
		...
		{
			public char16* pstrPersistableViewDescription;
		...
		public struct CONTEXTMENUITEM2
		{
			...
			public int32 fFlags;
			public int32 fSpecialFlags;
			public char16* strLanguageIndependentName;
		}
		[CRepr]
		public struct MMC_EXT_VIEW_DATA
		{
			...
			public char16* pszViewTitle;
			public char16* pszTooltipText;
			public IntBool bReplacesDefaultView;
		}
		...
		public struct ISnapinPropertiesCallback : IUnknown
		{
			...
			public HResult AddPropertyName(char16* pszPropName, uint32 dwFlags) mut => VT.AddPropertyName(ref this, pszPropName, dwFlags);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinPropertiesCallback self, char16* pszPropName, uint32 dwFlags) AddPropertyName;
			}
		}
		[CRepr]
		public struct _Application : IDispatch
		{
			...
			public HResult get_Visible(out IntBool Visible) mut => VT.get_Visible(ref this, out Visible);
			public HResult Show() mut => VT.Show(ref this);
			public HResult Hide() mut => VT.Hide(ref this);
			public HResult get_UserControl(out IntBool UserControl) mut => VT.get_UserControl(ref this, out UserControl);
			public HResult put_UserControl(IntBool UserControl) mut => VT.put_UserControl(ref this, UserControl);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref _Application self, out IntBool Visible) get_Visible;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref _Application self, out IntBool UserControl) get_UserControl;
				public new function [CallingConvention(.Stdcall)] HResult(ref _Application self, IntBool UserControl) put_UserControl;
		...
		public struct _AppEvents : IDispatch
		{
			...
			public HResult OnDocumentOpen(ref Document Document, IntBool New) mut => VT.OnDocumentOpen(ref this, ref Document, New);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref _AppEvents self, ref Document Document, IntBool New) OnDocumentOpen;
		...
		public struct Node : IDispatch
		{
			...
			public HResult IsScopeNode(out IntBool IsScopeNode) mut => VT.IsScopeNode(ref this, out IsScopeNode);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Node self, out IntBool IsScopeNode) IsScopeNode;
		...
		public struct Document : IDispatch
		{
			...
			public HResult Close(IntBool SaveChanges) mut => VT.Close(ref this, SaveChanges);
			...
			public HResult get_IsSaved(out IntBool IsSaved) mut => VT.get_IsSaved(ref this, out IsSaved);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Document self, IntBool SaveChanges) Close;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Document self, out IntBool IsSaved) get_IsSaved;
		...
		public struct SnapIn : IDispatch
		{
			...
			public HResult EnableAllExtensions(IntBool Enable) mut => VT.EnableAllExtensions(ref this, Enable);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref SnapIn self, IntBool Enable) EnableAllExtensions;
			}
		}
		[CRepr]
		...
		public struct Extension : IDispatch
		{
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Extension self, IntBool Enable) EnableAllExtensions;
				public new function [CallingConvention(.Stdcall)] HResult(ref Extension self, IntBool Enable) Enable;
			}
		}
		[CRepr]
		...
		public struct Column : IDispatch
		{
			...
			public HResult get_Hidden(out IntBool Hidden) mut => VT.get_Hidden(ref this, out Hidden);
			public HResult put_Hidden(IntBool Hidden) mut => VT.put_Hidden(ref this, Hidden);
			public HResult SetAsSortColumn(_ColumnSortOrder SortOrder) mut => VT.SetAsSortColumn(ref this, SortOrder);
			public HResult IsSortColumn(out IntBool IsSortColumn) mut => VT.IsSortColumn(ref this, out IsSortColumn);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Column self, out IntBool Hidden) get_Hidden;
				public new function [CallingConvention(.Stdcall)] HResult(ref Column self, IntBool Hidden) put_Hidden;
				public new function [CallingConvention(.Stdcall)] HResult(ref Column self, _ColumnSortOrder SortOrder) SetAsSortColumn;
				public new function [CallingConvention(.Stdcall)] HResult(ref Column self, out IntBool IsSortColumn) IsSortColumn;
			}
		}
		[CRepr]
		...
		public struct View : IDispatch
		{
			...
			public HResult IsSelected(ref Node Node, out IntBool IsSelected) mut => VT.IsSelected(ref this, ref Node, out IsSelected);
			...
			public HResult get_ScopeTreeVisible(out IntBool Visible) mut => VT.get_ScopeTreeVisible(ref this, out Visible);
			public HResult put_ScopeTreeVisible(IntBool Visible) mut => VT.put_ScopeTreeVisible(ref this, Visible);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref View self, ref Node Node, out IntBool IsSelected) IsSelected;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref View self, out IntBool Visible) get_ScopeTreeVisible;
				public new function [CallingConvention(.Stdcall)] HResult(ref View self, IntBool Visible) put_ScopeTreeVisible;
		...
		public struct MenuItem : IDispatch
		{
			...
			public HResult get_Enabled(out IntBool Enabled) mut => VT.get_Enabled(ref this, out Enabled);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref MenuItem self, out IntBool Enabled) get_Enabled;
			}
		}
		[CRepr]
		...
		public struct IComponentAlt : IUnknown
		{
			...
			public HResult QueryDataObject(int cookie, DATA_OBJECT_TYPES type, out IDataObject* ppDataObject) mut => VT.QueryDataObject(ref this, cookie, type, out ppDataObject);
			public HResult GetResultViewType(int cookie, out char16* ppViewType, out int32 pViewOptions) mut => VT.GetResultViewType(ref this, cookie, out ppViewType, out pViewOptions);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IComponentAlt self, int cookie, out char16* ppViewType, out int32 pViewOptions) GetResultViewType;
		...
		public struct IConsole : IUnknown
		{
			...
			public HResult MessageBox(char16* lpszText, char16* lpszTitle, uint32 fuStyle, out int32 piRetval) mut => VT.MessageBox(ref this, lpszText, lpszTitle, fuStyle, out piRetval);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsole self, char16* lpszText, char16* lpszTitle, uint32 fuStyle, out int32 piRetval) MessageBox;
		...
		public struct IHeaderCtrl : IUnknown
		{
			...
			public HResult InsertColumn(int32 nCol, char16* title, int32 nFormat, int32 nWidth) mut => VT.InsertColumn(ref this, nCol, title, nFormat, nWidth);
			public HResult DeleteColumn(int32 nCol) mut => VT.DeleteColumn(ref this, nCol);
			public HResult SetColumnText(int32 nCol, char16* title) mut => VT.SetColumnText(ref this, nCol, title);
			public HResult GetColumnText(int32 nCol, out char16* pText) mut => VT.GetColumnText(ref this, nCol, out pText);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHeaderCtrl self, int32 nCol, char16* title, int32 nFormat, int32 nWidth) InsertColumn;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHeaderCtrl self, int32 nCol) DeleteColumn;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHeaderCtrl self, int32 nCol, char16* title) SetColumnText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHeaderCtrl self, int32 nCol, out char16* pText) GetColumnText;
		...
		public struct IResultData : IUnknown
		{
			...
			public HResult SetDescBarText(char16* DescText) mut => VT.SetDescBarText(ref this, DescText);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IResultData self, char16* DescText) SetDescBarText;
		...
		public struct IPropertySheetProvider : IUnknown
		{
			...
			public HResult CreatePropertySheet(char16* title, uint8 type, int cookie, ref IDataObject pIDataObjectm, uint32 dwOptions) mut => VT.CreatePropertySheet(ref this, title, type, cookie, ref pIDataObjectm, dwOptions);
			...
			public HResult AddPrimaryPages(IUnknown* lpUnknown, IntBool bCreateHandle, HWnd hNotifyWindow, IntBool bScopePane) mut => VT.AddPrimaryPages(ref this, lpUnknown, bCreateHandle, hNotifyWindow, bScopePane);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPropertySheetProvider self, char16* title, uint8 type, int cookie, ref IDataObject pIDataObjectm, uint32 dwOptions) CreatePropertySheet;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IPropertySheetProvider self, IUnknown* lpUnknown, IntBool bCreateHandle, HWnd hNotifyWindow, IntBool bScopePane) AddPrimaryPages;
		...
		public struct IToolbar : IUnknown
		{
			...
			public HResult GetButtonState(int32 idCommand, MMC_BUTTON_STATE nState, out IntBool pState) mut => VT.GetButtonState(ref this, idCommand, nState, out pState);
			public HResult SetButtonState(int32 idCommand, MMC_BUTTON_STATE nState, IntBool bState) mut => VT.SetButtonState(ref this, idCommand, nState, bState);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IToolbar self, int32 idCommand, MMC_BUTTON_STATE nState, out IntBool pState) GetButtonState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IToolbar self, int32 idCommand, MMC_BUTTON_STATE nState, IntBool bState) SetButtonState;
			}
		}
		[CRepr]
		public struct IConsoleVerb : IUnknown
		{
			...
			public HResult GetVerbState(MMC_CONSOLE_VERB eCmdID, MMC_BUTTON_STATE nState, out IntBool pState) mut => VT.GetVerbState(ref this, eCmdID, nState, out pState);
			public HResult SetVerbState(MMC_CONSOLE_VERB eCmdID, MMC_BUTTON_STATE nState, IntBool bState) mut => VT.SetVerbState(ref this, eCmdID, nState, bState);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsoleVerb self, MMC_CONSOLE_VERB eCmdID, MMC_BUTTON_STATE nState, out IntBool pState) GetVerbState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsoleVerb self, MMC_CONSOLE_VERB eCmdID, MMC_BUTTON_STATE nState, IntBool bState) SetVerbState;
		...
		public struct ISnapinAbout : IUnknown
		{
			...
			public HResult GetSnapinDescription(out char16* lpDescription) mut => VT.GetSnapinDescription(ref this, out lpDescription);
			public HResult GetProvider(out char16* lpName) mut => VT.GetProvider(ref this, out lpName);
			public HResult GetSnapinVersion(out char16* lpVersion) mut => VT.GetSnapinVersion(ref this, out lpVersion);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinAbout self, out char16* lpDescription) GetSnapinDescription;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinAbout self, out char16* lpName) GetProvider;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinAbout self, out char16* lpVersion) GetSnapinVersion;
		...
		public struct IMenuButton : IUnknown
		{
			...
			public HResult AddButton(int32 idCommand, char16* lpButtonText, char16* lpTooltipText) mut => VT.AddButton(ref this, idCommand, lpButtonText, lpTooltipText);
			public HResult SetButton(int32 idCommand, char16* lpButtonText, char16* lpTooltipText) mut => VT.SetButton(ref this, idCommand, lpButtonText, lpTooltipText);
			public HResult SetButtonState(int32 idCommand, MMC_BUTTON_STATE nState, IntBool bState) mut => VT.SetButtonState(ref this, idCommand, nState, bState);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IMenuButton self, int32 idCommand, char16* lpButtonText, char16* lpTooltipText) AddButton;
				public new function [CallingConvention(.Stdcall)] HResult(ref IMenuButton self, int32 idCommand, char16* lpButtonText, char16* lpTooltipText) SetButton;
				public new function [CallingConvention(.Stdcall)] HResult(ref IMenuButton self, int32 idCommand, MMC_BUTTON_STATE nState, IntBool bState) SetButtonState;
			}
		}
		[CRepr]
		public struct ISnapinHelp : IUnknown
		{
			...
			public HResult GetHelpTopic(out char16* lpCompiledHelpFile) mut => VT.GetHelpTopic(ref this, out lpCompiledHelpFile);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinHelp self, out char16* lpCompiledHelpFile) GetHelpTopic;
			}
		}
		[CRepr]
		public struct IExtendPropertySheet2 : IExtendPropertySheet
		{
			...
			public HResult GetWatermarks(ref IDataObject lpIDataObject, out HBITMAP lphWatermark, out HBITMAP lphHeader, out HPALETTE lphPalette, out IntBool bStretch) mut => VT.GetWatermarks(ref this, ref lpIDataObject, out lphWatermark, out lphHeader, out lphPalette, out bStretch);

			[CRepr]
			public struct VTable : IExtendPropertySheet.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendPropertySheet2 self, ref IDataObject lpIDataObject, out HBITMAP lphWatermark, out HBITMAP lphHeader, out HPALETTE lphPalette, out IntBool bStretch) GetWatermarks;
			}
		}
		[CRepr]
		...
		public struct ISnapinHelp2 : ISnapinHelp
		{
			...
			public HResult GetLinkedTopics(out char16* lpCompiledHelpFiles) mut => VT.GetLinkedTopics(ref this, out lpCompiledHelpFiles);

			[CRepr]
			public struct VTable : ISnapinHelp.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISnapinHelp2 self, out char16* lpCompiledHelpFiles) GetLinkedTopics;
			}
		}
		[CRepr]
		...
		public struct IExtendTaskPad : IUnknown
		{
			...
			public HResult EnumTasks(ref IDataObject pdo, char16* szTaskGroup, out IEnumTASK* ppEnumTASK) mut => VT.EnumTasks(ref this, ref pdo, szTaskGroup, out ppEnumTASK);
			public HResult GetTitle(char16* pszGroup, out char16* pszTitle) mut => VT.GetTitle(ref this, pszGroup, out pszTitle);
			public HResult GetDescriptiveText(char16* pszGroup, out char16* pszDescriptiveText) mut => VT.GetDescriptiveText(ref this, pszGroup, out pszDescriptiveText);
			public HResult GetBackground(char16* pszGroup, out MMC_TASK_DISPLAY_OBJECT pTDO) mut => VT.GetBackground(ref this, pszGroup, out pTDO);
			public HResult GetListPadInfo(char16* pszGroup, out MMC_LISTPAD_INFO lpListPadInfo) mut => VT.GetListPadInfo(ref this, pszGroup, out lpListPadInfo);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendTaskPad self, ref IDataObject pdo, char16* szTaskGroup, out IEnumTASK* ppEnumTASK) EnumTasks;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendTaskPad self, char16* pszGroup, out char16* pszTitle) GetTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendTaskPad self, char16* pszGroup, out char16* pszDescriptiveText) GetDescriptiveText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendTaskPad self, char16* pszGroup, out MMC_TASK_DISPLAY_OBJECT pTDO) GetBackground;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtendTaskPad self, char16* pszGroup, out MMC_LISTPAD_INFO lpListPadInfo) GetListPadInfo;
			}
		}
		[CRepr]
		public struct IConsole2 : IConsole
		{
			...
			public HResult Expand(int hItem, IntBool bExpand) mut => VT.Expand(ref this, hItem, bExpand);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsole2 self, int hItem, IntBool bExpand) Expand;
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsole2 self) IsTaskpadViewPreferred;
				public new function [CallingConvention(.Stdcall)] HResult(ref IConsole2 self, char16* pszStatusText) SetStatusText;
			}
		}
		[CRepr]
		public struct IDisplayHelp : IUnknown
		{
			...
			public HResult ShowTopic(char16* pszHelpTopic) mut => VT.ShowTopic(ref this, pszHelpTopic);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDisplayHelp self, char16* pszHelpTopic) ShowTopic;
			}
		}
		[CRepr]
		...
		public struct IStringTable : IUnknown
		{
			...
			public HResult AddString(char16* pszAdd, out uint32 pStringID) mut => VT.AddString(ref this, pszAdd, out pStringID);
			...
			public HResult FindString(char16* pszFind, out uint32 pStringID) mut => VT.FindString(ref this, pszFind, out pStringID);
			public HResult Enumerate(out IEnumString* ppEnum) mut => VT.Enumerate(ref this, out ppEnum);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IStringTable self, char16* pszAdd, out uint32 pStringID) AddString;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IStringTable self, char16* pszFind, out uint32 pStringID) FindString;
		...
		public struct IMessageView : IUnknown
		{
			...
			public HResult SetTitleText(char16* pszTitleText) mut => VT.SetTitleText(ref this, pszTitleText);
			public HResult SetBodyText(char16* pszBodyText) mut => VT.SetBodyText(ref this, pszBodyText);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IMessageView self, char16* pszTitleText) SetTitleText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IMessageView self, char16* pszBodyText) SetBodyText;
