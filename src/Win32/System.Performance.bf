...
namespace Win32
{
	extension Win32
	{
		...
		public function void PLA_CABEXTRACT_CALLBACK(char16* FileName, void* Context);
		...
		public function uint32 PM_OPEN_PROC(char16* pContext);
		public function uint32 PM_COLLECT_PROC(char16* pValueName, void** ppData, out uint32 pcbTotalBytes, out uint32 pNumObjectTypes);
		...
		{
			public char8* szMachineName;
			public char8* szObjectName;
			public char8* szInstanceName;
			public char8* szParentInstance;
			public uint32 dwInstanceIndex;
			public char8* szCounterName;
		}
		[CRepr]
		public struct PDH_COUNTER_PATH_ELEMENTS_W
		{
			public char16* szMachineName;
			public char16* szObjectName;
			public char16* szInstanceName;
			public char16* szParentInstance;
			public uint32 dwInstanceIndex;
			public char16* szCounterName;
		}
		[CRepr]
		...
		public struct PDH_COUNTER_INFO_A
		{
			...
			public char8* szFullPath;
			public _Anonymous_e__Union Anonymous;
			public char8* szExplainText;
		...
		public struct PDH_COUNTER_INFO_W
		{
			...
			public uint dwUserData;
			public uint dwQueryUserData;
			public char16* szFullPath;
			public _Anonymous_e__Union Anonymous;
			public char16* szExplainText;
			public uint32[0] DataBuffer;
		...
		public struct PDH_LOG_SERVICE_QUERY_INFO_A
		{
			...
			public char8* szLogFileCaption;
			public char8* szDefaultDir;
			public char8* szBaseFileName;
			...
			public struct _Anonymous_e__Union
			{
				...
				public struct _Anonymous1_e__Struct
				{
					...
					public char8* PdlCommandFilename;
					public char8* PdlCounterList;
		...
		public struct PDH_LOG_SERVICE_QUERY_INFO_W
		{
			...
			public uint32 dwFlags;
			public uint32 dwLogQuota;
			public char16* szLogFileCaption;
			public char16* szDefaultDir;
			public char16* szBaseFileName;
			public uint32 dwFileType;
			public uint32 dwReserved;
			public _Anonymous_e__Union Anonymous;
			...
			public struct _Anonymous_e__Union
			{
				...
				public struct _Anonymous1_e__Struct
				{
					public uint32 PdlAutoNameInterval;
					public uint32 PdlAutoNameUnits;
					public char16* PdlCommandFilename;
					public char16* PdlCounterList;
					public uint32 PdlAutoNameFormat;
					public uint32 PdlSampleInterval;
					public FileTime PdlLogStartTime;
					public FileTime PdlLogEndTime;
		...
		public struct PDH_BROWSE_DLG_CONFIG_HW
		{
			...
			public char16* szReturnPathBuffer;
			...
			public char16* szDialogBoxCaption;
		}
		[CRepr]
		public struct PDH_BROWSE_DLG_CONFIG_HA
		{
			...
			public HWnd hWndOwner;
			public int hDataSource;
			public char8* szReturnPathBuffer;
			public uint32 cchReturnPathLength;
			public CounterPathCallBack pCallBack;
			public uint dwCallBackArg;
			public int32 CallBackStatus;
			public PERF_DETAIL dwDefaultDetailLevel;
			public char8* szDialogBoxCaption;
		}
		[CRepr]
		...
		public static extern IntBool QueryPerformanceCounter(out LARGE_INTEGER lpPerformanceCount);
		public static uint64 QueryPerformanceCounter() => (.)QueryPerformanceCounter(..var _).QuadPart;
		[Import("kernel32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool QueryPerformanceFrequency(out LARGE_INTEGER lpFrequency);
		public static uint64 QueryPerformanceFrequency() => (.)QueryPerformanceFrequency(..var _).QuadPart;
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 InstallPerfDllW(char16* szComputerName, char16* lpIniFile, uint dwFlags);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 InstallPerfDllA(char8* szComputerName, char8* lpIniFile, uint dwFlags);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 LoadPerfCounterTextStringsA(char8* lpCommandLine, IntBool bQuietModeArg);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 LoadPerfCounterTextStringsW(char16* lpCommandLine, IntBool bQuietModeArg);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 UnloadPerfCounterTextStringsW(char16* lpCommandLine, IntBool bQuietModeArg);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 UnloadPerfCounterTextStringsA(char8* lpCommandLine, IntBool bQuietModeArg);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 UpdatePerfNameFilesA(char8* szNewCtrFilePath, char8* szNewHlpFilePath, char8* szLanguageID, uint dwFlags);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 UpdatePerfNameFilesW(char16* szNewCtrFilePath, char16* szNewHlpFilePath, char16* szLanguageID, uint dwFlags);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 SetServiceAsTrustedA(char8* szReserved, char8* szServiceName);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 SetServiceAsTrustedW(char16* szReserved, char16* szServiceName);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 BackupPerfRegistryToFileW(char16* szFileName, char16* szCommentString);
		[Import("loadperf.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 RestorePerfRegistryFromFileW(char16* szFileName, char16* szLangId);
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern PERF_COUNTERSET_INSTANCE* PerfCreateInstance(PerfProviderHandle ProviderHandle, in Guid CounterSetGuid, char16* Name, uint32 Id);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PerfDeleteInstance(PerfProviderHandle Provider, ref PERF_COUNTERSET_INSTANCE InstanceBlock);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern PERF_COUNTERSET_INSTANCE* PerfQueryInstance(Handle ProviderHandle, in Guid CounterSetGuid, char16* Name, uint32 Id);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PerfEnumerateCounterSet(char16* szMachine, Guid* pCounterSetIds, uint32 cCounterSetIds, out uint32 pcCounterSetIdsActual);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PerfEnumerateCounterSetInstances(char16* szMachine, in Guid pCounterSetId, PERF_INSTANCE_HEADER* pInstances, uint32 cbInstances, out uint32 pcbInstancesActual);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PerfQueryCounterSetRegistrationInfo(char16* szMachine, in Guid pCounterSetId, PerfRegInfoType requestCode, uint32 requestLangId, uint8* pbRegInfo, uint32 cbRegInfo, out uint32 pcbRegInfoActual);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PerfOpenQueryHandle(char16* szMachine, out PerfQueryHandle phQuery);
		[Import("advapi32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhOpenQueryW(char16* szDataSource, uint dwUserData, out int phQuery);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhOpenQueryA(char8* szDataSource, uint dwUserData, out int phQuery);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhAddCounterW(int hQuery, char16* szFullCounterPath, uint dwUserData, out int phCounter);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhAddCounterA(int hQuery, char8* szFullCounterPath, uint dwUserData, out int phCounter);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhAddEnglishCounterW(int hQuery, char16* szFullCounterPath, uint dwUserData, out int phCounter);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhAddEnglishCounterA(int hQuery, char8* szFullCounterPath, uint dwUserData, out int phCounter);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhCollectQueryDataWithTime(int hQuery, out int64 pllTimeStamp);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhValidatePathExW(int hDataSource, char16* szFullPathBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhValidatePathExA(int hDataSource, char8* szFullPathBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetCounterInfoW(int hCounter, bool bRetrieveExplainText, out uint32 pdwBufferSize, PDH_COUNTER_INFO_W* lpBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetCounterInfoA(int hCounter, bool bRetrieveExplainText, out uint32 pdwBufferSize, PDH_COUNTER_INFO_A* lpBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhSetCounterScaleFactor(int hCounter, int32 lFactor);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhConnectMachineW(char16* szMachineName);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhConnectMachineA(char8* szMachineName);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumMachinesW(char16* szDataSource, char16* mszMachineList, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumMachinesA(char8* szDataSource, char8* mszMachineList, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectsW(char16* szDataSource, char16* szMachineName, char16* mszObjectList, out uint32 pcchBufferSize, PERF_DETAIL dwDetailLevel, IntBool bRefresh);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectsA(char8* szDataSource, char8* szMachineName, char8* mszObjectList, out uint32 pcchBufferSize, PERF_DETAIL dwDetailLevel, IntBool bRefresh);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectItemsW(char16* szDataSource, char16* szMachineName, char16* szObjectName, char16* mszCounterList, out uint32 pcchCounterListLength, char16* mszInstanceList, out uint32 pcchInstanceListLength, PERF_DETAIL dwDetailLevel, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectItemsA(char8* szDataSource, char8* szMachineName, char8* szObjectName, char8* mszCounterList, out uint32 pcchCounterListLength, char8* mszInstanceList, out uint32 pcchInstanceListLength, PERF_DETAIL dwDetailLevel, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhMakeCounterPathW(ref PDH_COUNTER_PATH_ELEMENTS_W pCounterPathElements, char16* szFullPathBuffer, out uint32 pcchBufferSize, PDH_PATH_FLAGS dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhMakeCounterPathA(ref PDH_COUNTER_PATH_ELEMENTS_A pCounterPathElements, char8* szFullPathBuffer, out uint32 pcchBufferSize, PDH_PATH_FLAGS dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhParseCounterPathW(char16* szFullPathBuffer, PDH_COUNTER_PATH_ELEMENTS_W* pCounterPathElements, out uint32 pdwBufferSize, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhParseCounterPathA(char8* szFullPathBuffer, PDH_COUNTER_PATH_ELEMENTS_A* pCounterPathElements, out uint32 pdwBufferSize, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhParseInstanceNameW(char16* szInstanceString, char16* szInstanceName, out uint32 pcchInstanceNameLength, char16* szParentName, out uint32 pcchParentNameLength, out uint32 lpIndex);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhParseInstanceNameA(char8* szInstanceString, char8* szInstanceName, out uint32 pcchInstanceNameLength, char8* szParentName, out uint32 pcchParentNameLength, out uint32 lpIndex);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhValidatePathW(char16* szFullPathBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhValidatePathA(char8* szFullPathBuffer);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfObjectW(char16* szDataSource, char16* szMachineName, char16* szDefaultObjectName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfObjectA(char8* szDataSource, char8* szMachineName, char8* szDefaultObjectName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfCounterW(char16* szDataSource, char16* szMachineName, char16* szObjectName, char16* szDefaultCounterName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfCounterA(char8* szDataSource, char8* szMachineName, char8* szObjectName, char8* szDefaultCounterName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandCounterPathW(char16* szWildCardPath, char16* mszExpandedPathList, out uint32 pcchPathListLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandCounterPathA(char8* szWildCardPath, char8* mszExpandedPathList, out uint32 pcchPathListLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhLookupPerfNameByIndexW(char16* szMachineName, uint32 dwNameIndex, char16* szNameBuffer, out uint32 pcchNameBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhLookupPerfNameByIndexA(char8* szMachineName, uint32 dwNameIndex, char8* szNameBuffer, out uint32 pcchNameBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhLookupPerfIndexByNameW(char16* szMachineName, char16* szNameBuffer, out uint32 pdwIndex);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhLookupPerfIndexByNameA(char8* szMachineName, char8* szNameBuffer, out uint32 pdwIndex);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandWildCardPathA(char8* szDataSource, char8* szWildCardPath, char8* mszExpandedPathList, out uint32 pcchPathListLength, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandWildCardPathW(char16* szDataSource, char16* szWildCardPath, char16* mszExpandedPathList, out uint32 pcchPathListLength, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhOpenLogW(char16* szLogFileName, PDH_LOG dwAccessFlags, out PDH_LOG_TYPE lpdwLogType, int hQuery, uint32 dwMaxSize, char16* szUserCaption, out int phLog);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhOpenLogA(char8* szLogFileName, PDH_LOG dwAccessFlags, out PDH_LOG_TYPE lpdwLogType, int hQuery, uint32 dwMaxSize, char8* szUserCaption, out int phLog);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhUpdateLogW(int hLog, char16* szUserString);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhUpdateLogA(int hLog, char8* szUserString);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhSelectDataSourceW(HWnd hWndOwner, PDH_SELECT_DATA_SOURCE_FLAGS dwFlags, char16* szDataSource, out uint32 pcchBufferLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhSelectDataSourceA(HWnd hWndOwner, PDH_SELECT_DATA_SOURCE_FLAGS dwFlags, char8* szDataSource, out uint32 pcchBufferLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PdhIsRealTimeQuery(int hQuery);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhSetQueryTimeRange(int hQuery, ref PDH_TIME_INFO pInfo);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDataSourceTimeRangeW(char16* szDataSource, out uint32 pdwNumEntries, out PDH_TIME_INFO pInfo, out uint32 pdwBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDataSourceTimeRangeA(char8* szDataSource, out uint32 pdwNumEntries, out PDH_TIME_INFO pInfo, out uint32 pdwBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhBindInputDataSourceW(out int phDataSource, char16* LogFileNameList);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhBindInputDataSourceA(out int phDataSource, char8* LogFileNameList);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhOpenQueryH(int hDataSource, uint dwUserData, out int phQuery);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumMachinesHW(int hDataSource, char16* mszMachineList, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumMachinesHA(int hDataSource, char8* mszMachineList, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectsHW(int hDataSource, char16* szMachineName, char16* mszObjectList, out uint32 pcchBufferSize, PERF_DETAIL dwDetailLevel, IntBool bRefresh);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectsHA(int hDataSource, char8* szMachineName, char8* mszObjectList, out uint32 pcchBufferSize, PERF_DETAIL dwDetailLevel, IntBool bRefresh);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectItemsHW(int hDataSource, char16* szMachineName, char16* szObjectName, char16* mszCounterList, out uint32 pcchCounterListLength, char16* mszInstanceList, out uint32 pcchInstanceListLength, PERF_DETAIL dwDetailLevel, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumObjectItemsHA(int hDataSource, char8* szMachineName, char8* szObjectName, char8* mszCounterList, out uint32 pcchCounterListLength, char8* mszInstanceList, out uint32 pcchInstanceListLength, PERF_DETAIL dwDetailLevel, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandWildCardPathHW(int hDataSource, char16* szWildCardPath, char16* mszExpandedPathList, out uint32 pcchPathListLength, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhExpandWildCardPathHA(int hDataSource, char8* szWildCardPath, char8* mszExpandedPathList, out uint32 pcchPathListLength, uint32 dwFlags);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfObjectHW(int hDataSource, char16* szMachineName, char16* szDefaultObjectName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfObjectHA(int hDataSource, char8* szMachineName, char8* szDefaultObjectName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfCounterHW(int hDataSource, char16* szMachineName, char16* szObjectName, char16* szDefaultCounterName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhGetDefaultPerfCounterHA(int hDataSource, char8* szMachineName, char8* szObjectName, char8* szDefaultCounterName, out uint32 pcchBufferSize);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhVerifySQLDBW(char16* szDataSource);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhVerifySQLDBA(char8* szDataSource);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhCreateSQLTablesW(char16* szDataSource);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhCreateSQLTablesA(char8* szDataSource);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumLogSetNamesW(char16* szDataSource, char16* mszDataSetNameList, out uint32 pcchBufferLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PdhEnumLogSetNamesA(char8* szDataSource, char8* mszDataSetNameList, out uint32 pcchBufferLength);
		[Import("pdh.dll"), CLink, CallingConvention(.Stdcall)]
