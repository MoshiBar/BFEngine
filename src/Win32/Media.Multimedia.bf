...
namespace Win32.Media
{
	public static class Multimedia
	{
		...
		public function LRESULT LPMMIOPROC(char8* lpmmioinfo, uint32 uMsg, LPARAM lParam1, LPARAM lParam2);
		public function IntBool AVISAVECALLBACK(int32 param0);
		public function LRESULT CAPYIELDCALLBACK(HWnd hWnd);
		public function LRESULT CAPSTATUSCALLBACKW(HWnd hWnd, int32 nID, char16* lpsz);
		public function LRESULT CAPERRORCALLBACKW(HWnd hWnd, int32 nID, char16* lpsz);
		public function LRESULT CAPSTATUSCALLBACKA(HWnd hWnd, int32 nID, char8* lpsz);
		public function LRESULT CAPERRORCALLBACKA(HWnd hWnd, int32 nID, char8* lpsz);
		...
		public function IntBool LPFNEXTDEVIO(LPARAM lParam, uint32 dwFlags, uint32 dwIoControlCode, void* lpInBuffer, uint32 nInBufferSize, void* lpOutBuffer, uint32 nOutBufferSize, out uint32 lpBytesReturned, out OVERLAPPED lpOverlapped);
		...
		public struct MCI_OPEN_PARMSA
		{
			...
			public char8* lpstrDeviceType;
			public char8* lpstrElementName;
			public char8* lpstrAlias;
		}
		[CRepr, Packed(1)]
		public struct MCI_OPEN_PARMSW
		{
			public uint dwCallback;
			public uint32 wDeviceID;
			public char16* lpstrDeviceType;
			public char16* lpstrElementName;
			public char16* lpstrAlias;
		}
		[CRepr, Packed(1)]
		...
		{
			public uint dwCallback;
			public char8* lpstrCommand;
		}
		[CRepr, Packed(1)]
		public struct MCI_VD_ESCAPE_PARMSW
		{
			public uint dwCallback;
			public char16* lpstrCommand;
		}
		[CRepr, Packed(1)]
		...
		public struct DRVCONFIGINFOEX
		{
			...
			public char16* lpszDCISectionName;
			public char16* lpszDCIAliasName;
		...
		public struct CAPDRIVERCAPS
		{
			...
			public IntBool fHasOverlay;
			public IntBool fHasDlgVideoSource;
			public IntBool fHasDlgVideoFormat;
			public IntBool fHasDlgVideoDisplay;
			public IntBool fCaptureInitialized;
			public IntBool fDriverSuppliesPalettes;
		...
		public struct CAPSTATUS
		{
			...
			public IntBool fLiveWindow;
			public IntBool fOverlayWindow;
			public IntBool fScale;
			public POINT ptScroll;
			public IntBool fUsingDefaultPalette;
			public IntBool fAudioHardware;
			public IntBool fCapFileExists;
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciSendStringA(char8* lpstrCommand, uint8* lpstrReturnString, uint32 uReturnLength, HWnd hwndCallback);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciSendStringW(char16* lpstrCommand, char16* lpstrReturnString, uint32 uReturnLength, HWnd hwndCallback);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciGetDeviceIDA(char8* pszDevice);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciGetDeviceIDW(char16* pszDevice);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciGetDeviceIDFromElementIDA(uint32 dwElementID, char8* lpstrType);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciGetDeviceIDFromElementIDW(uint32 dwElementID, char16* lpstrType);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciGetErrorStringA(uint32 mcierr, uint8* pszText, uint32 cchText);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciGetErrorStringW(uint32 mcierr, char16* pszText, uint32 cchText);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciSetYieldProc(uint32 mciId, YIELDPROC fpYieldProc, uint32 dwYieldData);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciLoadCommandResource(Handle hInstance, char16* lpResName, uint32 wType);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciSetDriverData(uint32 wDeviceID, uint dwData);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mciDriverYield(uint32 wDeviceID);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciDriverNotify(Handle hwndCallback, uint32 wDeviceID, uint32 uStatus);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mciFreeCommandResource(uint32 wTable);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LRESULT CloseDriver(HDRVR hDriver, LPARAM lParam1, LPARAM lParam2);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HDRVR OpenDriver(char16* szDriverName, char16* szSectionName, LPARAM lParam2);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DriverCallback(uint dwCallback, uint32 dwFlags, HDRVR hDevice, uint32 dwMsg, uint dwUser, uint dwParam1, uint dwParam2);
		[Import("api-ms-win-mm-misc-l1-1-1.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 sndOpenSound(char16* EventName, char16* AppName, int32 Flags, out Handle FileHandle);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mmDrvInstall(HDRVR hDriver, char16* wszDrvEntry, DRIVERMSGPROC drvMessage, uint32 wFlags);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mmioStringToFOURCCA(char8* sz, uint32 uFlags);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mmioStringToFOURCCW(char16* sz, uint32 uFlags);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mmioRenameA(char8* pszFileName, char8* pszNewFileName, MMIOINFO* pmmioinfo, uint32 fdwRename);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 mmioRenameW(char16* pszFileName, char16* pszNewFileName, MMIOINFO* pmmioinfo, uint32 fdwRename);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 mmioWrite(HMMIO hmmio, char8* pch, int32 cch);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 joySetCapture(HWnd hwnd, uint32 uJoyID, uint32 uPeriod, IntBool fChanged);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ICInfo(uint32 fccType, uint32 fccHandler, out ICINFO lpicinfo);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ICInstall(uint32 fccType, uint32 fccHandler, LPARAM lParam, char8* szDesc, uint32 wFlags);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ICRemove(uint32 fccType, uint32 fccHandler, uint32 wFlags);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ICCompressorChoose(HWnd hwnd, uint32 uiFlags, void* pvIn, void* lpData, out COMPVARS pc, char8* lpszTitle);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ICSeqCompressFrameStart(ref COMPVARS pc, ref BITMAPINFO lpbiIn);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void ICSeqCompressFrameEnd(ref COMPVARS pc);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void* ICSeqCompressFrame(ref COMPVARS pc, uint32 uiFlags, void* lpBits, out IntBool pfKey, int32* plSize);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void ICCompressorFree(ref COMPVARS pc);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int DrawDibOpen();
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibClose(int hdd);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibSetPalette(int hdd, HPALETTE hpal);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibChangePalette(int hdd, int32 iStart, int32 iLen, PALETTEENTRY* lppe);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 DrawDibRealize(int hdd, HDC hdc, IntBool fBackground);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibStart(int hdd, uint32 rate);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibStop(int hdd);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibBegin(int hdd, HDC hdc, int32 dxDst, int32 dyDst, ref BITMAPINFOHEADER lpbi, int32 dxSrc, int32 dySrc, uint32 wFlags);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibDraw(int hdd, HDC hdc, int32 xDst, int32 yDst, int32 dxDst, int32 dyDst, BITMAPINFOHEADER* lpbi, void* lpBits, int32 xSrc, int32 ySrc, int32 dxSrc, int32 dySrc, uint32 wFlags);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibEnd(int hdd);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DrawDibTime(int hdd, out DRAWDIBTIME lpddtime);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIFileOpenA(out IAVIFile* ppfile, char8* szFile, uint32 uMode, Guid* lpHandler);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIFileOpenW(out IAVIFile* ppfile, char16* szFile, uint32 uMode, Guid* lpHandler);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIStreamOpenFromFileA(out IAVIStream* ppavi, char8* szFile, uint32 fccType, int32 lParam, uint32 mode, Guid* pclsidHandler);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIStreamOpenFromFileW(out IAVIStream* ppavi, char16* szFile, uint32 fccType, int32 lParam, uint32 mode, Guid* pclsidHandler);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVISaveA(char8* szFile, Guid* pclsidHandler, AVISAVECALLBACK lpfnCallback, int32 nStreams, ref IAVIStream pfile, ref AVICOMPRESSOPTIONS lpOptions);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVISaveVA(char8* szFile, Guid* pclsidHandler, AVISAVECALLBACK lpfnCallback, int32 nStreams, IAVIStream** ppavi, AVICOMPRESSOPTIONS** plpOptions);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVISaveW(char16* szFile, Guid* pclsidHandler, AVISAVECALLBACK lpfnCallback, int32 nStreams, ref IAVIStream pfile, ref AVICOMPRESSOPTIONS lpOptions);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVISaveVW(char16* szFile, Guid* pclsidHandler, AVISAVECALLBACK lpfnCallback, int32 nStreams, IAVIStream** ppavi, AVICOMPRESSOPTIONS** plpOptions);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIBuildFilterW(char16* lpszFilter, int32 cbFilter, IntBool fSaving);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AVIBuildFilterA(uint8* lpszFilter, int32 cbFilter, IntBool fSaving);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult EditStreamSetNameA(ref IAVIStream pavi, char8* lpszName);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult EditStreamSetNameW(ref IAVIStream pavi, char16* lpszName);
		[Import("avifil32.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HWnd MCIWndCreateA(HWnd hwndParent, HInstance hInstance, uint32 dwStyle, char8* szFile);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HWnd MCIWndCreateW(HWnd hwndParent, HInstance hInstance, uint32 dwStyle, char16* szFile);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool MCIWndRegisterClass();
		[Import("avicap32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HWnd capCreateCaptureWindowA(char8* lpszWindowName, uint32 dwStyle, int32 x, int32 y, int32 nWidth, int32 nHeight, HWnd hwndParent, int32 nID);
		[Import("avicap32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool capGetDriverDescriptionA(uint32 wDriverIndex, uint8* lpszName, int32 cbName, uint8* lpszVer, int32 cbVer);
		[Import("avicap32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HWnd capCreateCaptureWindowW(char16* lpszWindowName, uint32 dwStyle, int32 x, int32 y, int32 nWidth, int32 nHeight, HWnd hwndParent, int32 nID);
		[Import("avicap32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool capGetDriverDescriptionW(uint32 wDriverIndex, char16* lpszName, int32 cbName, char16* lpszVer, int32 cbVer);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetOpenFileNamePreviewA(out OPENFILENAMEA lpofn);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetSaveFileNamePreviewA(out OPENFILENAMEA lpofn);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetOpenFileNamePreviewW(out OPENFILENAMEW lpofn);
		[Import("msvfw32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetSaveFileNamePreviewW(out OPENFILENAMEW lpofn);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool mmTaskSignal(uint32 h);
		[Import("winmm.dll"), CLink, CallingConvention(.Stdcall)]
