...
namespace Win32.Devices
{
	public static class HumanInterfaceDevice
	{
		...
		public const uint32 DIDFT_OPTIONAL		= 0x80000000;
		...
		public static readonly DIOBJECTDATAFORMAT[?] dfDIMouse	= .(
		  ...
		  public static readonly DIDATAFORMAT c_dfDIMouse	= .(
			sizeof(DIDATAFORMAT),
			...
			.(&GUID_Button, DIMOFS_BUTTON7, DIDFT_OPTIONAL | DIDFT_ANYINSTANCE | DIDFT_BUTTON, 0)
		  	...
		  	public static readonly DIDATAFORMAT c_dfDIMouse2	= .(
			sizeof(DIDATAFORMAT),
			sizeof(DIOBJECTDATAFORMAT),
			DIDF_RELAXIS,
			sizeof(DIMOUSESTATE),
		...
		static uint32 DIDFT_MAKEINSTANCE(uint32 n) => ((uint16)(n) << 8);

		static uint32 DIJOFS_SLIDER(int n) => (.)(offsetof(DIJOYSTATE, rglSlider) + (n) * sizeof(uint32));
		static uint32 DIJOFS_POV(int n) => (.)(offsetof(DIJOYSTATE, rgdwPOV) + (n) * sizeof(uint32));
		...
		public static readonly DIOBJECTDATAFORMAT[?] dfDIKeyboard	= .(
			...
			.(&GUID_Key, 255, DIDFT_OPTIONAL | DIDFT_BUTTON | DIDFT_MAKEINSTANCE(255), 0)
		  	...
		  	static readonly DIDATAFORMAT c_dfDIKeyboard	= .(
				sizeof(DIDATAFORMAT),
				sizeof(DIOBJECTDATAFORMAT),
				DIDF_RELAXIS,
				256,
		...
		static readonly DIOBJECTDATAFORMAT[?] dfDIJoystick	= .(
			...
			public static readonly DIDATAFORMAT c_dfDIJoystick	= .(
				sizeof(DIDATAFORMAT),
				sizeof(DIOBJECTDATAFORMAT),
				DIDF_ABSAXIS,
				sizeof(DIJOYSTATE),
		...
		public static readonly DIOBJECTDATAFORMAT[?] dfDIJoystick2	= .(
		  ...
		  public static readonly DIDATAFORMAT c_dfDIJoystick2	= .(
			sizeof(DIDATAFORMAT),
			sizeof(DIOBJECTDATAFORMAT),
			DIDF_ABSAXIS,
			sizeof(DIJOYSTATE2),
		...
		public function IntBool LPDIENUMEFFECTSINFILECALLBACK(out DIFILEEFFECT param0, void* param1);
		public function IntBool LPDIENUMDEVICEOBJECTSCALLBACKA(out DIDEVICEOBJECTINSTANCEA param0, void* param1);
		public function IntBool LPDIENUMDEVICEOBJECTSCALLBACKW(out DIDEVICEOBJECTINSTANCEW param0, void* param1);
		public function IntBool LPDIENUMEFFECTSCALLBACKA(out DIEFFECTINFOA param0, void* param1);
		public function IntBool LPDIENUMEFFECTSCALLBACKW(out DIEFFECTINFOW param0, void* param1);
		public function IntBool LPDIENUMCREATEDEFFECTOBJECTSCALLBACK(ref IDirectInputEffect param0, void* param1);
		public function IntBool LPDIENUMDEVICESCALLBACKA(out DIDEVICEINSTANCEA param0, void* param1);
		public function IntBool LPDIENUMDEVICESCALLBACKW(out DIDEVICEINSTANCEW param0, void* param1);
		public function IntBool LPDICONFIGUREDEVICESCALLBACK(ref IUnknown param0, void* param1);
		public function IntBool LPDIENUMDEVICESBYSEMANTICSCBA(out DIDEVICEINSTANCEA param0, ref IDirectInputDevice8A param1, uint32 param2, uint32 param3, void* param4);
		public function IntBool LPDIENUMDEVICESBYSEMANTICSCBW(out DIDEVICEINSTANCEW param0, ref IDirectInputDevice8W param1, uint32 param2, uint32 param3, void* param4);
		public function void LPFNSHOWJOYCPL(HWnd hWnd);
		public function IntBool LPDIJOYTYPECALLBACK(char16* param0, void* param1);
		public function bool PHIDP_INSERT_SCANCODES(void* Context, char8* NewScanCodes, uint32 Length);
		...
		public struct DIFILEEFFECT
		{
			...
			public char8[260] szFriendlyName;
		}
		[CRepr]
		...
		{
			public uint32 dwSize;
			public char16* pwszDeviceInterface;
			public Guid GuidInstance;
		}
		[CRepr]
		...
		public struct IDirectInputEffect : IUnknown
		{
			...
			public HResult Escape(out DIEFFESCAPE param0) mut	=> VT._Escape(ref this, out param0);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputEffect self, out DIEFFESCAPE param0) _Escape;
			}
		}
		[CRepr]
		public struct IDirectInputDeviceW : IUnknown
		{
			...
			public HResult EnumObjects(LPDIENUMDEVICEOBJECTSCALLBACKW param0, void* param1, uint32 param2) mut	=> VT._EnumObjects(ref this, param0, param1, param2);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDeviceW self, LPDIENUMDEVICEOBJECTSCALLBACKW param0, void* param1, uint32 param2) _EnumObjects;
		...
		public struct IDirectInputDeviceA : IUnknown
		{
			...
			public HResult GetCapabilities(out DIDEVCAPS param0) mut	=> VT.GetCapabilities(ref this, out param0);
			public HResult EnumObjects(LPDIENUMDEVICEOBJECTSCALLBACKA param0, void* param1, uint32 param2) mut	=> VT._EnumObjects(ref this, param0, param1, param2);
			public HResult GetProperty(in Guid param0, out DIPROPHEADER param1) mut	=> VT.GetProperty(ref this, param0, out param1);
			public HResult SetProperty(in Guid param0, out DIPROPHEADER param1) mut	=> VT.SetProperty(ref this, param0, out param1);
			public HResult Acquire() mut	=> VT.Acquire(ref this);
			public HResult Unacquire() mut	=> VT.Unacquire(ref this);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDeviceA self, LPDIENUMDEVICEOBJECTSCALLBACKA param0, void* param1, uint32 param2) _EnumObjects;
		...
		public struct IDirectInputDevice2W : IDirectInputDeviceW
		{
			...
			public struct VTable : IDirectInputDeviceW.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice2W self, out DIEFFESCAPE param0) _Escape;
		...
		public struct IDirectInputDevice2A : IDirectInputDeviceA
		{
			...
			public struct VTable : IDirectInputDeviceA.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice2A self, out DIEFFESCAPE param0) _Escape;
		...
		public struct IDirectInputDevice7W : IDirectInputDevice2W
		{
			...
			public HResult EnumEffectsInFile(char16* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) mut	=> VT.EnumEffectsInFile(ref this, param0, param1, param2, param3);
			public HResult WriteEffectToFile(char16* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) mut	=> VT.WriteEffectToFile(ref this, param0, param1, out param2, param3);

			[CRepr]
			public struct VTable : IDirectInputDevice2W.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice7W self, char16* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) EnumEffectsInFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice7W self, char16* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) WriteEffectToFile;
			}
		}
		[CRepr]
		public struct IDirectInputDevice7A : IDirectInputDevice2A
		{
			...
			public HResult EnumEffectsInFile(char8* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) mut	=> VT.EnumEffectsInFile(ref this, param0, param1, param2, param3);
			public HResult WriteEffectToFile(char8* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) mut	=> VT.WriteEffectToFile(ref this, param0, param1, out param2, param3);

			[CRepr]
			public struct VTable : IDirectInputDevice2A.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice7A self, char8* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) EnumEffectsInFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice7A self, char8* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) WriteEffectToFile;
			}
		}
		[CRepr]
		public struct IDirectInputDevice8W : IUnknown
		{
			...
			public HResult EnumEffectsInFile(char16* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) mut	=> VT.EnumEffectsInFile(ref this, param0, param1, param2, param3);
			public HResult WriteEffectToFile(char16* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) mut	=> VT.WriteEffectToFile(ref this, param0, param1, out param2, param3);
			public HResult BuildActionMap(out DIACTIONFORMATW param0, char16* param1, uint32 param2) mut	=> VT.BuildActionMap(ref this, out param0, param1, param2);
			public HResult SetActionMap(out DIACTIONFORMATW param0, char16* param1, uint32 param2) mut	=> VT.SetActionMap(ref this, out param0, param1, param2);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, LPDIENUMDEVICEOBJECTSCALLBACKW param0, void* param1, uint32 param2) _EnumObjects;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, out DIEFFESCAPE param0) _Escape;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, char16* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) EnumEffectsInFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, char16* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) WriteEffectToFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, out DIACTIONFORMATW param0, char16* param1, uint32 param2) BuildActionMap;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8W self, out DIACTIONFORMATW param0, char16* param1, uint32 param2) SetActionMap;
		...
		public struct IDirectInputDevice8A : IUnknown
		{
			...
			public HResult GetDeviceState(uint32 param0, void* param1) mut	=> VT.GetDeviceState(ref this, param0, param1);
			public HResult GetDeviceData(uint32 param0, out DIDEVICEOBJECTDATA param1, out uint32 param2, uint32 param3) mut	=> VT.GetDeviceData(ref this, param0, out param1, out param2, param3);
			public HResult SetDataFormat(in DIDATAFORMAT param0) mut	=> VT.SetDataFormat(ref this, param0);
			public HResult SetEventNotification(Handle param0) mut	=> VT.SetEventNotification(ref this, param0);
			public HResult SetCooperativeLevel(HWnd param0, uint32 param1) mut	=> VT.SetCooperativeLevel(ref this, param0, param1);
			public HResult GetObjectInfo(out DIDEVICEOBJECTINSTANCEA param0, uint32 param1, uint32 param2) mut	=> VT.GetObjectInfo(ref this, out param0, param1, param2);
			public HResult GetDeviceInfo(out DIDEVICEINSTANCEA param0) mut	=> VT.GetDeviceInfo(ref this, out param0);
			...
			public HResult EnumEffectsInFile(char8* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) mut	=> VT.EnumEffectsInFile(ref this, param0, param1, param2, param3);
			public HResult WriteEffectToFile(char8* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) mut	=> VT.WriteEffectToFile(ref this, param0, param1, out param2, param3);
			public HResult BuildActionMap(out DIACTIONFORMATA param0, char8* param1, uint32 param2) mut	=> VT.BuildActionMap(ref this, out param0, param1, param2);
			public HResult SetActionMap(out DIACTIONFORMATA param0, char8* param1, uint32 param2) mut	=> VT.SetActionMap(ref this, out param0, param1, param2);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, LPDIENUMDEVICEOBJECTSCALLBACKA param0, void* param1, uint32 param2) _EnumObjects;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, in DIDATAFORMAT param0) SetDataFormat;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, out DIEFFESCAPE param0) _Escape;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, char8* param0, LPDIENUMEFFECTSINFILECALLBACK param1, void* param2, uint32 param3) EnumEffectsInFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, char8* param0, uint32 param1, out DIFILEEFFECT param2, uint32 param3) WriteEffectToFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, out DIACTIONFORMATA param0, char8* param1, uint32 param2) BuildActionMap;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputDevice8A self, out DIACTIONFORMATA param0, char8* param1, uint32 param2) SetActionMap;
		...
		public struct IDirectInput2W : IDirectInputW
		{
			...
			public HResult FindDevice(in Guid param0, char16* param1, out Guid param2) mut	=> VT.FindDevice(ref this, param0, param1, out param2);

			[CRepr]
			public struct VTable : IDirectInputW.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput2W self, in Guid param0, char16* param1, out Guid param2) FindDevice;
			}
		}
		[CRepr]
		public struct IDirectInput2A : IDirectInputA
		{
			...
			public HResult FindDevice(in Guid param0, char8* param1, out Guid param2) mut	=> VT.FindDevice(ref this, param0, param1, out param2);

			[CRepr]
			public struct VTable : IDirectInputA.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput2A self, in Guid param0, char8* param1, out Guid param2) FindDevice;
			}
		}
		[CRepr]
		...
		public struct IDirectInput8W : IUnknown
		{
			...
			public HResult Initialize(HInstance param0, uint32 param1) mut	=> VT.Initialize(ref this, param0, param1);
			public HResult FindDevice(in Guid param0, char16* param1, out Guid param2) mut	=> VT.FindDevice(ref this, param0, param1, out param2);
			public HResult EnumDevicesBySemantics(char16* param0, out DIACTIONFORMATW param1, LPDIENUMDEVICESBYSEMANTICSCBW param2, void* param3, uint32 param4) mut	=> VT.EnumDevicesBySemantics(ref this, param0, out param1, param2, param3, param4);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8W self, in Guid param0, char16* param1, out Guid param2) FindDevice;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8W self, char16* param0, out DIACTIONFORMATW param1, LPDIENUMDEVICESBYSEMANTICSCBW param2, void* param3, uint32 param4) EnumDevicesBySemantics;
		...
		public struct IDirectInput8A : IUnknown
		{
			...
			public HResult CreateDevice(in Guid param0, out IDirectInputDevice8A* param1, IUnknown* param2	= null) mut	=> VT.CreateDevice(ref this, param0, out param1, param2);
			public HResult EnumDevices(DeviceClass param0, LPDIENUMDEVICESCALLBACKA param1, void* param2, DIEDFL param3) mut	=> VT.EnumDevices(ref this, param0, param1, param2, param3);
			public HResult GetDeviceStatus(in Guid param0) mut	=> VT.GetDeviceStatus(ref this, param0);
			public HResult RunControlPanel(HWnd param0, uint32 param1) mut	=> VT.RunControlPanel(ref this, param0, param1);
			public HResult Initialize(HInstance param0, uint32 param1) mut	=> VT.Initialize(ref this, param0, param1);
			public HResult FindDevice(in Guid param0, char8* param1, out Guid param2) mut	=> VT.FindDevice(ref this, param0, param1, out param2);
			public HResult EnumDevicesBySemantics(char8* param0, out DIACTIONFORMATA param1, LPDIENUMDEVICESBYSEMANTICSCBA param2, void* param3, uint32 param4) mut	=> VT.EnumDevicesBySemantics(ref this, param0, out param1, param2, param3, param4);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8A self, in Guid param0, out IDirectInputDevice8A* param1, IUnknown* param2) CreateDevice;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8A self, DeviceClass param0, LPDIENUMDEVICESCALLBACKA param1, void* param2, DIEDFL param3) EnumDevices;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8A self, in Guid param0, char8* param1, out Guid param2) FindDevice;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInput8A self, char8* param0, out DIACTIONFORMATA param1, LPDIENUMDEVICESBYSEMANTICSCBA param2, void* param3, uint32 param4) EnumDevicesBySemantics;
		...
		public struct IDirectInputEffectDriver : IUnknown
		{
			...
			public HResult Escape(uint32 param0, uint32 param1, out DIEFFESCAPE param2) mut	=> VT._Escape(ref this, param0, param1, out param2);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputEffectDriver self, uint32 param0, uint32 param1, out DIEFFESCAPE param2) _Escape;
		...
		public struct IDirectInputJoyConfig : IUnknown
		{
			...
			public HResult GetTypeInfo(char16* param0, out DIJOYTYPEINFO param1, uint32 param2) mut	=> VT.GetTypeInfo(ref this, param0, out param1, param2);
			public HResult SetTypeInfo(char16* param0, out DIJOYTYPEINFO param1, uint32 param2) mut	=> VT.SetTypeInfo(ref this, param0, out param1, param2);
			public HResult DeleteType(char16* param0) mut	=> VT.DeleteType(ref this, param0);
			...
			public HResult OpenTypeKey(char16* param0, uint32 param1, out HKey param2) mut	=> VT.OpenTypeKey(ref this, param0, param1, out param2);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig self, char16* param0, out DIJOYTYPEINFO param1, uint32 param2) GetTypeInfo;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig self, char16* param0, out DIJOYTYPEINFO param1, uint32 param2) SetTypeInfo;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig self, char16* param0) DeleteType;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig self, char16* param0, uint32 param1, out HKey param2) OpenTypeKey;
		...
		public struct IDirectInputJoyConfig8 : IUnknown
		{
			...
			public HResult EnumTypes(LPDIJOYTYPECALLBACK param0, void* param1) mut	=> VT.EnumTypes(ref this, param0, param1);
			public HResult GetTypeInfo(char16* param0, out DIJOYTYPEINFO param1, uint32 param2) mut	=> VT.GetTypeInfo(ref this, param0, out param1, param2);
			public HResult SetTypeInfo(char16* param0, out DIJOYTYPEINFO param1, uint32 param2, char16* param3) mut	=> VT.SetTypeInfo(ref this, param0, out param1, param2, param3);
			public HResult DeleteType(char16* param0) mut	=> VT.DeleteType(ref this, param0);
			public HResult GetConfig(uint32 param0, out DIJOYCONFIG param1, uint32 param2) mut	=> VT.GetConfig(ref this, param0, out param1, param2);
			public HResult SetConfig(uint32 param0, out DIJOYCONFIG param1, uint32 param2) mut	=> VT.SetConfig(ref this, param0, out param1, param2);
			public HResult DeleteConfig(uint32 param0) mut	=> VT.DeleteConfig(ref this, param0);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig8 self, char16* param0, out DIJOYTYPEINFO param1, uint32 param2) GetTypeInfo;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig8 self, char16* param0, out DIJOYTYPEINFO param1, uint32 param2, char16* param3) SetTypeInfo;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig8 self, char16* param0) DeleteType;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDirectInputJoyConfig8 self, char16* param0, uint32 param1, out HKey param2) OpenTypeKey;
		...
		public static extern HResult DirectInput8Create(HInstance hinst, uint32 dwVersion, in Guid riidltf, void** ppvOut, IUnknown* punkOuter	= null);
		...
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_InitializeReportForID(HIDP_REPORT_TYPE ReportType, uint8 ReportID, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetData(HIDP_REPORT_TYPE ReportType, HIDP_DATA* DataList, out uint32 DataLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetData(HIDP_REPORT_TYPE ReportType, HIDP_DATA* DataList, out uint32 DataLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 HidP_MaxDataListLength(HIDP_REPORT_TYPE ReportType, int PreparsedData);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetUsages(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16* UsageList, out uint32 UsageLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_UnsetUsages(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16* UsageList, out uint32 UsageLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetUsages(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16* UsageList, out uint32 UsageLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetUsagesEx(HIDP_REPORT_TYPE ReportType, uint16 LinkCollection, USAGE_AND_PAGE* ButtonList, out uint32 UsageLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 HidP_MaxUsageListLength(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, int PreparsedData);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetUsageValue(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, uint32 UsageValue, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetScaledUsageValue(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, int32 UsageValue, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetUsageValueArray(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, char8* UsageValue, uint16 UsageValueByteLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetUsageValue(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, out uint32 UsageValue, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetScaledUsageValue(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, out int32 UsageValue, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetUsageValueArray(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, char8* UsageValue, uint16 UsageValueByteLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_GetButtonArray(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, HIDP_BUTTON_ARRAY_DATA* ButtonData, out uint16 ButtonDataLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern NTSTATUS HidP_SetButtonArray(HIDP_REPORT_TYPE ReportType, uint16 UsagePage, uint16 LinkCollection, uint16 Usage, HIDP_BUTTON_ARRAY_DATA* ButtonData, uint16 ButtonDataLength, int PreparsedData, char8* Report, uint32 ReportLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetAttributes(Handle HidDeviceObject, out HIDD_ATTRIBUTES Attributes);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void HidD_GetHidGuid(out Guid HidGuid);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetPreparsedData(Handle HidDeviceObject, out int PreparsedData);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_FreePreparsedData(int PreparsedData);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_FlushQueue(Handle HidDeviceObject);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetConfiguration(Handle HidDeviceObject, out HIDD_CONFIGURATION Configuration, uint32 ConfigurationLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_SetConfiguration(Handle HidDeviceObject, ref HIDD_CONFIGURATION Configuration, uint32 ConfigurationLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetFeature(Handle HidDeviceObject, void* ReportBuffer, uint32 ReportBufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_SetFeature(Handle HidDeviceObject, void* ReportBuffer, uint32 ReportBufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetInputReport(Handle HidDeviceObject, void* ReportBuffer, uint32 ReportBufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_SetOutputReport(Handle HidDeviceObject, void* ReportBuffer, uint32 ReportBufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetNumInputBuffers(Handle HidDeviceObject, out uint32 NumberBuffers);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_SetNumInputBuffers(Handle HidDeviceObject, uint32 NumberBuffers);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetPhysicalDescriptor(Handle HidDeviceObject, void* Buffer, uint32 BufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetManufacturerString(Handle HidDeviceObject, void* Buffer, uint32 BufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetProductString(Handle HidDeviceObject, void* Buffer, uint32 BufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetIndexedString(Handle HidDeviceObject, uint32 StringIndex, void* Buffer, uint32 BufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetSerialNumberString(Handle HidDeviceObject, void* Buffer, uint32 BufferLength);
		[Import("hid.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern bool HidD_GetMsGenreDescriptor(Handle HidDeviceObject, void* Buffer, uint32 BufferLength);
	}
}
