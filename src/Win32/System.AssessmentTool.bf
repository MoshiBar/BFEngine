...
namespace Win32
{
	extension Win32
	{
		...
		public struct IWinSATInitiateEvents : IUnknown
		{
			...
			public HResult WinSATComplete(HResult hresult, char16* strDescription) mut => VT.WinSATComplete(ref this, hresult, strDescription);
			public HResult WinSATUpdate(uint32 uCurrentTick, uint32 uTickTotal, char16* strCurrentState) mut => VT.WinSATUpdate(ref this, uCurrentTick, uTickTotal, strCurrentState);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IWinSATInitiateEvents self, HResult hresult, char16* strDescription) WinSATComplete;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWinSATInitiateEvents self, uint32 uCurrentTick, uint32 uTickTotal, char16* strCurrentState) WinSATUpdate;
			}
		}
		[CRepr]
		public struct IInitiateWinSATAssessment : IUnknown
		{
			...
			public HResult InitiateAssessment(char16* cmdLine, IWinSATInitiateEvents* pCallbacks, HWnd callerHwnd) mut => VT.InitiateAssessment(ref this, cmdLine, pCallbacks, callerHwnd);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IInitiateWinSATAssessment self, char16* cmdLine, IWinSATInitiateEvents* pCallbacks, HWnd callerHwnd) InitiateAssessment;
		...
		public struct IAccessibleWinSAT : IAccessible
		{
			...
			public HResult SetAccessiblityData(char16* wsName, char16* wsValue, char16* wsDesc) mut => VT.SetAccessiblityData(ref this, wsName, wsValue, wsDesc);

			[CRepr]
			public struct VTable : IAccessible.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAccessibleWinSAT self, char16* wsName, char16* wsValue, char16* wsDesc) SetAccessiblityData;
			}
		}
		[CRepr]
