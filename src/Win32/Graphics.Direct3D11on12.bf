...
using static Win32.Graphics.Direct3D12;
...
{
	static class Direct3D11On12
	{
		// --- Function Pointers ---
		
		public function HResult PFN_D3D11ON12_CREATE_DEVICE(ref IUnknown param0, uint32 param1, FeatureLevel* param2, uint32 FeatureLevels, IUnknown** param4, uint32 NumQueues, uint32 param6, ID3D11Device** param7, ID3D11DeviceContext** param8, FeatureLevel* param9);
		...
		public static extern HResult D3D11On12CreateDevice(ref IUnknown pDevice, uint32 Flags, FeatureLevel* pFeatureLevels, uint32 FeatureLevels, IUnknown** ppCommandQueues, uint32 NumQueues, uint32 NodeMask, ID3D11Device** ppDevice, ID3D11DeviceContext** ppImmediateContext, FeatureLevel* pChosenFeatureLevel);
	}
}
