...
using static Win32.NetworkManagement.WNet;
using static Win32.Graphics.Gdi;
using static Win32.Graphics.DirectComposition;
...
using static Win32.System.Console;
using static Win32.System.IO;
using static Win32.Storage.FileSystem;
using static Win32.System.Com.UrlMon;
...
namespace Win32.UI
{
	public static class Shell
	{
		...
		public function HResult PFNCANSHAREFOLDERW(char16* pszPath);
		public function HResult PFNSHOWSHAREFOLDERUIW(HWnd hwndParent, char16* pszPath);
		...
		public function void PAPPSTATE_CHANGE_ROUTINE(bool Quiesced, void* Context);
		public function void PAPPCONSTRAIN_CHANGE_ROUTINE(bool Constrained, void* Context);
		...
		public struct CMINVOKECOMMANDINFO
		{
			...
			public HWnd hwnd;
			public char8* lpVerb;
			public char8* lpParameters;
			public char8* lpDirectory;
			public int32 nShow;
		...
		public struct CMINVOKECOMMANDINFOEX
		{
			...
			public char16* lpVerbW;
			public char16* lpParametersW;
			public char16* lpDirectoryW;
			public char16* lpTitleW;
		...
		public struct CMINVOKECOMMANDINFOEX_REMOTE
		{
			...
			public uint32 fMask;
			public HWnd hwnd;
			public char8* lpVerbString;
			public char8* lpParameters;
			public char8* lpDirectory;
			public int32 nShow;
			public uint32 dwHotKey;
			public char8* lpTitle;
			public char16* lpVerbWString;
			public char16* lpParametersW;
			public char16* lpDirectoryW;
			public char16* lpTitleW;
			public POINT ptInvoke;
		...
		public struct KNOWNFOLDER_DEFINITION
		{
			...
			public char16* pszRelativePath;
			public char16* pszParsingName;
			public char16* pszTooltip;
			public char16* pszLocalizedName;
			public char16* pszIcon;
			public char16* pszSecurity;
			public uint32 dwAttributes;
		...
		public struct BANNER_NOTIFICATION
		{
			...
			public char16* providerIdentity;
			public char16* contentId;
		}
		[CRepr]
		...
		public struct NT_CONSOLE_PROPS
		{
			...
			public IntBool bFullScreen;
			public IntBool bQuickEdit;
			public IntBool bInsertMode;
			public IntBool bAutoPosition;
			public uint32 uHistoryBufferSize;
			public uint32 uNumberOfHistoryBuffers;
			public IntBool bHistoryNoDup;
		...
		public struct SHFOLDERCUSTOMSETTINGS
		{
			...
			public uint32 dwMask;
			public Guid* pvid;
			public char16* pszWebViewTemplate;
			public uint32 cchWebViewTemplate;
			public char16* pszWebViewTemplateVersion;
			public char16* pszInfoTip;
			public uint32 cchInfoTip;
			public Guid* pclsid;
			public uint32 dwFlags;
			public char16* pszIconFile;
			public uint32 cchIconFile;
			public int32 iIconIndex;
			public char16* pszLogo;
		...
		public struct BROWSEINFOA
		{
			...
			public char8* pszDisplayName;
			public char8* lpszTitle;
		...
		public struct BROWSEINFOW
		{
			public HWnd hwndOwner;
			public ITEMIDLIST* pidlRoot;
			public char16* pszDisplayName;
			public char16* lpszTitle;
			public uint32 ulFlags;
			public BFFCALLBACK lpfn;
			public LPARAM lParam;
			public int32 iImage;
		...
		public struct SHChangeNotifyEntry
		{
			...
			public IntBool fRecursive;
		}
		[CRepr, Packed(1)]
		public struct SHARDAPPIDINFO
		{
			public IShellItem* psi;
			public char16* pszAppID;
		}
		[CRepr, Packed(1)]
		...
		{
			public char16* pcszFile;
			public char16* pcszClass;
		...
		public struct SHFILEOPSTRUCTA
		{
			...
			public IntBool fAnyOperationsAborted;
			public void* hNameMappings;
			public char8* lpszProgressTitle;
		}
		[CRepr]
		public struct SHFILEOPSTRUCTW
		{
			...
			public IntBool fAnyOperationsAborted;
			public void* hNameMappings;
			public char16* lpszProgressTitle;
		}
		[CRepr]
		public struct SHNAMEMAPPINGA
		{
			public char8* pszOldPath;
			public char8* pszNewPath;
		...
		{
			public char16* pszOldPath;
			public char16* pszNewPath;
			public int32 cchOldPath;
			public int32 cchNewPath;
		}
		[CRepr]
		...
		public struct SHELLEXECUTEINFOW
		{
			...
			public uint32 fMask;
			public HWnd hwnd;
			public char16* lpVerb;
			public char16* lpFile;
			public char16* lpParameters;
			public char16* lpDirectory;
			public int32 nShow;
			public HInstance hInstApp;
			public void* lpIDList;
			public char16* lpClass;
			public HKey hkeyClass;
			public uint32 dwHotKey;
			public _Anonymous_e__Union Anonymous;
			public Handle hProcess;
		...
		public struct SHCREATEPROCESSINFOW
		{
			...
			public uint32 fMask;
			public HWnd hwnd;
			public char16* pszFile;
			public char16* pszParameters;
			public char16* pszCurrentDirectory;
			public Handle hUserToken;
			public SecurityAttributes* lpProcessAttributes;
			public SecurityAttributes* lpThreadAttributes;
			public IntBool bInheritHandles;
		...
		{
			public uint32 dwSize;
			public char8* pszSheetName;
			public uint32 uSheetIndex;
			public uint32 dwFlags;
			public IntBool bModal;
		}
		[CRepr]
		public struct OPEN_PRINTER_PROPS_INFOW
		{
			public uint32 dwSize;
			public char16* pszSheetName;
			public uint32 uSheetIndex;
			public uint32 dwFlags;
			public IntBool bModal;
		}
		...
		{
			public uint32 cbSize;
			public char8* pszProtocol;
			public uint32 cchProtocol;
			public char8* pszSuffix;
		...
		{
			public uint32 cbSize;
			public char16* pszProtocol;
			public uint32 cchProtocol;
			public char16* pszSuffix;
			public uint32 cchSuffix;
			public uint32 nScheme;
		}
		[CRepr]
		...
		public struct APPINFODATA
		{
			...
			public uint32 dwMask;
			public char16* pszDisplayName;
			public char16* pszVersion;
			public char16* pszPublisher;
			public char16* pszProductID;
			public char16* pszRegisteredOwner;
			public char16* pszRegisteredCompany;
			public char16* pszLanguage;
			public char16* pszSupportUrl;
			public char16* pszSupportTelephone;
			public char16* pszHelpLink;
			public char16* pszInstallLocation;
			public char16* pszInstallSource;
			public char16* pszInstallDate;
			public char16* pszContact;
			public char16* pszComments;
			public char16* pszImage;
			public char16* pszReadmeUrl;
			public char16* pszUpdateInfoUrl;
		}
		[CRepr]
		...
		public struct CONFIRM_CONFLICT_ITEM
		{
			...
			public char16* pszOriginalName;
			public char16* pszAlternateName;
			public char16* pszLocationShort;
			public char16* pszLocationFull;
			public SYNCMGR_CONFLICT_ITEM_TYPE nType;
		}
		[CRepr]
		public struct CONFIRM_CONFLICT_RESULT_INFO
		{
			public char16* pszNewName;
		...
		public struct WINDOWDATA
		{
			...
			public uint32 uiCP;
			public ITEMIDLIST* pidl;
			public char16* lpszUrl;
			public char16* lpszUrlLocation;
			public char16* lpszTitle;
		}
		[CRepr]
		...
		public struct HLBWINFO
		{
			...
			public RectI rcFramePos;
			public RectI rcDocPos;
		...
		public struct TOOLBARITEM
		{
			...
			public RectI rcBorderTool;
			public char16* pwszItem;
			public IntBool fShow;
		...
		public struct PROFILEINFOA
		{
			public uint32 dwSize;
			public uint32 dwFlags;
			public char8* lpUserName;
			public char8* lpProfilePath;
			public char8* lpDefaultPath;
			public char8* lpServerName;
			public char8* lpPolicyPath;
		...
		public struct PROFILEINFOW
		{
			public uint32 dwSize;
			public uint32 dwFlags;
			public char16* lpUserName;
			public char16* lpProfilePath;
			public char16* lpDefaultPath;
			public char16* lpServerName;
			public char16* lpPolicyPath;
			public Handle hProfile;
		}
		[CRepr]
		...
		public struct IContextMenu : IUnknown
		{
			...
			public HResult GetCommandString(uint idCmd, uint32 uType, out uint32 pReserved, char8* pszName, uint32 cchMax) mut => VT.GetCommandString(ref this, idCmd, uType, out pReserved, pszName, cchMax);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IContextMenu self, uint idCmd, uint32 uType, out uint32 pReserved, char8* pszName, uint32 cchMax) GetCommandString;
			}
		}
		[CRepr]
		...
		public struct IExecuteCommand : IUnknown
		{
			...
			public HResult SetParameters(char16* pszParameters) mut => VT.SetParameters(ref this, pszParameters);
			...
			public HResult SetNoShowUI(IntBool fNoShowUI) mut => VT.SetNoShowUI(ref this, fNoShowUI);
			public HResult SetDirectory(char16* pszDirectory) mut => VT.SetDirectory(ref this, pszDirectory);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExecuteCommand self, char16* pszParameters) SetParameters;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExecuteCommand self, IntBool fNoShowUI) SetNoShowUI;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExecuteCommand self, char16* pszDirectory) SetDirectory;
		...
		public struct IRunnableTask : IUnknown
		{
			...
			public HResult Kill(IntBool bWait) mut => VT.Kill(ref this, bWait);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IRunnableTask self, IntBool bWait) Kill;
		...
		public struct IShellTaskScheduler : IUnknown
		{
			...
			public HResult RemoveTasks(in Guid rtoid, uint lParam, IntBool bWaitIfRunning) mut => VT.RemoveTasks(ref this, rtoid, lParam, bWaitIfRunning);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellTaskScheduler self, in Guid rtoid, uint lParam, IntBool bWaitIfRunning) RemoveTasks;
		...
		public struct IFileSyncMergeHandler : IUnknown
		{
			...
			public HResult Merge(char16* localFilePath, char16* serverFilePath, out MERGE_UPDATE_STATUS updateStatus) mut => VT.Merge(ref this, localFilePath, serverFilePath, out updateStatus);
			public HResult ShowResolveConflictUIAsync(char16* localFilePath, HMONITOR monitorToDisplayOn) mut => VT.ShowResolveConflictUIAsync(ref this, localFilePath, monitorToDisplayOn);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSyncMergeHandler self, char16* localFilePath, char16* serverFilePath, out MERGE_UPDATE_STATUS updateStatus) Merge;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSyncMergeHandler self, char16* localFilePath, HMONITOR monitorToDisplayOn) ShowResolveConflictUIAsync;
			}
		}
		[CRepr]
		...
		public struct IShellFolder : IUnknown
		{
			...
			public HResult ParseDisplayName(HWnd hwnd, ref IBindCtx pbc, char16* pszDisplayName, out uint32 pchEaten, out ITEMIDLIST* ppidl, out uint32 pdwAttributes) mut => VT.ParseDisplayName(ref this, hwnd, ref pbc, pszDisplayName, out pchEaten, out ppidl, out pdwAttributes);
			public HResult EnumObjects(HWnd hwnd, uint32 grfFlags, out IEnumIDList* ppenumIDList) mut => VT._EnumObjects(ref this, hwnd, grfFlags, out ppenumIDList);
			...
			public HResult SetNameOf(HWnd hwnd, ref ITEMIDLIST pidl, char16* pszName, uint32 uFlags, ITEMIDLIST** ppidlOut) mut => VT.SetNameOf(ref this, hwnd, ref pidl, pszName, uFlags, ppidlOut);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolder self, HWnd hwnd, ref IBindCtx pbc, char16* pszDisplayName, out uint32 pchEaten, out ITEMIDLIST* ppidl, out uint32 pdwAttributes) ParseDisplayName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolder self, HWnd hwnd, uint32 grfFlags, out IEnumIDList* ppenumIDList) _EnumObjects;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolder self, HWnd hwnd, ref ITEMIDLIST pidl, char16* pszName, uint32 uFlags, ITEMIDLIST** ppidlOut) SetNameOf;
			}
		}
		[CRepr]
		...
		public struct IShellView : IOleWindow
		{
			...
			public HResult CreateViewWindow(ref IShellView psvPrevious, ref FOLDERSETTINGS pfs, ref IShellBrowser psb, ref RectI prcView, out HWnd phWnd) mut => VT.CreateViewWindow(ref this, ref psvPrevious, ref pfs, ref psb, ref prcView, out phWnd);
			...
			public struct VTable : IOleWindow.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellView self, IntBool fEnable) EnableModeless;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellView self, ref IShellView psvPrevious, ref FOLDERSETTINGS pfs, ref IShellBrowser psb, ref RectI prcView, out HWnd phWnd) CreateViewWindow;
		...
		public struct IFolderView2 : IFolderView
		{
			...
			public HResult SetGroupBy(in PROPERTYKEY key, IntBool fAscending) mut => VT.SetGroupBy(ref this, key, fAscending);
			public HResult GetGroupBy(out PROPERTYKEY pkey, IntBool* pfAscending) mut => VT.GetGroupBy(ref this, out pkey, pfAscending);
			...
			public HResult SetTileViewProperties(ref ITEMIDLIST pidl, char16* pszPropList) mut => VT.SetTileViewProperties(ref this, ref pidl, pszPropList);
			public HResult SetExtendedTileViewProperties(ref ITEMIDLIST pidl, char16* pszPropList) mut => VT.SetExtendedTileViewProperties(ref this, ref pidl, pszPropList);
			public HResult SetText(FVTEXTTYPE iType, char16* pwszText) mut => VT.SetText(ref this, iType, pwszText);
			...
			public HResult GetVisibleItem(int32 iStart, IntBool fPrevious, out int32 piItem) mut => VT.GetVisibleItem(ref this, iStart, fPrevious, out piItem);
			public HResult GetSelectedItem(int32 iStart, out int32 piItem) mut => VT.GetSelectedItem(ref this, iStart, out piItem);
			public HResult GetSelection(IntBool fNoneImpliesFolder, out IShellItemArray* ppsia) mut => VT.GetSelection(ref this, fNoneImpliesFolder, out ppsia);
			...
			public HResult InvokeVerbOnSelection(char8* pszVerb) mut => VT.InvokeVerbOnSelection(ref this, pszVerb);
			...
			public HResult SetRedraw(IntBool fRedrawOn) mut => VT.SetRedraw(ref this, fRedrawOn);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, in PROPERTYKEY key, IntBool fAscending) SetGroupBy;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, out PROPERTYKEY pkey, IntBool* pfAscending) GetGroupBy;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, ref ITEMIDLIST pidl, char16* pszPropList) SetTileViewProperties;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, ref ITEMIDLIST pidl, char16* pszPropList) SetExtendedTileViewProperties;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, FVTEXTTYPE iType, char16* pwszText) SetText;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, int32 iStart, IntBool fPrevious, out int32 piItem) GetVisibleItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, IntBool fNoneImpliesFolder, out IShellItemArray* ppsia) GetSelection;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, char8* pszVerb) InvokeVerbOnSelection;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderView2 self, IntBool fRedrawOn) SetRedraw;
		...
		public struct IFolderViewSettings : IUnknown
		{
			...
			public HResult GetGroupByProperty(out PROPERTYKEY pkey, out IntBool pfGroupAscending) mut => VT.GetGroupByProperty(ref this, out pkey, out pfGroupAscending);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderViewSettings self, out PROPERTYKEY pkey, out IntBool pfGroupAscending) GetGroupByProperty;
		...
		public struct IInitializeNetworkFolder : IUnknown
		{
			...
			public HResult Initialize(ref ITEMIDLIST pidl, ref ITEMIDLIST pidlTarget, uint32 uDisplayType, char16* pszResName, char16* pszProvider) mut => VT.Initialize(ref this, ref pidl, ref pidlTarget, uDisplayType, pszResName, pszProvider);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IInitializeNetworkFolder self, ref ITEMIDLIST pidl, ref ITEMIDLIST pidlTarget, uint32 uDisplayType, char16* pszResName, char16* pszProvider) Initialize;
			}
		}
		[CRepr]
		...
		public struct IPreviewHandlerVisuals : IUnknown
		{
			...
			public HResult SetTextColor(uint32 color) mut => VT._SetTextColor(ref this, color);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IPreviewHandlerVisuals self, uint32 color) _SetTextColor;
			}
		}
		[CRepr]
		...
		public struct IInputObjectSite : IUnknown
		{
			...
			public HResult OnFocusChangeIS(ref IUnknown punkObj, IntBool fSetFocus) mut => VT.OnFocusChangeIS(ref this, ref punkObj, fSetFocus);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IInputObjectSite self, ref IUnknown punkObj, IntBool fSetFocus) OnFocusChangeIS;
			}
		}
		[CRepr]
		public struct IInputObject : IUnknown
		{
			...
			public HResult UIActivateIO(IntBool fActivate, ref MSG pMsg) mut => VT.UIActivateIO(ref this, fActivate, ref pMsg);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IInputObject self, IntBool fActivate, ref MSG pMsg) UIActivateIO;
		...
		public struct IShellBrowser : IOleWindow
		{
			...
			public HResult SetStatusTextSB(char16* pszStatusText) mut => VT.SetStatusTextSB(ref this, pszStatusText);
			public HResult EnableModelessSB(IntBool fEnable) mut => VT.EnableModelessSB(ref this, fEnable);
			...
			public struct VTable : IOleWindow.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellBrowser self, char16* pszStatusText) SetStatusTextSB;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellBrowser self, IntBool fEnable) EnableModelessSB;
		...
		public struct IShellItem : IUnknown
		{
			...
			public HResult GetParent(out IShellItem* ppsi) mut => VT._GetParent(ref this, out ppsi);
			public HResult GetDisplayName(SIGDN sigdnName, out char16* ppszName) mut => VT.GetDisplayName(ref this, sigdnName, out ppszName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem self, out IShellItem* ppsi) _GetParent;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem self, SIGDN sigdnName, out char16* ppszName) GetDisplayName;
		...
		public struct IShellItem2 : IShellItem
		{
			...
			public HResult GetFileTime(in PROPERTYKEY key, out FileTime pft) mut => VT._GetFileTime(ref this, key, out pft);
			public HResult GetInt32(in PROPERTYKEY key, out int32 pi) mut => VT.GetInt32(ref this, key, out pi);
			public HResult GetString(in PROPERTYKEY key, out char16* ppsz) mut => VT.GetString(ref this, key, out ppsz);
			...
			public HResult GetBool(in PROPERTYKEY key, out IntBool pf) mut => VT.GetBool(ref this, key, out pf);
			...
			public struct VTable : IShellItem.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem2 self, in PROPERTYKEY key, out FileTime pft) _GetFileTime;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem2 self, in PROPERTYKEY key, out int32 pi) GetInt32;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem2 self, in PROPERTYKEY key, out char16* ppsz) GetString;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItem2 self, in PROPERTYKEY key, out IntBool pf) GetBool;
			}
		}
		[CRepr]
		...
		public struct ITransferAdviseSink : IUnknown
		{
			...
			public HResult ConfirmOverwrite(ref IShellItem psiSource, ref IShellItem psiDestParent, char16* pszName) mut => VT.ConfirmOverwrite(ref this, ref psiSource, ref psiDestParent, pszName);
			public HResult ConfirmEncryptionLoss(ref IShellItem psiSource) mut => VT.ConfirmEncryptionLoss(ref this, ref psiSource);
			public HResult FileFailure(ref IShellItem psi, char16* pszItem, HResult hrError, char16* pszRename, uint32 cchRename) mut => VT.FileFailure(ref this, ref psi, pszItem, hrError, pszRename, cchRename);
			public HResult SubStreamFailure(ref IShellItem psi, char16* pszStreamName, HResult hrError) mut => VT.SubStreamFailure(ref this, ref psi, pszStreamName, hrError);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferAdviseSink self, ref IShellItem psiSource, ref IShellItem psiDestParent, char16* pszName) ConfirmOverwrite;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferAdviseSink self, ref IShellItem psi, char16* pszItem, HResult hrError, char16* pszRename, uint32 cchRename) FileFailure;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferAdviseSink self, ref IShellItem psi, char16* pszStreamName, HResult hrError) SubStreamFailure;
		...
		public struct ITransferSource : IUnknown
		{
			...
			public HResult MoveItem(ref IShellItem psi, ref IShellItem psiParentDst, char16* pszNameDst, uint32 flags, out IShellItem* ppsiNew) mut => VT.MoveItem(ref this, ref psi, ref psiParentDst, pszNameDst, flags, out ppsiNew);
			...
			public HResult RenameItem(ref IShellItem psiSource, char16* pszNewName, uint32 flags, out IShellItem* ppsiNewDest) mut => VT.RenameItem(ref this, ref psiSource, pszNewName, flags, out ppsiNewDest);
			public HResult LinkItem(ref IShellItem psiSource, ref IShellItem psiParentDest, char16* pszNewName, uint32 flags, out IShellItem* ppsiNewDest) mut => VT.LinkItem(ref this, ref psiSource, ref psiParentDest, pszNewName, flags, out ppsiNewDest);
			...
			public HResult GetDefaultDestinationName(ref IShellItem psiSource, ref IShellItem psiParentDest, out char16* ppszDestinationName) mut => VT.GetDefaultDestinationName(ref this, ref psiSource, ref psiParentDest, out ppszDestinationName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferSource self, ref IShellItem psi, ref IShellItem psiParentDst, char16* pszNameDst, uint32 flags, out IShellItem* ppsiNew) MoveItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferSource self, ref IShellItem psiSource, char16* pszNewName, uint32 flags, out IShellItem* ppsiNewDest) RenameItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferSource self, ref IShellItem psiSource, ref IShellItem psiParentDest, char16* pszNewName, uint32 flags, out IShellItem* ppsiNewDest) LinkItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferSource self, ref IShellItem psiSource, ref IShellItem psiParentDest, out char16* ppszDestinationName) GetDefaultDestinationName;
		...
		public struct IShellItemResources : IUnknown
		{
			...
			public HResult GetResourceDescription(in SHELL_ITEM_RESOURCE pcsir, out char16* ppszDescription) mut => VT.GetResourceDescription(ref this, pcsir, out ppszDescription);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellItemResources self, in SHELL_ITEM_RESOURCE pcsir, out char16* ppszDescription) GetResourceDescription;
		...
		public struct ITransferDestination : IUnknown
		{
			...
			public HResult Advise(ref ITransferAdviseSink psink, out uint32 pdwCookie) mut => VT.Advise(ref this, ref psink, out pdwCookie);
			public HResult Unadvise(uint32 dwCookie) mut => VT.Unadvise(ref this, dwCookie);
			public HResult CreateItem(char16* pszName, uint32 dwAttributes, uint64 ullSize, uint32 flags, in Guid riidItem, void** ppvItem, in Guid riidResources, void** ppvResources) mut => VT.CreateItem(ref this, pszName, dwAttributes, ullSize, flags, riidItem, ppvItem, riidResources, ppvResources);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITransferDestination self, char16* pszName, uint32 dwAttributes, uint64 ullSize, uint32 flags, in Guid riidItem, void** ppvItem, in Guid riidResources, void** ppvResources) CreateItem;
			}
		}
		[CRepr]
		public struct IFileOperationProgressSink : IUnknown
		{
			...
			public HResult PreRenameItem(uint32 dwFlags, ref IShellItem psiItem, char16* pszNewName) mut => VT.PreRenameItem(ref this, dwFlags, ref psiItem, pszNewName);
			public HResult PostRenameItem(uint32 dwFlags, ref IShellItem psiItem, char16* pszNewName, HResult hrRename, ref IShellItem psiNewlyCreated) mut => VT.PostRenameItem(ref this, dwFlags, ref psiItem, pszNewName, hrRename, ref psiNewlyCreated);
			public HResult PreMoveItem(uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName) mut => VT.PreMoveItem(ref this, dwFlags, ref psiItem, ref psiDestinationFolder, pszNewName);
			public HResult PostMoveItem(uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, HResult hrMove, ref IShellItem psiNewlyCreated) mut => VT.PostMoveItem(ref this, dwFlags, ref psiItem, ref psiDestinationFolder, pszNewName, hrMove, ref psiNewlyCreated);
			public HResult PreCopyItem(uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName) mut => VT.PreCopyItem(ref this, dwFlags, ref psiItem, ref psiDestinationFolder, pszNewName);
			public HResult PostCopyItem(uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, HResult hrCopy, ref IShellItem psiNewlyCreated) mut => VT.PostCopyItem(ref this, dwFlags, ref psiItem, ref psiDestinationFolder, pszNewName, hrCopy, ref psiNewlyCreated);
			...
			public HResult PreNewItem(uint32 dwFlags, ref IShellItem psiDestinationFolder, char16* pszNewName) mut => VT.PreNewItem(ref this, dwFlags, ref psiDestinationFolder, pszNewName);
			public HResult PostNewItem(uint32 dwFlags, ref IShellItem psiDestinationFolder, char16* pszNewName, char16* pszTemplateName, uint32 dwFileAttributes, HResult hrNew, ref IShellItem psiNewItem) mut => VT.PostNewItem(ref this, dwFlags, ref psiDestinationFolder, pszNewName, pszTemplateName, dwFileAttributes, hrNew, ref psiNewItem);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, char16* pszNewName) PreRenameItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, char16* pszNewName, HResult hrRename, ref IShellItem psiNewlyCreated) PostRenameItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName) PreMoveItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, HResult hrMove, ref IShellItem psiNewlyCreated) PostMoveItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName) PreCopyItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, HResult hrCopy, ref IShellItem psiNewlyCreated) PostCopyItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiDestinationFolder, char16* pszNewName) PreNewItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperationProgressSink self, uint32 dwFlags, ref IShellItem psiDestinationFolder, char16* pszNewName, char16* pszTemplateName, uint32 dwFileAttributes, HResult hrNew, ref IShellItem psiNewItem) PostNewItem;
		...
		public struct IDropTargetHelper : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDropTargetHelper self, IntBool fShow) Show;
			}
		}
		[CRepr]
		...
		public struct IShellLinkA : IUnknown
		{
			...
			public HResult GetPath(uint8* pszFile, int32 cch, out WIN32_FIND_DATAA pfd, uint32 fFlags) mut => VT._GetPath(ref this, pszFile, cch, out pfd, fFlags);
			public HResult GetIDList(out ITEMIDLIST* ppidl) mut => VT.GetIDList(ref this, out ppidl);
			public HResult SetIDList(ref ITEMIDLIST pidl) mut => VT.SetIDList(ref this, ref pidl);
			public HResult GetDescription(uint8* pszName, int32 cch) mut => VT.GetDescription(ref this, pszName, cch);
			public HResult SetDescription(char8* pszName) mut => VT.SetDescription(ref this, pszName);
			public HResult GetWorkingDirectory(uint8* pszDir, int32 cch) mut => VT.GetWorkingDirectory(ref this, pszDir, cch);
			public HResult SetWorkingDirectory(char8* pszDir) mut => VT.SetWorkingDirectory(ref this, pszDir);
			public HResult GetArguments(uint8* pszArgs, int32 cch) mut => VT.GetArguments(ref this, pszArgs, cch);
			public HResult SetArguments(char8* pszArgs) mut => VT.SetArguments(ref this, pszArgs);
			...
			public HResult SetIconLocation(char8* pszIconPath, int32 iIcon) mut => VT.SetIconLocation(ref this, pszIconPath, iIcon);
			public HResult SetRelativePath(char8* pszPathRel, uint32 dwReserved) mut => VT.SetRelativePath(ref this, pszPathRel, dwReserved);
			public HResult Resolve(HWnd hwnd, uint32 fFlags) mut => VT.Resolve(ref this, hwnd, fFlags);
			public HResult SetPath(char8* pszFile) mut => VT.SetPath(ref this, pszFile);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, uint8* pszFile, int32 cch, out WIN32_FIND_DATAA pfd, uint32 fFlags) _GetPath;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszName) SetDescription;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, uint8* pszDir, int32 cch) GetWorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszDir) SetWorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, uint8* pszArgs, int32 cch) GetArguments;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszArgs) SetArguments;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszIconPath, int32 iIcon) SetIconLocation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszPathRel, uint32 dwReserved) SetRelativePath;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, HWnd hwnd, uint32 fFlags) Resolve;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkA self, char8* pszFile) SetPath;
			}
		}
		[CRepr]
		public struct IShellLinkW : IUnknown
		{
			...
			public HResult GetPath(char16* pszFile, int32 cch, out WIN32_FIND_DATAW pfd, uint32 fFlags) mut => VT._GetPath(ref this, pszFile, cch, out pfd, fFlags);
			public HResult GetIDList(out ITEMIDLIST* ppidl) mut => VT.GetIDList(ref this, out ppidl);
			public HResult SetIDList(ref ITEMIDLIST pidl) mut => VT.SetIDList(ref this, ref pidl);
			public HResult GetDescription(char16* pszName, int32 cch) mut => VT.GetDescription(ref this, pszName, cch);
			public HResult SetDescription(char16* pszName) mut => VT.SetDescription(ref this, pszName);
			public HResult GetWorkingDirectory(char16* pszDir, int32 cch) mut => VT.GetWorkingDirectory(ref this, pszDir, cch);
			public HResult SetWorkingDirectory(char16* pszDir) mut => VT.SetWorkingDirectory(ref this, pszDir);
			public HResult GetArguments(char16* pszArgs, int32 cch) mut => VT.GetArguments(ref this, pszArgs, cch);
			public HResult SetArguments(char16* pszArgs) mut => VT.SetArguments(ref this, pszArgs);
			public HResult GetHotkey(out uint16 pwHotkey) mut => VT.GetHotkey(ref this, out pwHotkey);
			public HResult SetHotkey(uint16 wHotkey) mut => VT.SetHotkey(ref this, wHotkey);
			public HResult GetShowCmd(out int32 piShowCmd) mut => VT.GetShowCmd(ref this, out piShowCmd);
			public HResult SetShowCmd(int32 iShowCmd) mut => VT.SetShowCmd(ref this, iShowCmd);
			...
			public HResult SetIconLocation(char16* pszIconPath, int32 iIcon) mut => VT.SetIconLocation(ref this, pszIconPath, iIcon);
			public HResult SetRelativePath(char16* pszPathRel, uint32 dwReserved) mut => VT.SetRelativePath(ref this, pszPathRel, dwReserved);
			public HResult Resolve(HWnd hwnd, uint32 fFlags) mut => VT.Resolve(ref this, hwnd, fFlags);
			public HResult SetPath(char16* pszFile) mut => VT.SetPath(ref this, pszFile);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszFile, int32 cch, out WIN32_FIND_DATAW pfd, uint32 fFlags) _GetPath;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszName) SetDescription;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszDir, int32 cch) GetWorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszDir) SetWorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszArgs, int32 cch) GetArguments;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszArgs) SetArguments;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszIconPath, int32 iIcon) SetIconLocation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszPathRel, uint32 dwReserved) SetRelativePath;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, HWnd hwnd, uint32 fFlags) Resolve;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkW self, char16* pszFile) SetPath;
			}
		}
		[CRepr]
		...
		public struct IActionProgressDialog : IUnknown
		{
			...
			public HResult Initialize(uint32 flags, char16* pszTitle, char16* pszCancel) mut => VT.Initialize(ref this, flags, pszTitle, pszCancel);
			public HResult Stop() mut => VT.Stop(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IActionProgressDialog self, uint32 flags, char16* pszTitle, char16* pszCancel) Initialize;
		...
		public struct IActionProgress : IUnknown
		{
			...
			public HResult UpdateText(SPTEXT sptext, char16* pszText, IntBool fMayCompact) mut => VT.UpdateText(ref this, sptext, pszText, fMayCompact);
			public HResult QueryCancel(out IntBool pfCancelled) mut => VT.QueryCancel(ref this, out pfCancelled);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IActionProgress self, SPTEXT sptext, char16* pszText, IntBool fMayCompact) UpdateText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IActionProgress self, out IntBool pfCancelled) QueryCancel;
		...
		public struct IRemoteComputer : IUnknown
		{
			...
			public HResult Initialize(char16* pszMachine, IntBool bEnumerating) mut => VT.Initialize(ref this, pszMachine, bEnumerating);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IRemoteComputer self, char16* pszMachine, IntBool bEnumerating) Initialize;
			}
		}
		[CRepr]
		...
		public struct IUserNotification : IUnknown
		{
			...
			public HResult SetBalloonInfo(char16* pszTitle, char16* pszText, uint32 dwInfoFlags) mut => VT.SetBalloonInfo(ref this, pszTitle, pszText, dwInfoFlags);
			...
			public HResult SetIconInfo(HICON hIcon, char16* pszToolTip) mut => VT.SetIconInfo(ref this, hIcon, pszToolTip);
			...
			public HResult PlaySound(char16* pszSoundName) mut => VT.PlaySound(ref this, pszSoundName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification self, char16* pszTitle, char16* pszText, uint32 dwInfoFlags) SetBalloonInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification self, HICON hIcon, char16* pszToolTip) SetIconInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification self, char16* pszSoundName) PlaySound;
			}
		}
		[CRepr]
		public struct IItemNameLimits : IUnknown
		{
			...
			public HResult GetValidCharacters(out char16* ppwszValidChars, out char16* ppwszInvalidChars) mut => VT.GetValidCharacters(ref this, out ppwszValidChars, out ppwszInvalidChars);
			public HResult GetMaxLength(char16* pszName, out int32 piMaxNameLen) mut => VT.GetMaxLength(ref this, pszName, out piMaxNameLen);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IItemNameLimits self, out char16* ppwszValidChars, out char16* ppwszInvalidChars) GetValidCharacters;
				public new function [CallingConvention(.Stdcall)] HResult(ref IItemNameLimits self, char16* pszName, out int32 piMaxNameLen) GetMaxLength;
			}
		}
		[CRepr]
		public struct ISearchFolderItemFactory : IUnknown
		{
			...
			public HResult SetDisplayName(char16* pszDisplayName) mut => VT.SetDisplayName(ref this, pszDisplayName);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISearchFolderItemFactory self, char16* pszDisplayName) SetDisplayName;
		...
		public struct IDockingWindow : IOleWindow
		{
			...
			public HResult ShowDW(IntBool fShow) mut => VT.ShowDW(ref this, fShow);
			public HResult CloseDW(uint32 dwReserved) mut => VT.CloseDW(ref this, dwReserved);
			public HResult ResizeBorderDW(ref RectI prcBorder, ref IUnknown punkToolbarSite, IntBool fReserved) mut => VT.ResizeBorderDW(ref this, ref prcBorder, ref punkToolbarSite, fReserved);

			[CRepr]
			public struct VTable : IOleWindow.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindow self, IntBool fShow) ShowDW;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindow self, uint32 dwReserved) CloseDW;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindow self, ref RectI prcBorder, ref IUnknown punkToolbarSite, IntBool fReserved) ResizeBorderDW;
			}
		}
		[CRepr]
		...
		public struct ITaskbarList2 : ITaskbarList
		{
			...
			public HResult MarkFullscreenWindow(HWnd hwnd, IntBool fFullscreen) mut => VT.MarkFullscreenWindow(ref this, hwnd, fFullscreen);

			[CRepr]
			public struct VTable : ITaskbarList.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskbarList2 self, HWnd hwnd, IntBool fFullscreen) MarkFullscreenWindow;
			}
		}
		[CRepr]
		public struct ITaskbarList3 : ITaskbarList2
		{
			...
			public HResult SetOverlayIcon(HWnd hwnd, HICON hIcon, char16* pszDescription) mut => VT.SetOverlayIcon(ref this, hwnd, hIcon, pszDescription);
			public HResult SetThumbnailTooltip(HWnd hwnd, char16* pszTip) mut => VT.SetThumbnailTooltip(ref this, hwnd, pszTip);
			public HResult SetThumbnailClip(HWnd hwnd, ref RectI prcClip) mut => VT.SetThumbnailClip(ref this, hwnd, ref prcClip);
			...
			public struct VTable : ITaskbarList2.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskbarList3 self, HWnd hwnd, HICON hIcon, char16* pszDescription) SetOverlayIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskbarList3 self, HWnd hwnd, char16* pszTip) SetThumbnailTooltip;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITaskbarList3 self, HWnd hwnd, ref RectI prcClip) SetThumbnailClip;
			}
		}
		[CRepr]
		...
		public struct IExplorerBrowser : IUnknown
		{
			...
			public HResult Initialize(HWnd hwndParent, in RectI prc, FOLDERSETTINGS* pfs) mut => VT.Initialize(ref this, hwndParent, prc, pfs);
			public HResult Destroy() mut => VT.Destroy(ref this);
			public HResult SetRect(int* phdwp, RectI rcBrowser) mut => VT._SetRect(ref this, phdwp, rcBrowser);
			public HResult SetPropertyBag(char16* pszPropertyBag) mut => VT.SetPropertyBag(ref this, pszPropertyBag);
			public HResult SetEmptyText(char16* pszEmptyText) mut => VT.SetEmptyText(ref this, pszEmptyText);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerBrowser self, HWnd hwndParent, in RectI prc, FOLDERSETTINGS* pfs) Initialize;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerBrowser self) Destroy;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerBrowser self, int* phdwp, RectI rcBrowser) _SetRect;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerBrowser self, char16* pszPropertyBag) SetPropertyBag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerBrowser self, char16* pszEmptyText) SetEmptyText;
		...
		public struct IFileOperation : IUnknown
		{
			...
			public HResult SetProgressMessage(char16* pszMessage) mut => VT.SetProgressMessage(ref this, pszMessage);
			...
			public HResult RenameItem(ref IShellItem psiItem, char16* pszNewName, ref IFileOperationProgressSink pfopsItem) mut => VT.RenameItem(ref this, ref psiItem, pszNewName, ref pfopsItem);
			public HResult RenameItems(ref IUnknown pUnkItems, char16* pszNewName) mut => VT.RenameItems(ref this, ref pUnkItems, pszNewName);
			public HResult MoveItem(ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, ref IFileOperationProgressSink pfopsItem) mut => VT.MoveItem(ref this, ref psiItem, ref psiDestinationFolder, pszNewName, ref pfopsItem);
			...
			public HResult CopyItem(ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszCopyName, ref IFileOperationProgressSink pfopsItem) mut => VT.CopyItem(ref this, ref psiItem, ref psiDestinationFolder, pszCopyName, ref pfopsItem);
			...
			public HResult NewItem(ref IShellItem psiDestinationFolder, uint32 dwFileAttributes, char16* pszName, char16* pszTemplateName, ref IFileOperationProgressSink pfopsItem) mut => VT.NewItem(ref this, ref psiDestinationFolder, dwFileAttributes, pszName, pszTemplateName, ref pfopsItem);
			public HResult PerformOperations() mut => VT.PerformOperations(ref this);
			public HResult GetAnyOperationsAborted(out IntBool pfAnyOperationsAborted) mut => VT.GetAnyOperationsAborted(ref this, out pfAnyOperationsAborted);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, char16* pszMessage) SetProgressMessage;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, ref IShellItem psiItem, char16* pszNewName, ref IFileOperationProgressSink pfopsItem) RenameItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, ref IUnknown pUnkItems, char16* pszNewName) RenameItems;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszNewName, ref IFileOperationProgressSink pfopsItem) MoveItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, ref IShellItem psiItem, ref IShellItem psiDestinationFolder, char16* pszCopyName, ref IFileOperationProgressSink pfopsItem) CopyItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, ref IShellItem psiDestinationFolder, uint32 dwFileAttributes, char16* pszName, char16* pszTemplateName, ref IFileOperationProgressSink pfopsItem) NewItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self) PerformOperations;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileOperation self, out IntBool pfAnyOperationsAborted) GetAnyOperationsAborted;
			}
		}
		[CRepr]
		...
		public struct INamespaceWalkCB : IUnknown
		{
			...
			public HResult InitializeProgressDialog(out char16* ppszTitle, out char16* ppszCancel) mut => VT.InitializeProgressDialog(ref this, out ppszTitle, out ppszCancel);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INamespaceWalkCB self, out char16* ppszTitle, out char16* ppszCancel) InitializeProgressDialog;
			}
		}
		[CRepr]
		...
		public struct IRegTreeItem : IUnknown
		{
			...
			public HResult GetCheckState(out IntBool pbCheck) mut => VT.GetCheckState(ref this, out pbCheck);
			public HResult SetCheckState(IntBool bCheck) mut => VT.SetCheckState(ref this, bCheck);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IRegTreeItem self, out IntBool pbCheck) GetCheckState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IRegTreeItem self, IntBool bCheck) SetCheckState;
			}
		}
		[CRepr]
		public struct IDeskBar : IOleWindow
		{
			...
			public HResult OnPosRectChangeDB(ref RectI prc) mut => VT.OnPosRectChangeDB(ref this, ref prc);
			...
			public struct VTable : IOleWindow.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDeskBar self, ref RectI prc) OnPosRectChangeDB;
			}
		}
		[CRepr]
		public struct IMenuPopup : IDeskBar
		{
			...
			public HResult SetSubMenu(ref IMenuPopup pmp, IntBool fSet) mut => VT.SetSubMenu(ref this, ref pmp, fSet);
			...
			public struct VTable : IDeskBar.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IMenuPopup self, ref IMenuPopup pmp, IntBool fSet) SetSubMenu;
			}
		}
		[CRepr]
		public struct IFileIsInUse : IUnknown
		{
			...
			public HResult GetAppName(out char16* ppszName) mut => VT.GetAppName(ref this, out ppszName);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileIsInUse self, out char16* ppszName) GetAppName;
		...
		public struct IFileDialog : IModalWindow
		{
			...
			public HResult SetFileName(char16* pszName) mut => VT.SetFileName(ref this, pszName);
			public HResult GetFileName(out char16* pszName) mut => VT.GetFileName(ref this, out pszName);
			public HResult SetTitle(char16* pszTitle) mut => VT.SetTitle(ref this, pszTitle);
			public HResult SetOkButtonLabel(char16* pszText) mut => VT.SetOkButtonLabel(ref this, pszText);
			public HResult SetFileNameLabel(char16* pszLabel) mut => VT.SetFileNameLabel(ref this, pszLabel);
			...
			public HResult SetDefaultExtension(char16* pszDefaultExtension) mut => VT.SetDefaultExtension(ref this, pszDefaultExtension);
			...
			public struct VTable : IModalWindow.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, char16* pszName) SetFileName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, out char16* pszName) GetFileName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, char16* pszTitle) SetTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, char16* pszText) SetOkButtonLabel;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, char16* pszLabel) SetFileNameLabel;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog self, char16* pszDefaultExtension) SetDefaultExtension;
		...
		public struct IFileSaveDialog : IFileDialog
		{
			...
			public HResult SetCollectedProperties(ref IPropertyDescriptionList pList, IntBool fAppendDefault) mut => VT.SetCollectedProperties(ref this, ref pList, fAppendDefault);
			...
			public struct VTable : IFileDialog.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSaveDialog self, ref IPropertyDescriptionList pList, IntBool fAppendDefault) SetCollectedProperties;
		...
		public struct IFileDialogCustomize : IUnknown
		{
			...
			public HResult AddMenu(uint32 dwIDCtl, char16* pszLabel) mut => VT.AddMenu(ref this, dwIDCtl, pszLabel);
			public HResult AddPushButton(uint32 dwIDCtl, char16* pszLabel) mut => VT.AddPushButton(ref this, dwIDCtl, pszLabel);
			...
			public HResult AddCheckButton(uint32 dwIDCtl, char16* pszLabel, IntBool bChecked) mut => VT.AddCheckButton(ref this, dwIDCtl, pszLabel, bChecked);
			public HResult AddEditBox(uint32 dwIDCtl, char16* pszText) mut => VT.AddEditBox(ref this, dwIDCtl, pszText);
			public HResult AddSeparator(uint32 dwIDCtl) mut => VT.AddSeparator(ref this, dwIDCtl);
			public HResult AddText(uint32 dwIDCtl, char16* pszText) mut => VT.AddText(ref this, dwIDCtl, pszText);
			public HResult SetControlLabel(uint32 dwIDCtl, char16* pszLabel) mut => VT.SetControlLabel(ref this, dwIDCtl, pszLabel);
			...
			public HResult SetEditBoxText(uint32 dwIDCtl, char16* pszText) mut => VT.SetEditBoxText(ref this, dwIDCtl, pszText);
			public HResult GetCheckButtonState(uint32 dwIDCtl, out IntBool pbChecked) mut => VT.GetCheckButtonState(ref this, dwIDCtl, out pbChecked);
			public HResult SetCheckButtonState(uint32 dwIDCtl, IntBool bChecked) mut => VT.SetCheckButtonState(ref this, dwIDCtl, bChecked);
			public HResult AddControlItem(uint32 dwIDCtl, uint32 dwIDItem, char16* pszLabel) mut => VT.AddControlItem(ref this, dwIDCtl, dwIDItem, pszLabel);
			...
			public HResult StartVisualGroup(uint32 dwIDCtl, char16* pszLabel) mut => VT.StartVisualGroup(ref this, dwIDCtl, pszLabel);
			...
			public HResult SetControlItemText(uint32 dwIDCtl, uint32 dwIDItem, char16* pszLabel) mut => VT.SetControlItemText(ref this, dwIDCtl, dwIDItem, pszLabel);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl) EnableOpenDropDown;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszLabel) AddMenu;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszLabel) AddPushButton;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszLabel, IntBool bChecked) AddCheckButton;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszText) AddEditBox;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl) AddSeparator;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszText) AddText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszLabel) SetControlLabel;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszText) SetEditBoxText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, out IntBool pbChecked) GetCheckButtonState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, IntBool bChecked) SetCheckButtonState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, uint32 dwIDItem, char16* pszLabel) AddControlItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, char16* pszLabel) StartVisualGroup;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogCustomize self, uint32 dwIDCtl, uint32 dwIDItem, char16* pszLabel) SetControlItemText;
			}
		}
		[CRepr]
		public struct IApplicationAssociationRegistration : IUnknown
		{
			...
			public HResult QueryCurrentDefault(char16* pszQuery, ASSOCIATIONTYPE atQueryType, ASSOCIATIONLEVEL alQueryLevel, out char16* ppszAssociation) mut => VT.QueryCurrentDefault(ref this, pszQuery, atQueryType, alQueryLevel, out ppszAssociation);
			public HResult QueryAppIsDefault(char16* pszQuery, ASSOCIATIONTYPE atQueryType, ASSOCIATIONLEVEL alQueryLevel, char16* pszAppRegistryName, out IntBool pfDefault) mut => VT.QueryAppIsDefault(ref this, pszQuery, atQueryType, alQueryLevel, pszAppRegistryName, out pfDefault);
			public HResult QueryAppIsDefaultAll(ASSOCIATIONLEVEL alQueryLevel, char16* pszAppRegistryName, out IntBool pfDefault) mut => VT.QueryAppIsDefaultAll(ref this, alQueryLevel, pszAppRegistryName, out pfDefault);
			public HResult SetAppAsDefault(char16* pszAppRegistryName, char16* pszSet, ASSOCIATIONTYPE atSetType) mut => VT.SetAppAsDefault(ref this, pszAppRegistryName, pszSet, atSetType);
			public HResult SetAppAsDefaultAll(char16* pszAppRegistryName) mut => VT.SetAppAsDefaultAll(ref this, pszAppRegistryName);
			public HResult ClearUserAssociations() mut => VT.ClearUserAssociations(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistration self, char16* pszQuery, ASSOCIATIONTYPE atQueryType, ASSOCIATIONLEVEL alQueryLevel, out char16* ppszAssociation) QueryCurrentDefault;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistration self, char16* pszQuery, ASSOCIATIONTYPE atQueryType, ASSOCIATIONLEVEL alQueryLevel, char16* pszAppRegistryName, out IntBool pfDefault) QueryAppIsDefault;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistration self, ASSOCIATIONLEVEL alQueryLevel, char16* pszAppRegistryName, out IntBool pfDefault) QueryAppIsDefaultAll;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistration self, char16* pszAppRegistryName, char16* pszSet, ASSOCIATIONTYPE atSetType) SetAppAsDefault;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistration self, char16* pszAppRegistryName) SetAppAsDefaultAll;
		...
		public struct INewWindowManager : IUnknown
		{
			...
			public HResult EvaluateNewWindow(char16* pszUrl, char16* pszName, char16* pszUrlContext, char16* pszFeatures, IntBool fReplace, uint32 dwFlags, uint32 dwUserActionTime) mut => VT.EvaluateNewWindow(ref this, pszUrl, pszName, pszUrlContext, pszFeatures, fReplace, dwFlags, dwUserActionTime);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INewWindowManager self, char16* pszUrl, char16* pszName, char16* pszUrlContext, char16* pszFeatures, IntBool fReplace, uint32 dwFlags, uint32 dwUserActionTime) EvaluateNewWindow;
			}
		}
		[CRepr]
		public struct IAttachmentExecute : IUnknown
		{
			...
			public HResult SetClientTitle(char16* pszTitle) mut => VT.SetClientTitle(ref this, pszTitle);
			public HResult SetClientGuid(in Guid guid) mut => VT.SetClientGuid(ref this, guid);
			public HResult SetLocalPath(char16* pszLocalPath) mut => VT.SetLocalPath(ref this, pszLocalPath);
			public HResult SetFileName(char16* pszFileName) mut => VT.SetFileName(ref this, pszFileName);
			public HResult SetSource(char16* pszSource) mut => VT.SetSource(ref this, pszSource);
			public HResult SetReferrer(char16* pszReferrer) mut => VT.SetReferrer(ref this, pszReferrer);
			...
			public HResult Execute(HWnd hwnd, char16* pszVerb, Handle* phProcess) mut => VT.Execute(ref this, hwnd, pszVerb, phProcess);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, char16* pszTitle) SetClientTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, in Guid guid) SetClientGuid;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, char16* pszLocalPath) SetLocalPath;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, char16* pszFileName) SetFileName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, char16* pszSource) SetSource;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, char16* pszReferrer) SetReferrer;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IAttachmentExecute self, HWnd hwnd, char16* pszVerb, Handle* phProcess) Execute;
		...
		public struct IShellMenu : IUnknown
		{
			...
			public HResult GetMenuInfo(IShellMenuCallback** ppsmc, uint32* puId, uint32* puIdAncestor, uint32* pdwFlags) mut => VT._GetMenuInfo(ref this, ppsmc, puId, puIdAncestor, pdwFlags);
			...
			public HResult SetMenu(HMENU hmenu, HWnd hwnd, uint32 dwFlags) mut => VT._SetMenu(ref this, hmenu, hwnd, dwFlags);
			public HResult GetMenu(HMENU* phmenu, HWnd* phwnd, uint32* pdwFlags) mut => VT._GetMenu(ref this, phmenu, phwnd, pdwFlags);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellMenu self, IShellMenuCallback** ppsmc, uint32* puId, uint32* puIdAncestor, uint32* pdwFlags) _GetMenuInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellMenu self, HMENU hmenu, HWnd hwnd, uint32 dwFlags) _SetMenu;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellMenu self, HMENU* phmenu, HWnd* phwnd, uint32* pdwFlags) _GetMenu;
		...
		public struct IKnownFolder : IUnknown
		{
			...
			public HResult GetPath(uint32 dwFlags, out char16* ppszPath) mut => VT._GetPath(ref this, dwFlags, out ppszPath);
			public HResult SetPath(uint32 dwFlags, char16* pszPath) mut => VT.SetPath(ref this, dwFlags, pszPath);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IKnownFolder self, uint32 dwFlags, out char16* ppszPath) _GetPath;
				public new function [CallingConvention(.Stdcall)] HResult(ref IKnownFolder self, uint32 dwFlags, char16* pszPath) SetPath;
		...
		public struct IKnownFolderManager : IUnknown
		{
			...
			public HResult GetFolderByName(char16* pszCanonicalName, out IKnownFolder* ppkf) mut => VT.GetFolderByName(ref this, pszCanonicalName, out ppkf);
			...
			public HResult FindFolderFromPath(char16* pszPath, FFFP_MODE mode, out IKnownFolder* ppkf) mut => VT.FindFolderFromPath(ref this, pszPath, mode, out ppkf);
			...
			public HResult Redirect(in Guid rfid, HWnd hwnd, uint32 flags, char16* pszTargetPath, uint32 cFolders, Guid* pExclusion, char16** ppszError) mut => VT.Redirect(ref this, rfid, hwnd, flags, pszTargetPath, cFolders, pExclusion, ppszError);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IKnownFolderManager self, char16* pszCanonicalName, out IKnownFolder* ppkf) GetFolderByName;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IKnownFolderManager self, char16* pszPath, FFFP_MODE mode, out IKnownFolder* ppkf) FindFolderFromPath;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IKnownFolderManager self, in Guid rfid, HWnd hwnd, uint32 flags, char16* pszTargetPath, uint32 cFolders, Guid* pExclusion, char16** ppszError) Redirect;
			}
		}
		[CRepr]
		...
		public struct ICreateProcessInputs : IUnknown
		{
			...
			public HResult SetTitle(char16* pszTitle) mut => VT.SetTitle(ref this, pszTitle);
			public HResult SetEnvironmentVariable(char16* pszName, char16* pszValue) mut => VT.SetEnvironmentVariable(ref this, pszName, pszValue);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICreateProcessInputs self, char16* pszTitle) SetTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICreateProcessInputs self, char16* pszName, char16* pszValue) SetEnvironmentVariable;
			}
		}
		[CRepr]
		...
		public struct INameSpaceTreeControl : IUnknown
		{
			...
			public HResult Initialize(HWnd hwndParent, ref RectI prc, uint32 nsctsFlags) mut => VT.Initialize(ref this, hwndParent, ref prc, nsctsFlags);
			...
			public HResult SetTheme(char16* pszTheme) mut => VT.SetTheme(ref this, pszTheme);
			...
			public HResult GetItemRect(ref IShellItem psi, out RectI prect) mut => VT.GetItemRect(ref this, ref psi, out prect);
			public HResult CollapseAll() mut => VT.CollapseAll(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControl self, HWnd hwndParent, ref RectI prc, uint32 nsctsFlags) Initialize;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControl self, char16* pszTheme) SetTheme;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControl self, ref IShellItem psi, out RectI prect) GetItemRect;
		...
		public struct IPreviewHandler : IUnknown
		{
			...
			public HResult SetWindow(HWnd hwnd, in RectI prc) mut => VT.SetWindow(ref this, hwnd, prc);
			public HResult SetRect(in RectI prc) mut => VT._SetRect(ref this, prc);
			public HResult DoPreview() mut => VT.DoPreview(ref this);
			public HResult Unload() mut => VT.Unload(ref this);
			public HResult SetFocus() mut => VT._SetFocus(ref this);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPreviewHandler self, HWnd hwnd, in RectI prc) SetWindow;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPreviewHandler self, in RectI prc) _SetRect;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IPreviewHandler self) _SetFocus;
		...
		public struct IDefaultExtractIconInit : IUnknown
		{
			...
			public HResult SetNormalIcon(char16* pszFile, int32 iIcon) mut => VT.SetNormalIcon(ref this, pszFile, iIcon);
			public HResult SetOpenIcon(char16* pszFile, int32 iIcon) mut => VT.SetOpenIcon(ref this, pszFile, iIcon);
			public HResult SetShortcutIcon(char16* pszFile, int32 iIcon) mut => VT.SetShortcutIcon(ref this, pszFile, iIcon);
			public HResult SetDefaultIcon(char16* pszFile, int32 iIcon) mut => VT.SetDefaultIcon(ref this, pszFile, iIcon);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDefaultExtractIconInit self, char16* pszFile, int32 iIcon) SetNormalIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDefaultExtractIconInit self, char16* pszFile, int32 iIcon) SetOpenIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDefaultExtractIconInit self, char16* pszFile, int32 iIcon) SetShortcutIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDefaultExtractIconInit self, char16* pszFile, int32 iIcon) SetDefaultIcon;
			}
		}
		[CRepr]
		public struct IExplorerCommand : IUnknown
		{
			...
			public HResult GetTitle(ref IShellItemArray psiItemArray, out char16* ppszName) mut => VT.GetTitle(ref this, ref psiItemArray, out ppszName);
			public HResult GetIcon(ref IShellItemArray psiItemArray, out char16* ppszIcon) mut => VT.GetIcon(ref this, ref psiItemArray, out ppszIcon);
			public HResult GetToolTip(ref IShellItemArray psiItemArray, out char16* ppszInfotip) mut => VT.GetToolTip(ref this, ref psiItemArray, out ppszInfotip);
			public HResult GetCanonicalName(out Guid pguidCommandName) mut => VT.GetCanonicalName(ref this, out pguidCommandName);
			public HResult GetState(ref IShellItemArray psiItemArray, IntBool fOkToBeSlow, out uint32 pCmdState) mut => VT.GetState(ref this, ref psiItemArray, fOkToBeSlow, out pCmdState);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerCommand self, ref IShellItemArray psiItemArray, out char16* ppszName) GetTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerCommand self, ref IShellItemArray psiItemArray, out char16* ppszIcon) GetIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerCommand self, ref IShellItemArray psiItemArray, out char16* ppszInfotip) GetToolTip;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerCommand self, ref IShellItemArray psiItemArray, IntBool fOkToBeSlow, out uint32 pCmdState) GetState;
		...
		public struct IExplorerCommandState : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IExplorerCommandState self, ref IShellItemArray psiItemArray, IntBool fOkToBeSlow, out uint32 pCmdState) GetState;
			}
		}
		[CRepr]
		public struct IInitializeCommand : IUnknown
		{
			...
			public HResult Initialize(char16* pszCommandName, ref IPropertyBag ppb) mut => VT.Initialize(ref this, pszCommandName, ref ppb);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IInitializeCommand self, char16* pszCommandName, ref IPropertyBag ppb) Initialize;
			}
		}
		[CRepr]
		...
		public struct IOpenControlPanel : IUnknown
		{
			...
			public HResult Open(char16* pszName, char16* pszPage, ref IUnknown punkSite) mut => VT.Open(ref this, pszName, pszPage, ref punkSite);
			public HResult GetPath(char16* pszName, char16* pszPath, uint32 cchPath) mut => VT._GetPath(ref this, pszName, pszPath, cchPath);
			public HResult GetCurrentView(out CPVIEW pView) mut => VT.GetCurrentView(ref this, out pView);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IOpenControlPanel self, char16* pszName, char16* pszPage, ref IUnknown punkSite) Open;
				public new function [CallingConvention(.Stdcall)] HResult(ref IOpenControlPanel self, char16* pszName, char16* pszPath, uint32 cchPath) _GetPath;
		...
		public struct ICustomDestinationList : IUnknown
		{
			...
			public HResult SetAppID(char16* pszAppID) mut => VT.SetAppID(ref this, pszAppID);
			public HResult BeginList(out uint32 pcMinSlots, in Guid riid, void** ppv) mut => VT.BeginList(ref this, out pcMinSlots, riid, ppv);
			public HResult AppendCategory(char16* pszCategory, ref IObjectArray poa) mut => VT.AppendCategory(ref this, pszCategory, ref poa);
			...
			public HResult DeleteList(char16* pszAppID) mut => VT.DeleteList(ref this, pszAppID);
			public HResult AbortList() mut => VT.AbortList(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ICustomDestinationList self, char16* pszAppID) SetAppID;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICustomDestinationList self, char16* pszCategory, ref IObjectArray poa) AppendCategory;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICustomDestinationList self, char16* pszAppID) DeleteList;
		...
		public struct IApplicationDestinations : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationDestinations self, char16* pszAppID) SetAppID;
		...
		public struct IApplicationDocumentLists : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationDocumentLists self, char16* pszAppID) SetAppID;
		...
		public struct IObjectWithAppUserModelID : IUnknown
		{
			...
			public HResult SetAppID(char16* pszAppID) mut => VT.SetAppID(ref this, pszAppID);
			public HResult GetAppID(out char16* ppszAppID) mut => VT.GetAppID(ref this, out ppszAppID);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IObjectWithAppUserModelID self, char16* pszAppID) SetAppID;
				public new function [CallingConvention(.Stdcall)] HResult(ref IObjectWithAppUserModelID self, out char16* ppszAppID) GetAppID;
			}
		}
		[CRepr]
		public struct IObjectWithProgID : IUnknown
		{
			...
			public HResult SetProgID(char16* pszProgID) mut => VT.SetProgID(ref this, pszProgID);
			public HResult GetProgID(out char16* ppszProgID) mut => VT.GetProgID(ref this, out ppszProgID);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IObjectWithProgID self, char16* pszProgID) SetProgID;
				public new function [CallingConvention(.Stdcall)] HResult(ref IObjectWithProgID self, out char16* ppszProgID) GetProgID;
			}
		}
		[CRepr]
		...
		public struct IDesktopWallpaper : IUnknown
		{
			...
			public HResult SetWallpaper(char16* monitorID, char16* wallpaper) mut => VT.SetWallpaper(ref this, monitorID, wallpaper);
			public HResult GetWallpaper(char16* monitorID, out char16* wallpaper) mut => VT.GetWallpaper(ref this, monitorID, out wallpaper);
			public HResult GetMonitorDevicePathAt(uint32 monitorIndex, out char16* monitorID) mut => VT.GetMonitorDevicePathAt(ref this, monitorIndex, out monitorID);
			public HResult GetMonitorDevicePathCount(out uint32 count) mut => VT.GetMonitorDevicePathCount(ref this, out count);
			public HResult GetMonitorRECT(char16* monitorID, out RectI displayRect) mut => VT.GetMonitorRECT(ref this, monitorID, out displayRect);
			public HResult SetBackgroundColor(uint32 color) mut => VT.SetBackgroundColor(ref this, color);
			...
			public HResult AdvanceSlideshow(char16* monitorID, DESKTOP_SLIDESHOW_DIRECTION direction) mut => VT.AdvanceSlideshow(ref this, monitorID, direction);
			public HResult GetStatus(out DESKTOP_SLIDESHOW_STATE state) mut => VT.GetStatus(ref this, out state);
			public HResult Enable(IntBool enable) mut => VT.Enable(ref this, enable);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, char16* monitorID, char16* wallpaper) SetWallpaper;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, char16* monitorID, out char16* wallpaper) GetWallpaper;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, uint32 monitorIndex, out char16* monitorID) GetMonitorDevicePathAt;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, char16* monitorID, out RectI displayRect) GetMonitorRECT;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, char16* monitorID, DESKTOP_SLIDESHOW_DIRECTION direction) AdvanceSlideshow;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopWallpaper self, IntBool enable) Enable;
			}
		}
		[CRepr]
		public struct IHomeGroup : IUnknown
		{
			...
			public HResult IsMember(out IntBool member) mut => VT.IsMember(ref this, out member);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHomeGroup self, out IntBool member) IsMember;
		...
		public struct IOpenSearchSource : IUnknown
		{
			...
			public HResult GetResults(HWnd hwnd, char16* pszQuery, uint32 dwStartIndex, uint32 dwCount, in Guid riid, void** ppv) mut => VT.GetResults(ref this, hwnd, pszQuery, dwStartIndex, dwCount, riid, ppv);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IOpenSearchSource self, HWnd hwnd, char16* pszQuery, uint32 dwStartIndex, uint32 dwCount, in Guid riid, void** ppv) GetResults;
			}
		}
		[CRepr]
		public struct IShellLibrary : IUnknown
		{
			...
			public HResult GetIcon(out char16* ppszIcon) mut => VT.GetIcon(ref this, out ppszIcon);
			public HResult SetIcon(char16* pszIcon) mut => VT.SetIcon(ref this, pszIcon);
			public HResult Commit() mut => VT.Commit(ref this);
			public HResult Save(ref IShellItem psiFolderToSaveIn, char16* pszLibraryName, LIBRARYSAVEFLAGS lsf, out IShellItem* ppsiSavedTo) mut => VT.Save(ref this, ref psiFolderToSaveIn, pszLibraryName, lsf, out ppsiSavedTo);
			public HResult SaveInKnownFolder(in Guid kfidToSaveIn, char16* pszLibraryName, LIBRARYSAVEFLAGS lsf, out IShellItem* ppsiSavedTo) mut => VT.SaveInKnownFolder(ref this, kfidToSaveIn, pszLibraryName, lsf, out ppsiSavedTo);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLibrary self, out char16* ppszIcon) GetIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLibrary self, char16* pszIcon) SetIcon;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLibrary self) Commit;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLibrary self, ref IShellItem psiFolderToSaveIn, char16* pszLibraryName, LIBRARYSAVEFLAGS lsf, out IShellItem* ppsiSavedTo) Save;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLibrary self, in Guid kfidToSaveIn, char16* pszLibraryName, LIBRARYSAVEFLAGS lsf, out IShellItem* ppsiSavedTo) SaveInKnownFolder;
			}
		}
		[CRepr]
		...
		public struct IApplicationActivationManager : IUnknown
		{
			...
			public HResult ActivateApplication(char16* appUserModelId, char16* arguments, ACTIVATEOPTIONS options, out uint32 processId) mut => VT.ActivateApplication(ref this, appUserModelId, arguments, options, out processId);
			public HResult ActivateForFile(char16* appUserModelId, ref IShellItemArray itemArray, char16* verb, out uint32 processId) mut => VT.ActivateForFile(ref this, appUserModelId, ref itemArray, verb, out processId);
			public HResult ActivateForProtocol(char16* appUserModelId, ref IShellItemArray itemArray, out uint32 processId) mut => VT.ActivateForProtocol(ref this, appUserModelId, ref itemArray, out processId);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationActivationManager self, char16* appUserModelId, char16* arguments, ACTIVATEOPTIONS options, out uint32 processId) ActivateApplication;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationActivationManager self, char16* appUserModelId, ref IShellItemArray itemArray, char16* verb, out uint32 processId) ActivateForFile;
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationActivationManager self, char16* appUserModelId, ref IShellItemArray itemArray, out uint32 processId) ActivateForProtocol;
			}
		}
		[CRepr]
		public struct IVirtualDesktopManager : IUnknown
		{
			...
			public HResult IsWindowOnCurrentVirtualDesktop(HWnd topLevelWindow, out IntBool onCurrentDesktop) mut => VT.IsWindowOnCurrentVirtualDesktop(ref this, topLevelWindow, out onCurrentDesktop);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IVirtualDesktopManager self, HWnd topLevelWindow, out IntBool onCurrentDesktop) IsWindowOnCurrentVirtualDesktop;
		...
		public struct IAssocHandler : IUnknown
		{
			...
			public HResult GetName(out char16* ppsz) mut => VT.GetName(ref this, out ppsz);
			public HResult GetUIName(out char16* ppsz) mut => VT.GetUIName(ref this, out ppsz);
			public HResult GetIconLocation(out char16* ppszPath, out int32 pIndex) mut => VT.GetIconLocation(ref this, out ppszPath, out pIndex);
			public HResult IsRecommended() mut => VT.IsRecommended(ref this);
			public HResult MakeDefault(char16* pszDescription) mut => VT.MakeDefault(ref this, pszDescription);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAssocHandler self, out char16* ppsz) GetName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAssocHandler self, out char16* ppsz) GetUIName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAssocHandler self, out char16* ppszPath, out int32 pIndex) GetIconLocation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAssocHandler self) IsRecommended;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAssocHandler self, char16* pszDescription) MakeDefault;
		...
		public struct IFrameworkInputPaneHandler : IUnknown
		{
			...
			public HResult Showing(ref RectI prcInputPaneScreenLocation, IntBool fEnsureFocusedElementInView) mut => VT.Showing(ref this, ref prcInputPaneScreenLocation, fEnsureFocusedElementInView);
			public HResult Hiding(IntBool fEnsureFocusedElementInView) mut => VT.Hiding(ref this, fEnsureFocusedElementInView);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFrameworkInputPaneHandler self, ref RectI prcInputPaneScreenLocation, IntBool fEnsureFocusedElementInView) Showing;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFrameworkInputPaneHandler self, IntBool fEnsureFocusedElementInView) Hiding;
			}
		}
		[CRepr]
		public struct IFrameworkInputPane : IUnknown
		{
			...
			public HResult Unadvise(uint32 dwCookie) mut => VT.Unadvise(ref this, dwCookie);
			public HResult Location(out RectI prcInputPaneScreenLocation) mut => VT.Location(ref this, out prcInputPaneScreenLocation);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFrameworkInputPane self, out RectI prcInputPaneScreenLocation) Location;
			}
		}
		[CRepr]
		public struct IAppVisibilityEvents : IUnknown
		{
			...
			public HResult LauncherVisibilityChange(IntBool currentVisibleState) mut => VT.LauncherVisibilityChange(ref this, currentVisibleState);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IAppVisibilityEvents self, IntBool currentVisibleState) LauncherVisibilityChange;
			}
		}
		[CRepr]
		public struct IAppVisibility : IUnknown
		{
			...
			public HResult IsLauncherVisible(out IntBool pfVisible) mut => VT.IsLauncherVisible(ref this, out pfVisible);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IAppVisibility self, out IntBool pfVisible) IsLauncherVisible;
		...
		public struct IPackageExecutionStateChangeNotification : IUnknown
		{
			...
			public HResult OnStateChanged(char16* pszPackageFullName, PACKAGE_EXECUTION_STATE pesNewState) mut => VT.OnStateChanged(ref this, pszPackageFullName, pesNewState);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageExecutionStateChangeNotification self, char16* pszPackageFullName, PACKAGE_EXECUTION_STATE pesNewState) OnStateChanged;
			}
		}
		[CRepr]
		public struct IPackageDebugSettings : IUnknown
		{
			...
			public HResult EnableDebugging(char16* packageFullName, char16* debuggerCommandLine, char16* environment) mut => VT.EnableDebugging(ref this, packageFullName, debuggerCommandLine, environment);
			public HResult DisableDebugging(char16* packageFullName) mut => VT.DisableDebugging(ref this, packageFullName);
			public HResult Suspend(char16* packageFullName) mut => VT.Suspend(ref this, packageFullName);
			public HResult Resume(char16* packageFullName) mut => VT.Resume(ref this, packageFullName);
			public HResult TerminateAllProcesses(char16* packageFullName) mut => VT.TerminateAllProcesses(ref this, packageFullName);
			public HResult SetTargetSessionId(uint32 sessionId) mut => VT.SetTargetSessionId(ref this, sessionId);
			public HResult EnumerateBackgroundTasks(char16* packageFullName, out uint32 taskCount, out Guid* taskIds, out char16** taskNames) mut => VT.EnumerateBackgroundTasks(ref this, packageFullName, out taskCount, out taskIds, out taskNames);
			public HResult ActivateBackgroundTask(in Guid taskId) mut => VT.ActivateBackgroundTask(ref this, taskId);
			public HResult StartServicing(char16* packageFullName) mut => VT.StartServicing(ref this, packageFullName);
			public HResult StopServicing(char16* packageFullName) mut => VT.StopServicing(ref this, packageFullName);
			public HResult StartSessionRedirection(char16* packageFullName, uint32 sessionId) mut => VT.StartSessionRedirection(ref this, packageFullName, sessionId);
			public HResult StopSessionRedirection(char16* packageFullName) mut => VT.StopSessionRedirection(ref this, packageFullName);
			public HResult GetPackageExecutionState(char16* packageFullName, out PACKAGE_EXECUTION_STATE packageExecutionState) mut => VT.GetPackageExecutionState(ref this, packageFullName, out packageExecutionState);
			public HResult RegisterForPackageStateChanges(char16* packageFullName, ref IPackageExecutionStateChangeNotification pPackageExecutionStateChangeNotification, out uint32 pdwCookie) mut => VT.RegisterForPackageStateChanges(ref this, packageFullName, ref pPackageExecutionStateChangeNotification, out pdwCookie);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName, char16* debuggerCommandLine, char16* environment) EnableDebugging;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) DisableDebugging;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) Suspend;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) Resume;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) TerminateAllProcesses;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, uint32 sessionId) SetTargetSessionId;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName, out uint32 taskCount, out Guid* taskIds, out char16** taskNames) EnumerateBackgroundTasks;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) StartServicing;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) StopServicing;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName, uint32 sessionId) StartSessionRedirection;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName) StopSessionRedirection;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName, out PACKAGE_EXECUTION_STATE packageExecutionState) GetPackageExecutionState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings self, char16* packageFullName, ref IPackageExecutionStateChangeNotification pPackageExecutionStateChangeNotification, out uint32 pdwCookie) RegisterForPackageStateChanges;
		...
		public struct IPackageDebugSettings2 : IPackageDebugSettings
		{
			...
			public HResult EnumerateApps(char16* packageFullName, out uint32 appCount, out char16** appUserModelIds, out char16** appDisplayNames) mut => VT.EnumerateApps(ref this, packageFullName, out appCount, out appUserModelIds, out appDisplayNames);

			[CRepr]
			public struct VTable : IPackageDebugSettings.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPackageDebugSettings2 self, char16* packageFullName, out uint32 appCount, out char16** appUserModelIds, out char16** appDisplayNames) EnumerateApps;
			}
		}
		[CRepr]
		...
		public struct IApplicationDesignModeSettings : IUnknown
		{
			...
			public HResult IsApplicationViewStateSupported(APPLICATION_VIEW_STATE viewState, SIZE nativeDisplaySizePixels, DEVICE_SCALE_FACTOR scaleFactor, out IntBool supported) mut => VT.IsApplicationViewStateSupported(ref this, viewState, nativeDisplaySizePixels, scaleFactor, out supported);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationDesignModeSettings self, APPLICATION_VIEW_STATE viewState, SIZE nativeDisplaySizePixels, DEVICE_SCALE_FACTOR scaleFactor, out IntBool supported) IsApplicationViewStateSupported;
		...
		public struct IApplicationDesignModeSettings2 : IApplicationDesignModeSettings
		{
			...
			public HResult SetIsOnLockScreen(IntBool isOnLockScreen) mut => VT.SetIsOnLockScreen(ref this, isOnLockScreen);
			...
			public struct VTable : IApplicationDesignModeSettings.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationDesignModeSettings2 self, IntBool isOnLockScreen) SetIsOnLockScreen;
		...
		public struct ILaunchSourceAppUserModelId : IUnknown
		{
			...
			public HResult GetAppUserModelId(out char16* launchingApp) mut => VT.GetAppUserModelId(ref this, out launchingApp);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ILaunchSourceAppUserModelId self, out char16* launchingApp) GetAppUserModelId;
			}
		}
		[CRepr]
		...
		public struct IHandlerInfo : IUnknown
		{
			...
			public HResult GetApplicationDisplayName(out char16* value) mut => VT.GetApplicationDisplayName(ref this, out value);
			public HResult GetApplicationPublisher(out char16* value) mut => VT.GetApplicationPublisher(ref this, out value);
			public HResult GetApplicationIconReference(out char16* value) mut => VT.GetApplicationIconReference(ref this, out value);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHandlerInfo self, out char16* value) GetApplicationDisplayName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHandlerInfo self, out char16* value) GetApplicationPublisher;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHandlerInfo self, out char16* value) GetApplicationIconReference;
			}
		}
		[CRepr]
		public struct IHandlerInfo2 : IHandlerInfo
		{
			...
			public HResult GetApplicationId(out char16* value) mut => VT.GetApplicationId(ref this, out value);

			[CRepr]
			public struct VTable : IHandlerInfo.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHandlerInfo2 self, out char16* value) GetApplicationId;
			}
		}
		[CRepr]
		public struct IHandlerActivationHost : IUnknown
		{
			...
			public HResult BeforeCreateProcess(char16* applicationPath, char16* commandLine, ref IHandlerInfo handlerInfo) mut => VT.BeforeCreateProcess(ref this, applicationPath, commandLine, ref handlerInfo);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHandlerActivationHost self, char16* applicationPath, char16* commandLine, ref IHandlerInfo handlerInfo) BeforeCreateProcess;
			}
		}
		[CRepr]
		public struct IAppActivationUIInfo : IUnknown
		{
			...
			public HResult GetShowUI(out IntBool value) mut => VT.GetShowUI(ref this, out value);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IAppActivationUIInfo self, out IntBool value) GetShowUI;
		...
		public struct IContactManagerInterop : IUnknown
		{
			...
			public HResult ShowContactCardForWindow(HWnd appWindow, ref IUnknown contact, in RectI selection, FLYOUT_PLACEMENT preferredPlacement) mut => VT.ShowContactCardForWindow(ref this, appWindow, ref contact, selection, preferredPlacement);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IContactManagerInterop self, HWnd appWindow, ref IUnknown contact, in RectI selection, FLYOUT_PLACEMENT preferredPlacement) ShowContactCardForWindow;
			}
		}
		[CRepr]
		public struct IShellIconOverlayIdentifier : IUnknown
		{
			...
			public HResult IsMemberOf(char16* pwszPath, uint32 dwAttrib) mut => VT.IsMemberOf(ref this, pwszPath, dwAttrib);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellIconOverlayIdentifier self, char16* pwszPath, uint32 dwAttrib) IsMemberOf;
		...
		public struct IShellView3 : IShellView2
		{
			...
			public HResult CreateViewWindow3(ref IShellBrowser psbOwner, ref IShellView psvPrev, uint32 dwViewFlags, FOLDERFLAGS dwMask, FOLDERFLAGS dwFlags, FOLDERVIEWMODE fvMode, in Guid pvid, in RectI prcView, out HWnd phwndView) mut => VT.CreateViewWindow3(ref this, ref psbOwner, ref psvPrev, dwViewFlags, dwMask, dwFlags, fvMode, pvid, prcView, out phwndView);

			[CRepr]
			public struct VTable : IShellView2.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellView3 self, ref IShellBrowser psbOwner, ref IShellView psvPrev, uint32 dwViewFlags, FOLDERFLAGS dwMask, FOLDERFLAGS dwFlags, FOLDERVIEWMODE fvMode, in Guid pvid, in RectI prcView, out HWnd phwndView) CreateViewWindow3;
			}
		}
		[CRepr]
		public struct ISearchBoxInfo : IUnknown
		{
			...
			public HResult GetText(out char16* ppsz) mut => VT.GetText(ref this, out ppsz);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISearchBoxInfo self, in Guid riid, void** ppv) GetCondition;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISearchBoxInfo self, out char16* ppsz) GetText;
			}
		}
		[CRepr]
		public struct IVisualProperties : IUnknown
		{
			...
			public HResult SetFont(in LOGFONTW plf, IntBool bRedraw) mut => VT.SetFont(ref this, plf, bRedraw);
			public HResult GetFont(out LOGFONTW plf) mut => VT.GetFont(ref this, out plf);
			public HResult SetTheme(char16* pszSubAppName, char16* pszSubIdList) mut => VT.SetTheme(ref this, pszSubAppName, pszSubIdList);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IVisualProperties self, in LOGFONTW plf, IntBool bRedraw) SetFont;
				public new function [CallingConvention(.Stdcall)] HResult(ref IVisualProperties self, out LOGFONTW plf) GetFont;
				public new function [CallingConvention(.Stdcall)] HResult(ref IVisualProperties self, char16* pszSubAppName, char16* pszSubIdList) SetTheme;
			}
		}
		[CRepr]
		...
		public struct IUserAccountChangeCallback : IUnknown
		{
			...
			public HResult OnPictureChange(char16* pszUserName) mut => VT.OnPictureChange(ref this, pszUserName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserAccountChangeCallback self, char16* pszUserName) OnPictureChange;
			}
		}
		[CRepr]
		public struct IStreamAsync : IStream
		{
			...
			public HResult OverlappedResult(ref OVERLAPPED lpOverlapped, out uint32 lpNumberOfBytesTransferred, IntBool bWait) mut => VT.OverlappedResult(ref this, ref lpOverlapped, out lpNumberOfBytesTransferred, bWait);
			public HResult CancelIo() mut => VT._CancelIo(ref this);
			...
			public struct VTable : IStream.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IStreamAsync self, ref OVERLAPPED lpOverlapped, out uint32 lpNumberOfBytesTransferred, IntBool bWait) OverlappedResult;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStreamAsync self) _CancelIo;
			}
		}
		[CRepr]
		...
		public struct IHWEventHandler : IUnknown
		{
			...
			public HResult Initialize(char16* pszParams) mut => VT.Initialize(ref this, pszParams);
			public HResult HandleEvent(char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType) mut => VT.HandleEvent(ref this, pszDeviceID, pszAltDeviceID, pszEventType);
			public HResult HandleEventWithContent(char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType, char16* pszContentTypeHandler, ref IDataObject pdataobject) mut => VT.HandleEventWithContent(ref this, pszDeviceID, pszAltDeviceID, pszEventType, pszContentTypeHandler, ref pdataobject);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHWEventHandler self, char16* pszParams) Initialize;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHWEventHandler self, char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType) HandleEvent;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHWEventHandler self, char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType, char16* pszContentTypeHandler, ref IDataObject pdataobject) HandleEventWithContent;
			}
		}
		[CRepr]
		public struct IHWEventHandler2 : IHWEventHandler
		{
			...
			public HResult HandleEventWithHWND(char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType, HWnd hwndOwner) mut => VT.HandleEventWithHWND(ref this, pszDeviceID, pszAltDeviceID, pszEventType, hwndOwner);

			[CRepr]
			public struct VTable : IHWEventHandler.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IHWEventHandler2 self, char16* pszDeviceID, char16* pszAltDeviceID, char16* pszEventType, HWnd hwndOwner) HandleEventWithHWND;
			}
		}
		[CRepr]
		public struct IQueryCancelAutoPlay : IUnknown
		{
			...
			public HResult AllowAutoPlay(char16* pszPath, uint32 dwContentType, char16* pszLabel, uint32 dwSerialNumber) mut => VT.AllowAutoPlay(ref this, pszPath, dwContentType, pszLabel, dwSerialNumber);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryCancelAutoPlay self, char16* pszPath, uint32 dwContentType, char16* pszLabel, uint32 dwSerialNumber) AllowAutoPlay;
			}
		}
		[CRepr]
		public struct IDynamicHWHandler : IUnknown
		{
			...
			public HResult GetDynamicInfo(char16* pszDeviceID, uint32 dwContentType, out char16* ppszAction) mut => VT.GetDynamicInfo(ref this, pszDeviceID, dwContentType, out ppszAction);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDynamicHWHandler self, char16* pszDeviceID, uint32 dwContentType, out char16* ppszAction) GetDynamicInfo;
			}
		}
		[CRepr]
		...
		public struct IUserNotification2 : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification2 self, char16* pszTitle, char16* pszText, uint32 dwInfoFlags) SetBalloonInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification2 self, HICON hIcon, char16* pszToolTip) SetIconInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IUserNotification2 self, char16* pszSoundName) PlaySound;
			}
		}
		[CRepr]
		public struct IDeskBand2 : IDeskBand
		{
			...
			public HResult CanRenderComposited(out IntBool pfCanRenderComposited) mut => VT.CanRenderComposited(ref this, out pfCanRenderComposited);
			public HResult SetCompositionState(IntBool fCompositionEnabled) mut => VT.SetCompositionState(ref this, fCompositionEnabled);
			public HResult GetCompositionState(out IntBool pfCompositionEnabled) mut => VT.GetCompositionState(ref this, out pfCompositionEnabled);

			[CRepr]
			public struct VTable : IDeskBand.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDeskBand2 self, out IntBool pfCanRenderComposited) CanRenderComposited;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDeskBand2 self, IntBool fCompositionEnabled) SetCompositionState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDeskBand2 self, out IntBool pfCompositionEnabled) GetCompositionState;
			}
		}
		[CRepr]
		...
		public struct ICDBurn : IUnknown
		{
			...
			public HResult HasRecordableDrive(out IntBool pfHasRecorder) mut => VT.HasRecordableDrive(ref this, out pfHasRecorder);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICDBurn self, out IntBool pfHasRecorder) HasRecordableDrive;
			}
		}
		[CRepr]
		...
		public struct IWebWizardExtension : IWizardExtension
		{
			...
			public HResult SetInitialURL(char16* pszURL) mut => VT.SetInitialURL(ref this, pszURL);
			public HResult SetErrorURL(char16* pszErrorURL) mut => VT.SetErrorURL(ref this, pszErrorURL);

			[CRepr]
			public struct VTable : IWizardExtension.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardExtension self, char16* pszURL) SetInitialURL;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardExtension self, char16* pszErrorURL) SetErrorURL;
			}
		}
		[CRepr]
		public struct IPublishingWizard : IWizardExtension
		{
			...
			public HResult Initialize(IDataObject* pdo, uint32 dwOptions, char16* pszServiceScope) mut => VT.Initialize(ref this, pdo, dwOptions, pszServiceScope);
			...
			public struct VTable : IWizardExtension.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPublishingWizard self, IDataObject* pdo, uint32 dwOptions, char16* pszServiceScope) Initialize;
		...
		public struct IFolderViewHost : IUnknown
		{
			...
			public HResult Initialize(HWnd hwndParent, ref IDataObject pdo, ref RectI prc) mut => VT.Initialize(ref this, hwndParent, ref pdo, ref prc);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderViewHost self, HWnd hwndParent, ref IDataObject pdo, ref RectI prc) Initialize;
			}
		}
		[CRepr]
		public struct IAccessibleObject : IUnknown
		{
			...
			public HResult SetAccessibleName(char16* pszName) mut => VT.SetAccessibleName(ref this, pszName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAccessibleObject self, char16* pszName) SetAccessibleName;
			}
		}
		[CRepr]
		...
		public struct IAutoCompleteDropDown : IUnknown
		{
			...
			public HResult GetDropDownStatus(out uint32 pdwFlags, out char16* ppwszString) mut => VT.GetDropDownStatus(ref this, out pdwFlags, out ppwszString);
			public HResult ResetEnumerator() mut => VT.ResetEnumerator(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAutoCompleteDropDown self, out uint32 pdwFlags, out char16* ppwszString) GetDropDownStatus;
		...
		public struct IFolderBandPriv : IUnknown
		{
			...
			public HResult SetCascade(IntBool fCascade) mut => VT.SetCascade(ref this, fCascade);
			public HResult SetAccelerators(IntBool fAccelerators) mut => VT.SetAccelerators(ref this, fAccelerators);
			public HResult SetNoIcons(IntBool fNoIcons) mut => VT.SetNoIcons(ref this, fNoIcons);
			public HResult SetNoText(IntBool fNoText) mut => VT.SetNoText(ref this, fNoText);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderBandPriv self, IntBool fCascade) SetCascade;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderBandPriv self, IntBool fAccelerators) SetAccelerators;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderBandPriv self, IntBool fNoIcons) SetNoIcons;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFolderBandPriv self, IntBool fNoText) SetNoText;
			}
		}
		[CRepr]
		...
		public struct IFileDialogControlEvents : IUnknown
		{
			...
			public HResult OnCheckButtonToggled(ref IFileDialogCustomize pfdc, uint32 dwIDCtl, IntBool bChecked) mut => VT.OnCheckButtonToggled(ref this, ref pfdc, dwIDCtl, bChecked);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialogControlEvents self, ref IFileDialogCustomize pfdc, uint32 dwIDCtl, IntBool bChecked) OnCheckButtonToggled;
		...
		public struct IFileDialog2 : IFileDialog
		{
			...
			public HResult SetCancelButtonLabel(char16* pszLabel) mut => VT.SetCancelButtonLabel(ref this, pszLabel);
			public HResult SetNavigationRoot(ref IShellItem psi) mut => VT.SetNavigationRoot(ref this, ref psi);

			[CRepr]
			public struct VTable : IFileDialog.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileDialog2 self, char16* pszLabel) SetCancelButtonLabel;
		...
		public struct IApplicationAssociationRegistrationUI : IUnknown
		{
			...
			public HResult LaunchAdvancedAssociationUI(char16* pszAppRegistryName) mut => VT.LaunchAdvancedAssociationUI(ref this, pszAppRegistryName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IApplicationAssociationRegistrationUI self, char16* pszAppRegistryName) LaunchAdvancedAssociationUI;
			}
		}
		[CRepr]
		public struct IShellRunDll : IUnknown
		{
			...
			public HResult Run(char16* pszArgs) mut => VT.Run(ref this, pszArgs);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellRunDll self, char16* pszArgs) Run;
			}
		}
		[CRepr]
		public struct IPreviousVersionsInfo : IUnknown
		{
			...
			public HResult AreSnapshotsAvailable(char16* pszPath, IntBool fOkToBeSlow, out IntBool pfAvailable) mut => VT.AreSnapshotsAvailable(ref this, pszPath, fOkToBeSlow, out pfAvailable);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IPreviousVersionsInfo self, char16* pszPath, IntBool fOkToBeSlow, out IntBool pfAvailable) AreSnapshotsAvailable;
			}
		}
		[CRepr]
		...
		public struct INameSpaceTreeControlEvents : IUnknown
		{
			...
			public HResult OnItemAdded(ref IShellItem psi, IntBool fIsRoot) mut => VT.OnItemAdded(ref this, ref psi, fIsRoot);
			public HResult OnItemDeleted(ref IShellItem psi, IntBool fIsRoot) mut => VT.OnItemDeleted(ref this, ref psi, fIsRoot);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlEvents self, ref IShellItem psi, IntBool fIsRoot) OnItemAdded;
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlEvents self, ref IShellItem psi, IntBool fIsRoot) OnItemDeleted;
		...
		public struct INameSpaceTreeControlDropHandler : IUnknown
		{
			...
			public HResult OnDragEnter(IShellItem* psiOver, ref IShellItemArray psiaData, IntBool fOutsideSource, uint32 grfKeyState, out uint32 pdwEffect) mut => VT.OnDragEnter(ref this, psiOver, ref psiaData, fOutsideSource, grfKeyState, out pdwEffect);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlDropHandler self, IShellItem* psiOver, ref IShellItemArray psiaData, IntBool fOutsideSource, uint32 grfKeyState, out uint32 pdwEffect) OnDragEnter;
		...
		public struct INameSpaceTreeAccessible : IUnknown
		{
			...
			public HResult OnGetDefaultAccessibilityAction(ref IShellItem psi, out char16* pbstrDefaultAction) mut => VT.OnGetDefaultAccessibilityAction(ref this, ref psi, out pbstrDefaultAction);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeAccessible self, ref IShellItem psi, out char16* pbstrDefaultAction) OnGetDefaultAccessibilityAction;
		...
		public struct INameSpaceTreeControlCustomDraw : IUnknown
		{
			...
			public HResult PrePaint(HDC hdc, ref RectI prc, out LRESULT plres) mut => VT.PrePaint(ref this, hdc, ref prc, out plres);
			public HResult PostPaint(HDC hdc, ref RectI prc) mut => VT.PostPaint(ref this, hdc, ref prc);
			public HResult ItemPrePaint(HDC hdc, ref RectI prc, ref NSTCCUSTOMDRAW pnstccdItem, out uint32 pclrText, out uint32 pclrTextBk, out LRESULT plres) mut => VT.ItemPrePaint(ref this, hdc, ref prc, ref pnstccdItem, out pclrText, out pclrTextBk, out plres);
			public HResult ItemPostPaint(HDC hdc, ref RectI prc, ref NSTCCUSTOMDRAW pnstccdItem) mut => VT.ItemPostPaint(ref this, hdc, ref prc, ref pnstccdItem);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlCustomDraw self, HDC hdc, ref RectI prc, out LRESULT plres) PrePaint;
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlCustomDraw self, HDC hdc, ref RectI prc) PostPaint;
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlCustomDraw self, HDC hdc, ref RectI prc, ref NSTCCUSTOMDRAW pnstccdItem, out uint32 pclrText, out uint32 pclrTextBk, out LRESULT plres) ItemPrePaint;
				public new function [CallingConvention(.Stdcall)] HResult(ref INameSpaceTreeControlCustomDraw self, HDC hdc, ref RectI prc, ref NSTCCUSTOMDRAW pnstccdItem) ItemPostPaint;
			}
		}
		[CRepr]
		...
		public struct IBandHost : IUnknown
		{
			...
			public HResult CreateBand(in Guid rclsidBand, IntBool fAvailable, IntBool fVisible, in Guid riid, void** ppv) mut => VT.CreateBand(ref this, rclsidBand, fAvailable, fVisible, riid, ppv);
			public HResult SetBandAvailability(in Guid rclsidBand, IntBool fAvailable) mut => VT.SetBandAvailability(ref this, rclsidBand, fAvailable);
			public HResult DestroyBand(in Guid rclsidBand) mut => VT.DestroyBand(ref this, rclsidBand);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IBandHost self, in Guid rclsidBand, IntBool fAvailable, IntBool fVisible, in Guid riid, void** ppv) CreateBand;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBandHost self, in Guid rclsidBand, IntBool fAvailable) SetBandAvailability;
		...
		public struct IDesktopGadget : IUnknown
		{
			...
			public HResult RunGadget(char16* gadgetPath) mut => VT.RunGadget(ref this, gadgetPath);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDesktopGadget self, char16* gadgetPath) RunGadget;
			}
		}
		[CRepr]
		...
		public struct IStorageProviderBanners : IUnknown
		{
			...
			public HResult SetBanner(char16* providerIdentity, char16* subscriptionId, char16* contentId) mut => VT.SetBanner(ref this, providerIdentity, subscriptionId, contentId);
			public HResult ClearBanner(char16* providerIdentity, char16* subscriptionId) mut => VT.ClearBanner(ref this, providerIdentity, subscriptionId);
			public HResult ClearAllBanners(char16* providerIdentity) mut => VT.ClearAllBanners(ref this, providerIdentity);
			public HResult GetBanner(char16* providerIdentity, char16* subscriptionId, out char16* contentId) mut => VT.GetBanner(ref this, providerIdentity, subscriptionId, out contentId);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderBanners self, char16* providerIdentity, char16* subscriptionId, char16* contentId) SetBanner;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderBanners self, char16* providerIdentity, char16* subscriptionId) ClearBanner;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderBanners self, char16* providerIdentity) ClearAllBanners;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderBanners self, char16* providerIdentity, char16* subscriptionId, out char16* contentId) GetBanner;
			}
		}
		[CRepr]
		public struct IStorageProviderCopyHook : IUnknown
		{
			...
			public HResult CopyCallback(HWnd hwnd, uint32 operation, uint32 flags, char16* srcFile, uint32 srcAttribs, char16* destFile, uint32 destAttribs, out uint32 result) mut => VT.CopyCallback(ref this, hwnd, operation, flags, srcFile, srcAttribs, destFile, destAttribs, out result);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderCopyHook self, HWnd hwnd, uint32 operation, uint32 flags, char16* srcFile, uint32 srcAttribs, char16* destFile, uint32 destAttribs, out uint32 result) CopyCallback;
			}
		}
		[CRepr]
		public struct IWebBrowser : IDispatch
		{
			...
			public HResult Navigate(char16* URL, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers) mut => VT.Navigate(ref this, URL, Flags, TargetFrameName, PostData, Headers);
			public HResult Refresh() mut => VT.Refresh(ref this);
			...
			public HResult get_Type(out char16* Type) mut => VT.get_Type(ref this, out Type);
			...
			public HResult get_LocationName(out char16* LocationName) mut => VT.get_LocationName(ref this, out LocationName);
			public HResult get_LocationURL(out char16* LocationURL) mut => VT.get_LocationURL(ref this, out LocationURL);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowser self, char16* URL, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers) Navigate;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowser self, out char16* Type) get_Type;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowser self, out char16* LocationName) get_LocationName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowser self, out char16* LocationURL) get_LocationURL;
		...
		public struct IWebBrowserApp : IWebBrowser
		{
			...
			public HResult PutProperty(char16* Property, VARIANT vtValue) mut => VT.PutProperty(ref this, Property, vtValue);
			public HResult GetProperty(char16* Property, out VARIANT pvtValue) mut => VT.GetProperty(ref this, Property, out pvtValue);
			...
			public HResult get_FullName(out char16* FullName) mut => VT.get_FullName(ref this, out FullName);
			public HResult get_Path(out char16* Path) mut => VT.get_Path(ref this, out Path);
			...
			public HResult get_StatusText(out char16* StatusText) mut => VT.get_StatusText(ref this, out StatusText);
			public HResult put_StatusText(char16* StatusText) mut => VT.put_StatusText(ref this, StatusText);
			...
			public struct VTable : IWebBrowser.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, char16* Property, VARIANT vtValue) PutProperty;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, char16* Property, out VARIANT pvtValue) GetProperty;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, out char16* Name) get_Name;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, out SHANDLE_PTR pHWND) get_HWND;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, out char16* FullName) get_FullName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, out char16* Path) get_Path;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, out char16* StatusText) get_StatusText;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebBrowserApp self, char16* StatusText) put_StatusText;
		...
		public struct IShellUIHelper : IDispatch
		{
			...
			public HResult AddFavorite(char16* URL, VARIANT* Title) mut => VT.AddFavorite(ref this, URL, Title);
			public HResult AddChannel(char16* URL) mut => VT.AddChannel(ref this, URL);
			public HResult AddDesktopComponent(char16* URL, char16* Type, VARIANT* Left, VARIANT* Top, VARIANT* Width, VARIANT* Height) mut => VT.AddDesktopComponent(ref this, URL, Type, Left, Top, Width, Height);
			public HResult IsSubscribed(char16* URL, out int16 pBool) mut => VT.IsSubscribed(ref this, URL, out pBool);
			public HResult NavigateAndFind(char16* URL, char16* strQuery, ref VARIANT varTargetFrame) mut => VT.NavigateAndFind(ref this, URL, strQuery, ref varTargetFrame);
			public HResult ImportExportFavorites(int16 fImport, char16* strImpExpPath) mut => VT.ImportExportFavorites(ref this, fImport, strImpExpPath);
			public HResult AutoCompleteSaveForm(VARIANT* Form) mut => VT.AutoCompleteSaveForm(ref this, Form);
			public HResult AutoScan(char16* strSearch, char16* strFailureUrl, VARIANT* pvarTargetFrame) mut => VT.AutoScan(ref this, strSearch, strFailureUrl, pvarTargetFrame);
			public HResult AutoCompleteAttach(VARIANT* Reserved) mut => VT.AutoCompleteAttach(ref this, Reserved);
			public HResult ShowBrowserUI(char16* bstrName, ref VARIANT pvarIn, out VARIANT pvarOut) mut => VT.ShowBrowserUI(ref this, bstrName, ref pvarIn, out pvarOut);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* URL, VARIANT* Title) AddFavorite;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* URL) AddChannel;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* URL, char16* Type, VARIANT* Left, VARIANT* Top, VARIANT* Width, VARIANT* Height) AddDesktopComponent;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* URL, out int16 pBool) IsSubscribed;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* URL, char16* strQuery, ref VARIANT varTargetFrame) NavigateAndFind;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, int16 fImport, char16* strImpExpPath) ImportExportFavorites;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, VARIANT* Form) AutoCompleteSaveForm;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* strSearch, char16* strFailureUrl, VARIANT* pvarTargetFrame) AutoScan;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, VARIANT* Reserved) AutoCompleteAttach;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper self, char16* bstrName, ref VARIANT pvarIn, out VARIANT pvarOut) ShowBrowserUI;
			}
		}
		[CRepr]
		public struct IShellUIHelper2 : IShellUIHelper
		{
			...
			public HResult AddSearchProvider(char16* URL) mut => VT.AddSearchProvider(ref this, URL);
			public HResult RunOnceShown() mut => VT.RunOnceShown(ref this);
			public HResult SkipRunOnce() mut => VT.SkipRunOnce(ref this);
			public HResult CustomizeSettings(int16 fSQM, int16 fPhishing, char16* bstrLocale) mut => VT.CustomizeSettings(ref this, fSQM, fPhishing, bstrLocale);
			...
			public HResult BrandImageUri(out char16* pbstrUri) mut => VT.BrandImageUri(ref this, out pbstrUri);
			...
			public HResult IsSearchProviderInstalled(char16* URL, out uint32 pdwResult) mut => VT.IsSearchProviderInstalled(ref this, URL, out pdwResult);
			public HResult IsSearchMigrated(out int16 pfMigrated) mut => VT.IsSearchMigrated(ref this, out pfMigrated);
			public HResult DefaultSearchProvider(out char16* pbstrName) mut => VT.DefaultSearchProvider(ref this, out pbstrName);
			...
			public HResult SearchGuideUrl(out char16* pbstrUrl) mut => VT.SearchGuideUrl(ref this, out pbstrUrl);

			[CRepr]
			public struct VTable : IShellUIHelper.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, char16* URL) AddSearchProvider;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, int16 fSQM, int16 fPhishing, char16* bstrLocale) CustomizeSettings;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, out char16* pbstrUri) BrandImageUri;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, char16* URL, out uint32 pdwResult) IsSearchProviderInstalled;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, out int16 pfMigrated) IsSearchMigrated;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, out char16* pbstrName) DefaultSearchProvider;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper2 self, out char16* pbstrUrl) SearchGuideUrl;
			}
		}
		[CRepr]
		public struct IShellUIHelper3 : IShellUIHelper2
		{
			...
			public HResult AddService(char16* URL) mut => VT.AddService(ref this, URL);
			public HResult IsServiceInstalled(char16* URL, char16* Verb, out uint32 pdwResult) mut => VT.IsServiceInstalled(ref this, URL, Verb, out pdwResult);
			public HResult InPrivateFilteringEnabled(out int16 pfEnabled) mut => VT.InPrivateFilteringEnabled(ref this, out pfEnabled);
			public HResult AddToFavoritesBar(char16* URL, char16* Title, ref VARIANT Type) mut => VT.AddToFavoritesBar(ref this, URL, Title, ref Type);
			...
			public HResult NavigateToSuggestedSites(char16* bstrRelativeUrl) mut => VT.NavigateToSuggestedSites(ref this, bstrRelativeUrl);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper3 self, char16* URL) AddService;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper3 self, char16* URL, char16* Verb, out uint32 pdwResult) IsServiceInstalled;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper3 self, char16* URL, char16* Title, ref VARIANT Type) AddToFavoritesBar;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper3 self, char16* bstrRelativeUrl) NavigateToSuggestedSites;
		...
		public struct IShellUIHelper4 : IShellUIHelper3
		{
			...
			public HResult msSiteModeAddThumbBarButton(char16* bstrIconURL, char16* bstrTooltip, out VARIANT pvarButtonID) mut => VT.msSiteModeAddThumbBarButton(ref this, bstrIconURL, bstrTooltip, out pvarButtonID);
			...
			public HResult msSiteModeSetIconOverlay(char16* IconUrl, ref VARIANT pvarDescription) mut => VT.msSiteModeSetIconOverlay(ref this, IconUrl, ref pvarDescription);
			...
			public HResult msSiteModeCreateJumpList(char16* bstrHeader) mut => VT.msSiteModeCreateJumpList(ref this, bstrHeader);
			public HResult msSiteModeAddJumpListItem(char16* bstrName, char16* bstrActionUri, char16* bstrIconUri, ref VARIANT pvarWindowType) mut => VT.msSiteModeAddJumpListItem(ref this, bstrName, bstrActionUri, bstrIconUri, ref pvarWindowType);
			...
			public HResult msSiteModeAddButtonStyle(VARIANT uiButtonID, char16* bstrIconUrl, char16* bstrTooltip, out VARIANT pvarStyleID) mut => VT.msSiteModeAddButtonStyle(ref this, uiButtonID, bstrIconUrl, bstrTooltip, out pvarStyleID);
			...
			public HResult msAddTrackingProtectionList(char16* URL, char16* bstrFilterName) mut => VT.msAddTrackingProtectionList(ref this, URL, bstrFilterName);
			...
			public struct VTable : IShellUIHelper3.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, char16* bstrIconURL, char16* bstrTooltip, out VARIANT pvarButtonID) msSiteModeAddThumbBarButton;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, char16* IconUrl, ref VARIANT pvarDescription) msSiteModeSetIconOverlay;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, char16* bstrHeader) msSiteModeCreateJumpList;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, char16* bstrName, char16* bstrActionUri, char16* bstrIconUri, ref VARIANT pvarWindowType) msSiteModeAddJumpListItem;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, VARIANT uiButtonID, char16* bstrIconUrl, char16* bstrTooltip, out VARIANT pvarStyleID) msSiteModeAddButtonStyle;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper4 self, char16* URL, char16* bstrFilterName) msAddTrackingProtectionList;
		...
		public struct IShellUIHelper5 : IShellUIHelper4
		{
			...
			public HResult msProvisionNetworks(char16* bstrProvisioningXml, out VARIANT puiResult) mut => VT.msProvisionNetworks(ref this, bstrProvisioningXml, out puiResult);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper5 self, char16* bstrProvisioningXml, out VARIANT puiResult) msProvisionNetworks;
		...
		public struct IShellUIHelper6 : IShellUIHelper5
		{
			...
			public HResult msScheduledTileNotification(char16* bstrNotificationXml, char16* bstrNotificationId, char16* bstrNotificationTag, VARIANT startTime, VARIANT expirationTime) mut => VT.msScheduledTileNotification(ref this, bstrNotificationXml, bstrNotificationId, bstrNotificationTag, startTime, expirationTime);
			public HResult msRemoveScheduledTileNotification(char16* bstrNotificationId) mut => VT.msRemoveScheduledTileNotification(ref this, bstrNotificationId);
			public HResult msStartPeriodicBadgeUpdate(char16* pollingUri, VARIANT startTime, VARIANT uiUpdateRecurrence) mut => VT.msStartPeriodicBadgeUpdate(ref this, pollingUri, startTime, uiUpdateRecurrence);
			...
			public struct VTable : IShellUIHelper5.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper6 self, char16* bstrNotificationXml, char16* bstrNotificationId, char16* bstrNotificationTag, VARIANT startTime, VARIANT expirationTime) msScheduledTileNotification;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper6 self, char16* bstrNotificationId) msRemoveScheduledTileNotification;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper6 self, char16* pollingUri, VARIANT startTime, VARIANT uiUpdateRecurrence) msStartPeriodicBadgeUpdate;
		...
		public struct IShellUIHelper7 : IShellUIHelper6
		{
			...
			public HResult SetExperimentalFlag(char16* bstrFlagString, int16 vfFlag) mut => VT.SetExperimentalFlag(ref this, bstrFlagString, vfFlag);
			public HResult GetExperimentalFlag(char16* bstrFlagString, out int16 vfFlag) mut => VT.GetExperimentalFlag(ref this, bstrFlagString, out vfFlag);
			public HResult SetExperimentalValue(char16* bstrValueString, uint32 dwValue) mut => VT.SetExperimentalValue(ref this, bstrValueString, dwValue);
			public HResult GetExperimentalValue(char16* bstrValueString, out uint32 pdwValue) mut => VT.GetExperimentalValue(ref this, bstrValueString, out pdwValue);
			public HResult ResetAllExperimentalFlagsAndValues() mut => VT.ResetAllExperimentalFlagsAndValues(ref this);
			public HResult GetNeedIEAutoLaunchFlag(char16* bstrUrl, out int16 flag) mut => VT.GetNeedIEAutoLaunchFlag(ref this, bstrUrl, out flag);
			public HResult SetNeedIEAutoLaunchFlag(char16* bstrUrl, int16 flag) mut => VT.SetNeedIEAutoLaunchFlag(ref this, bstrUrl, flag);
			public HResult HasNeedIEAutoLaunchFlag(char16* bstrUrl, out int16 exists) mut => VT.HasNeedIEAutoLaunchFlag(ref this, bstrUrl, out exists);
			public HResult LaunchIE(char16* bstrUrl, int16 automated) mut => VT.LaunchIE(ref this, bstrUrl, automated);

			[CRepr]
			public struct VTable : IShellUIHelper6.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrFlagString, int16 vfFlag) SetExperimentalFlag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrFlagString, out int16 vfFlag) GetExperimentalFlag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrValueString, uint32 dwValue) SetExperimentalValue;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrValueString, out uint32 pdwValue) GetExperimentalValue;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self) ResetAllExperimentalFlagsAndValues;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrUrl, out int16 flag) GetNeedIEAutoLaunchFlag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrUrl, int16 flag) SetNeedIEAutoLaunchFlag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrUrl, out int16 exists) HasNeedIEAutoLaunchFlag;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper7 self, char16* bstrUrl, int16 automated) LaunchIE;
			}
		}
		[CRepr]
		public struct IShellUIHelper8 : IShellUIHelper7
		{
			...
			public HResult GetCVListData(out char16* pbstrResult) mut => VT.GetCVListData(ref this, out pbstrResult);
			public HResult GetCVListLocalData(out char16* pbstrResult) mut => VT.GetCVListLocalData(ref this, out pbstrResult);
			public HResult GetEMIEListData(out char16* pbstrResult) mut => VT.GetEMIEListData(ref this, out pbstrResult);
			public HResult GetEMIEListLocalData(out char16* pbstrResult) mut => VT.GetEMIEListLocalData(ref this, out pbstrResult);
			...
			public HResult LaunchInHVSI(char16* bstrUrl) mut => VT.LaunchInHVSI(ref this, bstrUrl);

			[CRepr]
			public struct VTable : IShellUIHelper7.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper8 self, out char16* pbstrResult) GetCVListData;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper8 self, out char16* pbstrResult) GetCVListLocalData;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper8 self, out char16* pbstrResult) GetEMIEListData;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper8 self, out char16* pbstrResult) GetEMIEListLocalData;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellUIHelper8 self, char16* bstrUrl) LaunchInHVSI;
			}
		}
		[CRepr]
		...
		public struct IShellFavoritesNameSpace : IDispatch
		{
			...
			public HResult InvokeContextMenuCommand(char16* strCommand) mut => VT.InvokeContextMenuCommand(ref this, strCommand);
			...
			public HResult SetRoot(char16* bstrFullPath) mut => VT.SetRoot(ref this, bstrFullPath);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFavoritesNameSpace self, char16* strCommand) InvokeContextMenuCommand;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFavoritesNameSpace self, char16* bstrFullPath) SetRoot;
			}
		}
		[CRepr]
		public struct IShellNameSpace : IShellFavoritesNameSpace
		{
			...
			public HResult get_Columns(out char16* bstrColumns) mut => VT.get_Columns(ref this, out bstrColumns);
			public HResult put_Columns(char16* bstrColumns) mut => VT.put_Columns(ref this, bstrColumns);
			...
			public struct VTable : IShellFavoritesNameSpace.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellNameSpace self, out char16* bstrColumns) get_Columns;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellNameSpace self, char16* bstrColumns) put_Columns;
		...
		public struct IScriptErrorList : IDispatch
		{
			...
			public HResult canAdvanceError(out IntBool pfCanAdvance) mut => VT.canAdvanceError(ref this, out pfCanAdvance);
			public HResult canRetreatError(out IntBool pfCanRetreat) mut => VT.canRetreatError(ref this, out pfCanRetreat);
			...
			public HResult getErrorMsg(out char16* pstr) mut => VT.getErrorMsg(ref this, out pstr);
			public HResult getErrorUrl(out char16* pstr) mut => VT.getErrorUrl(ref this, out pstr);
			public HResult getAlwaysShowLockState(out IntBool pfAlwaysShowLocked) mut => VT.getAlwaysShowLockState(ref this, out pfAlwaysShowLocked);
			public HResult getDetailsPaneOpen(out IntBool pfDetailsPaneOpen) mut => VT.getDetailsPaneOpen(ref this, out pfDetailsPaneOpen);
			public HResult setDetailsPaneOpen(IntBool fDetailsPaneOpen) mut => VT.setDetailsPaneOpen(ref this, fDetailsPaneOpen);
			public HResult getPerErrorDisplay(out IntBool pfPerErrorDisplay) mut => VT.getPerErrorDisplay(ref this, out pfPerErrorDisplay);
			public HResult setPerErrorDisplay(IntBool fPerErrorDisplay) mut => VT.setPerErrorDisplay(ref this, fPerErrorDisplay);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out IntBool pfCanAdvance) canAdvanceError;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out IntBool pfCanRetreat) canRetreatError;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out char16* pstr) getErrorMsg;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out char16* pstr) getErrorUrl;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out IntBool pfAlwaysShowLocked) getAlwaysShowLockState;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out IntBool pfDetailsPaneOpen) getDetailsPaneOpen;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, IntBool fDetailsPaneOpen) setDetailsPaneOpen;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, out IntBool pfPerErrorDisplay) getPerErrorDisplay;
				public new function [CallingConvention(.Stdcall)] HResult(ref IScriptErrorList self, IntBool fPerErrorDisplay) setPerErrorDisplay;
			}
		}
		[CRepr]
		...
		public struct DFConstraint : IDispatch
		{
			...
			public HResult get_Name(out char16* pbs) mut => VT.get_Name(ref this, out pbs);
			public HResult get_Value(out VARIANT pv) mut => VT.get_Value(ref this, out pv);

			[CRepr]
			public struct VTable : IDispatch.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref DFConstraint self, out char16* pbs) get_Name;
		...
		public struct FolderItem : IDispatch
		{
			...
			public HResult get_Name(out char16* pbs) mut => VT.get_Name(ref this, out pbs);
			public HResult put_Name(char16* bs) mut => VT.put_Name(ref this, bs);
			public HResult get_Path(out char16* pbs) mut => VT.get_Path(ref this, out pbs);
			...
			public HResult get_Type(out char16* pbs) mut => VT.get_Type(ref this, out pbs);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItem self, out char16* pbs) get_Name;
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItem self, char16* bs) put_Name;
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItem self, out char16* pbs) get_Path;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItem self, out char16* pbs) get_Type;
		...
		public struct FolderItemVerb : IDispatch
		{
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItemVerb self, out char16* pbs) get_Name;
		...
		public struct Folder : IDispatch
		{
			...
			public HResult get_Title(out char16* pbs) mut => VT.get_Title(ref this, out pbs);
			public HResult get_Application(out IDispatch* ppid) mut => VT.get_Application(ref this, out ppid);
			public HResult get_Parent(out IDispatch* ppid) mut => VT.get_Parent(ref this, out ppid);
			...
			public HResult ParseName(char16* bName, out FolderItem* ppid) mut => VT.ParseName(ref this, bName, out ppid);
			public HResult NewFolder(char16* bName, VARIANT vOptions) mut => VT.NewFolder(ref this, bName, vOptions);
			...
			public HResult GetDetailsOf(VARIANT vItem, int32 iColumn, out char16* pbs) mut => VT.GetDetailsOf(ref this, vItem, iColumn, out pbs);

			[CRepr]
			public struct VTable : IDispatch.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref Folder self, out char16* pbs) get_Title;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Folder self, char16* bName, out FolderItem* ppid) ParseName;
				public new function [CallingConvention(.Stdcall)] HResult(ref Folder self, char16* bName, VARIANT vOptions) NewFolder;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref Folder self, VARIANT vItem, int32 iColumn, out char16* pbs) GetDetailsOf;
			}
		}
		[CRepr]
		...
		public struct FolderItem2 : FolderItem
		{
			...
			public HResult ExtendedProperty(char16* bstrPropName, out VARIANT pvRet) mut => VT.ExtendedProperty(ref this, bstrPropName, out pvRet);
			...
			public struct VTable : FolderItem.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItem2 self, char16* bstrPropName, out VARIANT pvRet) ExtendedProperty;
			}
		}
		[CRepr]
		...
		public struct FolderItems3 : FolderItems2
		{
			...
			public HResult Filter(int32 grfFlags, char16* bstrFileSpec) mut => VT.Filter(ref this, grfFlags, bstrFileSpec);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref FolderItems3 self, int32 grfFlags, char16* bstrFileSpec) Filter;
		...
		public struct IShellLinkDual : IDispatch
		{
			...
			public HResult get_Path(out char16* pbs) mut => VT.get_Path(ref this, out pbs);
			public HResult put_Path(char16* bs) mut => VT.put_Path(ref this, bs);
			public HResult get_Description(out char16* pbs) mut => VT.get_Description(ref this, out pbs);
			public HResult put_Description(char16* bs) mut => VT.put_Description(ref this, bs);
			public HResult get_WorkingDirectory(out char16* pbs) mut => VT.get_WorkingDirectory(ref this, out pbs);
			public HResult put_WorkingDirectory(char16* bs) mut => VT.put_WorkingDirectory(ref this, bs);
			public HResult get_Arguments(out char16* pbs) mut => VT.get_Arguments(ref this, out pbs);
			public HResult put_Arguments(char16* bs) mut => VT.put_Arguments(ref this, bs);
			...
			public HResult GetIconLocation(out char16* pbs, out int32 piIcon) mut => VT.GetIconLocation(ref this, out pbs, out piIcon);
			public HResult SetIconLocation(char16* bs, int32 iIcon) mut => VT.SetIconLocation(ref this, bs, iIcon);
			public HResult Save(VARIANT vWhere) mut => VT.Save(ref this, vWhere);

			[CRepr]
			public struct VTable : IDispatch.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, out char16* pbs) get_Path;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, char16* bs) put_Path;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, out char16* pbs) get_Description;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, char16* bs) put_Description;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, out char16* pbs) get_WorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, char16* bs) put_WorkingDirectory;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, out char16* pbs) get_Arguments;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, char16* bs) put_Arguments;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, out char16* pbs, out int32 piIcon) GetIconLocation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellLinkDual self, char16* bs, int32 iIcon) SetIconLocation;
		...
		public struct IShellFolderViewDual : IDispatch
		{
			...
			public HResult PopupItemMenu(ref FolderItem pfi, VARIANT vx, VARIANT vy, out char16* pbs) mut => VT.PopupItemMenu(ref this, ref pfi, vx, vy, out pbs);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual self, ref FolderItem pfi, VARIANT vx, VARIANT vy, out char16* pbs) PopupItemMenu;
		...
		public struct IShellFolderViewDual3 : IShellFolderViewDual2
		{
			...
			public HResult get_GroupBy(out char16* pbstrGroupBy) mut => VT.get_GroupBy(ref this, out pbstrGroupBy);
			public HResult put_GroupBy(char16* bstrGroupBy) mut => VT.put_GroupBy(ref this, bstrGroupBy);
			...
			public HResult get_SortColumns(out char16* pbstrSortColumns) mut => VT.get_SortColumns(ref this, out pbstrSortColumns);
			public HResult put_SortColumns(char16* bstrSortColumns) mut => VT.put_SortColumns(ref this, bstrSortColumns);
			...
			public HResult FilterView(char16* bstrFilterText) mut => VT.FilterView(ref this, bstrFilterText);

			[CRepr]
			public struct VTable : IShellFolderViewDual2.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual3 self, out char16* pbstrGroupBy) get_GroupBy;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual3 self, char16* bstrGroupBy) put_GroupBy;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual3 self, out char16* pbstrSortColumns) get_SortColumns;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual3 self, char16* bstrSortColumns) put_SortColumns;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderViewDual3 self, char16* bstrFilterText) FilterView;
			}
		}
		[CRepr]
		public struct IShellDispatch : IDispatch
		{
			...
			public HResult BrowseForFolder(int32 Hwnd, char16* Title, int32 Options, VARIANT RootFolder, out Folder* ppsdf) mut => VT.BrowseForFolder(ref this, Hwnd, Title, Options, RootFolder, out ppsdf);
			...
			public HResult CascadeWindows() mut => VT._CascadeWindows(ref this);
			...
			public HResult ControlPanelItem(char16* bstrDir) mut => VT.ControlPanelItem(ref this, bstrDir);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch self, int32 Hwnd, char16* Title, int32 Options, VARIANT RootFolder, out Folder* ppsdf) BrowseForFolder;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch self) _CascadeWindows;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch self, char16* bstrDir) ControlPanelItem;
			}
		}
		[CRepr]
		public struct IShellDispatch2 : IShellDispatch
		{
			...
			public HResult IsRestricted(char16* Group, char16* Restriction, out int32 plRestrictValue) mut => VT.IsRestricted(ref this, Group, Restriction, out plRestrictValue);
			public HResult ShellExecute(char16* File, VARIANT vArgs, VARIANT vDir, VARIANT vOperation, VARIANT vShow) mut => VT.ShellExecute(ref this, File, vArgs, vDir, vOperation, vShow);
			public HResult FindPrinter(char16* name, char16* location, char16* model) mut => VT.FindPrinter(ref this, name, location, model);
			public HResult GetSystemInformation(char16* name, out VARIANT pv) mut => VT.GetSystemInformation(ref this, name, out pv);
			public HResult ServiceStart(char16* ServiceName, VARIANT Persistent, out VARIANT pSuccess) mut => VT.ServiceStart(ref this, ServiceName, Persistent, out pSuccess);
			public HResult ServiceStop(char16* ServiceName, VARIANT Persistent, out VARIANT pSuccess) mut => VT.ServiceStop(ref this, ServiceName, Persistent, out pSuccess);
			public HResult IsServiceRunning(char16* ServiceName, out VARIANT pRunning) mut => VT.IsServiceRunning(ref this, ServiceName, out pRunning);
			public HResult CanStartStopService(char16* ServiceName, out VARIANT pCanStartStop) mut => VT.CanStartStopService(ref this, ServiceName, out pCanStartStop);
			public HResult ShowBrowserBar(char16* bstrClsid, VARIANT bShow, out VARIANT pSuccess) mut => VT.ShowBrowserBar(ref this, bstrClsid, bShow, out pSuccess);

			[CRepr]
			public struct VTable : IShellDispatch.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* Group, char16* Restriction, out int32 plRestrictValue) IsRestricted;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* File, VARIANT vArgs, VARIANT vDir, VARIANT vOperation, VARIANT vShow) ShellExecute;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* name, char16* location, char16* model) FindPrinter;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* name, out VARIANT pv) GetSystemInformation;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* ServiceName, VARIANT Persistent, out VARIANT pSuccess) ServiceStart;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* ServiceName, VARIANT Persistent, out VARIANT pSuccess) ServiceStop;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* ServiceName, out VARIANT pRunning) IsServiceRunning;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* ServiceName, out VARIANT pCanStartStop) CanStartStopService;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch2 self, char16* bstrClsid, VARIANT bShow, out VARIANT pSuccess) ShowBrowserBar;
			}
		}
		[CRepr]
		public struct IShellDispatch3 : IShellDispatch2
		{
			...
			public HResult AddToRecent(VARIANT varFile, char16* bstrCategory) mut => VT.AddToRecent(ref this, varFile, bstrCategory);

			[CRepr]
			public struct VTable : IShellDispatch2.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch3 self, VARIANT varFile, char16* bstrCategory) AddToRecent;
			}
		}
		[CRepr]
		public struct IShellDispatch4 : IShellDispatch3
		{
			...
			public HResult ExplorerPolicy(char16* bstrPolicyName, out VARIANT pValue) mut => VT.ExplorerPolicy(ref this, bstrPolicyName, out pValue);
			...
			public struct VTable : IShellDispatch3.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellDispatch4 self, char16* bstrPolicyName, out VARIANT pValue) ExplorerPolicy;
		...
		public struct IFileSearchBand : IDispatch
		{
			...
			public HResult SetFocus() mut => VT._SetFocus(ref this);
			public HResult SetSearchParameters(ref char16* pbstrSearchID, int16 bNavToResults, ref VARIANT pvarScope, ref VARIANT pvarQueryFile) mut => VT.SetSearchParameters(ref this, ref pbstrSearchID, bNavToResults, ref pvarScope, ref pvarQueryFile);
			public HResult get_SearchID(out char16* pbstrSearchID) mut => VT.get_SearchID(ref this, out pbstrSearchID);
			...
			public struct VTable : IDispatch.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSearchBand self) _SetFocus;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSearchBand self, ref char16* pbstrSearchID, int16 bNavToResults, ref VARIANT pvarScope, ref VARIANT pvarQueryFile) SetSearchParameters;
				public new function [CallingConvention(.Stdcall)] HResult(ref IFileSearchBand self, out char16* pbstrSearchID) get_SearchID;
		...
		public struct IWebWizardHost : IDispatch
		{
			...
			public HResult put_Caption(char16* bstrCaption) mut => VT.put_Caption(ref this, bstrCaption);
			public HResult get_Caption(out char16* pbstrCaption) mut => VT.get_Caption(ref this, out pbstrCaption);
			public HResult put_Property(char16* bstrPropertyName, ref VARIANT pvProperty) mut => VT.put_Property(ref this, bstrPropertyName, ref pvProperty);
			public HResult get_Property(char16* bstrPropertyName, out VARIANT pvProperty) mut => VT.get_Property(ref this, bstrPropertyName, out pvProperty);
			...
			public HResult SetHeaderText(char16* bstrHeaderTitle, char16* bstrHeaderSubtitle) mut => VT.SetHeaderText(ref this, bstrHeaderTitle, bstrHeaderSubtitle);
			...
			public struct VTable : IDispatch.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost self, char16* bstrCaption) put_Caption;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost self, out char16* pbstrCaption) get_Caption;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost self, char16* bstrPropertyName, ref VARIANT pvProperty) put_Property;
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost self, char16* bstrPropertyName, out VARIANT pvProperty) get_Property;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost self, char16* bstrHeaderTitle, char16* bstrHeaderSubtitle) SetHeaderText;
			}
		}
		[CRepr]
		public struct IWebWizardHost2 : IWebWizardHost
		{
			...
			public HResult SignString(char16* value, out char16* signedValue) mut => VT.SignString(ref this, value, out signedValue);

			[CRepr]
			public struct VTable : IWebWizardHost.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IWebWizardHost2 self, char16* value, out char16* signedValue) SignString;
			}
		}
		[CRepr]
		public struct INewWDEvents : IWebWizardHost
		{
			...
			public HResult PassportAuthenticate(char16* bstrSignInUrl, out int16 pvfAuthenitcated) mut => VT.PassportAuthenticate(ref this, bstrSignInUrl, out pvfAuthenitcated);

			[CRepr]
			public struct VTable : IWebWizardHost.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INewWDEvents self, char16* bstrSignInUrl, out int16 pvfAuthenitcated) PassportAuthenticate;
			}
		}
		[CRepr]
		public struct IAutoComplete : IUnknown
		{
			...
			public HResult Init(HWnd hwndEdit, ref IUnknown punkACL, char16* pwszRegKeyPath, char16* pwszQuickComplete) mut => VT.Init(ref this, hwndEdit, ref punkACL, pwszRegKeyPath, pwszQuickComplete);
			public HResult Enable(IntBool fEnable) mut => VT.Enable(ref this, fEnable);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IAutoComplete self, HWnd hwndEdit, ref IUnknown punkACL, char16* pwszRegKeyPath, char16* pwszQuickComplete) Init;
				public new function [CallingConvention(.Stdcall)] HResult(ref IAutoComplete self, IntBool fEnable) Enable;
			}
		}
		[CRepr]
		...
		public struct IDataObjectAsyncCapability : IUnknown
		{
			...
			public HResult SetAsyncMode(IntBool fDoOpAsync) mut => VT.SetAsyncMode(ref this, fDoOpAsync);
			public HResult GetAsyncMode(out IntBool pfIsOpAsync) mut => VT.GetAsyncMode(ref this, out pfIsOpAsync);
			public HResult StartOperation(IBindCtx* pbcReserved) mut => VT.StartOperation(ref this, pbcReserved);
			public HResult InOperation(out IntBool pfInAsyncOp) mut => VT.InOperation(ref this, out pfInAsyncOp);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDataObjectAsyncCapability self, IntBool fDoOpAsync) SetAsyncMode;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDataObjectAsyncCapability self, out IntBool pfIsOpAsync) GetAsyncMode;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDataObjectAsyncCapability self, out IntBool pfInAsyncOp) InOperation;
		...
		public struct IExtractIconA : IUnknown
		{
			...
			public HResult Extract(char8* pszFile, uint32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize) mut => VT.Extract(ref this, pszFile, nIconIndex, phiconLarge, phiconSmall, nIconSize);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtractIconA self, char8* pszFile, uint32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize) Extract;
			}
		}
		[CRepr]
		public struct IExtractIconW : IUnknown
		{
			...
			public HResult Extract(char16* pszFile, uint32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize) mut => VT.Extract(ref this, pszFile, nIconIndex, phiconLarge, phiconSmall, nIconSize);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtractIconW self, char16* pszFile, uint32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize) Extract;
			}
		}
		[CRepr]
		public struct IShellIconOverlayManager : IUnknown
		{
			...
			public HResult GetFileOverlayInfo(char16* pwszPath, uint32 dwAttrib, out int32 pIndex, uint32 dwflags) mut => VT.GetFileOverlayInfo(ref this, pwszPath, dwAttrib, out pIndex, dwflags);
			public HResult GetReservedOverlayInfo(char16* pwszPath, uint32 dwAttrib, out int32 pIndex, uint32 dwflags, int32 iReservedID) mut => VT.GetReservedOverlayInfo(ref this, pwszPath, dwAttrib, out pIndex, dwflags, iReservedID);
			...
			public HResult OverlayIndexFromImageIndex(int32 iImage, out int32 piIndex, IntBool fAdd) mut => VT.OverlayIndexFromImageIndex(ref this, iImage, out piIndex, fAdd);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellIconOverlayManager self, char16* pwszPath, uint32 dwAttrib, out int32 pIndex, uint32 dwflags) GetFileOverlayInfo;
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellIconOverlayManager self, char16* pwszPath, uint32 dwAttrib, out int32 pIndex, uint32 dwflags, int32 iReservedID) GetReservedOverlayInfo;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellIconOverlayManager self, int32 iImage, out int32 piIndex, IntBool fAdd) OverlayIndexFromImageIndex;
			}
		}
		[CRepr]
		...
		public struct ISearchContext : IUnknown
		{
			...
			public HResult GetSearchUrl(out char16* pbstrSearchUrl) mut => VT.GetSearchUrl(ref this, out pbstrSearchUrl);
			public HResult GetSearchText(out char16* pbstrSearchText) mut => VT.GetSearchText(ref this, out pbstrSearchText);
			public HResult GetSearchStyle(out uint32 pdwSearchStyle) mut => VT.GetSearchStyle(ref this, out pdwSearchStyle);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISearchContext self, out char16* pbstrSearchUrl) GetSearchUrl;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISearchContext self, out char16* pbstrSearchText) GetSearchText;
		...
		public struct IACList : IUnknown
		{
			...
			public HResult Expand(char16* pszExpand) mut => VT.Expand(ref this, pszExpand);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IACList self, char16* pszExpand) Expand;
			}
		}
		[CRepr]
		...
		public struct IProgressDialog : IUnknown
		{
			...
			public HResult StopProgressDialog() mut => VT.StopProgressDialog(ref this);
			public HResult SetTitle(char16* pwzTitle) mut => VT.SetTitle(ref this, pwzTitle);
			...
			public IntBool HasUserCancelled() mut => VT.HasUserCancelled(ref this);
			...
			public HResult SetLine(uint32 dwLineNum, char16* pwzString, IntBool fCompactPath, void* pvResevered) mut => VT.SetLine(ref this, dwLineNum, pwzString, fCompactPath, pvResevered);
			public HResult SetCancelMsg(char16* pwzCancelMsg, void* pvResevered) mut => VT.SetCancelMsg(ref this, pwzCancelMsg, pvResevered);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IProgressDialog self, char16* pwzTitle) SetTitle;
				...
				public new function [CallingConvention(.Stdcall)] IntBool(ref IProgressDialog self) HasUserCancelled;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IProgressDialog self, uint32 dwLineNum, char16* pwzString, IntBool fCompactPath, void* pvResevered) SetLine;
				public new function [CallingConvention(.Stdcall)] HResult(ref IProgressDialog self, char16* pwzCancelMsg, void* pvResevered) SetCancelMsg;
		...
		public struct IDockingWindowSite : IOleWindow
		{
			...
			public HResult GetBorderDW(ref IUnknown punkObj, out RectI prcBorder) mut => VT.GetBorderDW(ref this, ref punkObj, out prcBorder);
			public HResult RequestBorderSpaceDW(ref IUnknown punkObj, ref RectI pbw) mut => VT.RequestBorderSpaceDW(ref this, ref punkObj, ref pbw);
			public HResult SetBorderSpaceDW(ref IUnknown punkObj, ref RectI pbw) mut => VT.SetBorderSpaceDW(ref this, ref punkObj, ref pbw);

			[CRepr]
			public struct VTable : IOleWindow.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindowSite self, ref IUnknown punkObj, out RectI prcBorder) GetBorderDW;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindowSite self, ref IUnknown punkObj, ref RectI pbw) RequestBorderSpaceDW;
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindowSite self, ref IUnknown punkObj, ref RectI pbw) SetBorderSpaceDW;
			}
		}
		[CRepr]
		...
		public struct IQueryInfo : IUnknown
		{
			...
			public HResult GetInfoTip(QITIPF_FLAGS dwFlags, out char16* ppwszTip) mut => VT.GetInfoTip(ref this, dwFlags, out ppwszTip);
			public HResult GetInfoFlags(out uint32 pdwFlags) mut => VT.GetInfoFlags(ref this, out pdwFlags);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryInfo self, QITIPF_FLAGS dwFlags, out char16* ppwszTip) GetInfoTip;
		...
		public struct IShellFolderView : IUnknown
		{
			...
			public HResult SetRedraw(IntBool bRedraw) mut => VT.SetRedraw(ref this, bRedraw);
			...
			public HResult SetClipboard(IntBool bMove) mut => VT.SetClipboard(ref this, bMove);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderView self, IntBool bRedraw) SetRedraw;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellFolderView self, IntBool bMove) SetClipboard;
		...
		public struct INamedPropertyBag : IUnknown
		{
			...
			public HResult ReadPropertyNPB(char16* pszBagname, char16* pszPropName, out PROPVARIANT pVar) mut => VT.ReadPropertyNPB(ref this, pszBagname, pszPropName, out pVar);
			public HResult WritePropertyNPB(char16* pszBagname, char16* pszPropName, ref PROPVARIANT pVar) mut => VT.WritePropertyNPB(ref this, pszBagname, pszPropName, ref pVar);
			public HResult RemovePropertyNPB(char16* pszBagname, char16* pszPropName) mut => VT.RemovePropertyNPB(ref this, pszBagname, pszPropName);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INamedPropertyBag self, char16* pszBagname, char16* pszPropName, out PROPVARIANT pVar) ReadPropertyNPB;
				public new function [CallingConvention(.Stdcall)] HResult(ref INamedPropertyBag self, char16* pszBagname, char16* pszPropName, ref PROPVARIANT pVar) WritePropertyNPB;
				public new function [CallingConvention(.Stdcall)] HResult(ref INamedPropertyBag self, char16* pszBagname, char16* pszPropName) RemovePropertyNPB;
			}
		}
		[CRepr]
		public struct INewShortcutHookA : IUnknown
		{
			...
			public HResult SetReferent(char8* pcszReferent, HWnd hwnd) mut => VT.SetReferent(ref this, pcszReferent, hwnd);
			public HResult GetReferent(uint8* pszReferent, int32 cchReferent) mut => VT.GetReferent(ref this, pszReferent, cchReferent);
			public HResult SetFolder(char8* pcszFolder) mut => VT.SetFolder(ref this, pcszFolder);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INewShortcutHookA self, char8* pcszReferent, HWnd hwnd) SetReferent;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INewShortcutHookA self, char8* pcszFolder) SetFolder;
		...
		public struct INewShortcutHookW : IUnknown
		{
			...
			public HResult SetReferent(char16* pcszReferent, HWnd hwnd) mut => VT.SetReferent(ref this, pcszReferent, hwnd);
			public HResult GetReferent(char16* pszReferent, int32 cchReferent) mut => VT.GetReferent(ref this, pszReferent, cchReferent);
			public HResult SetFolder(char16* pcszFolder) mut => VT.SetFolder(ref this, pcszFolder);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref INewShortcutHookW self, char16* pcszReferent, HWnd hwnd) SetReferent;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref INewShortcutHookW self, char16* pcszFolder) SetFolder;
		...
		public struct ICopyHookA : IUnknown
		{
			...
			public uint32 CopyCallback(HWnd hwnd, uint32 wFunc, uint32 wFlags, char8* pszSrcFile, uint32 dwSrcAttribs, char8* pszDestFile, uint32 dwDestAttribs) mut => VT.CopyCallback(ref this, hwnd, wFunc, wFlags, pszSrcFile, dwSrcAttribs, pszDestFile, dwDestAttribs);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] uint32(ref ICopyHookA self, HWnd hwnd, uint32 wFunc, uint32 wFlags, char8* pszSrcFile, uint32 dwSrcAttribs, char8* pszDestFile, uint32 dwDestAttribs) CopyCallback;
			}
		}
		[CRepr]
		public struct ICopyHookW : IUnknown
		{
			...
			public uint32 CopyCallback(HWnd hwnd, uint32 wFunc, uint32 wFlags, char16* pszSrcFile, uint32 dwSrcAttribs, char16* pszDestFile, uint32 dwDestAttribs) mut => VT.CopyCallback(ref this, hwnd, wFunc, wFlags, pszSrcFile, dwSrcAttribs, pszDestFile, dwDestAttribs);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] uint32(ref ICopyHookW self, HWnd hwnd, uint32 wFunc, uint32 wFlags, char16* pszSrcFile, uint32 dwSrcAttribs, char16* pszDestFile, uint32 dwDestAttribs) CopyCallback;
			}
		}
		[CRepr]
		public struct ICurrentWorkingDirectory : IUnknown
		{
			...
			public HResult SetDirectory(char16* pwzPath) mut => VT.SetDirectory(ref this, pwzPath);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICurrentWorkingDirectory self, char16* pwzPath) SetDirectory;
			}
		}
		[CRepr]
		public struct IDockingWindowFrame : IOleWindow
		{
			...
			public HResult AddToolbar(ref IUnknown punkSrc, char16* pwszItem, uint32 dwAddFlags) mut => VT.AddToolbar(ref this, ref punkSrc, pwszItem, dwAddFlags);
			...
			public HResult FindToolbar(char16* pwszItem, in Guid riid, void** ppv) mut => VT.FindToolbar(ref this, pwszItem, riid, ppv);

			[CRepr]
			public struct VTable : IOleWindow.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindowFrame self, ref IUnknown punkSrc, char16* pwszItem, uint32 dwAddFlags) AddToolbar;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDockingWindowFrame self, char16* pwszItem, in Guid riid, void** ppv) FindToolbar;
			}
		}
		[CRepr]
		...
		public struct IDeskBarClient : IOleWindow
		{
			...
			public HResult GetSize(uint32 dwWhich, out RectI prc) mut => VT.GetSize(ref this, dwWhich, out prc);
			...
			public struct VTable : IOleWindow.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IDeskBarClient self, uint32 dwWhich, out RectI prc) GetSize;
			}
		}
		[CRepr]
		...
		public struct IQueryAssociations : IUnknown
		{
			...
			public HResult Init(uint32 flags, char16* pszAssoc, HKey hkProgid, HWnd hwnd) mut => VT.Init(ref this, flags, pszAssoc, hkProgid, hwnd);
			public HResult GetString(uint32 flags, ASSOCSTR str, char16* pszExtra, char16* pszOut, out uint32 pcchOut) mut => VT.GetString(ref this, flags, str, pszExtra, pszOut, out pcchOut);
			public HResult GetKey(uint32 flags, ASSOCKEY key, char16* pszExtra, out HKey phkeyOut) mut => VT.GetKey(ref this, flags, key, pszExtra, out phkeyOut);
			public HResult GetData(uint32 flags, ASSOCDATA data, char16* pszExtra, void* pvOut, uint32* pcbOut) mut => VT.GetData(ref this, flags, data, pszExtra, pvOut, pcbOut);
			public HResult GetEnum(uint32 flags, ASSOCENUM assocenum, char16* pszExtra, in Guid riid, void** ppvOut) mut => VT.GetEnum(ref this, flags, assocenum, pszExtra, riid, ppvOut);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryAssociations self, uint32 flags, char16* pszAssoc, HKey hkProgid, HWnd hwnd) Init;
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryAssociations self, uint32 flags, ASSOCSTR str, char16* pszExtra, char16* pszOut, out uint32 pcchOut) GetString;
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryAssociations self, uint32 flags, ASSOCKEY key, char16* pszExtra, out HKey phkeyOut) GetKey;
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryAssociations self, uint32 flags, ASSOCDATA data, char16* pszExtra, void* pvOut, uint32* pcbOut) GetData;
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryAssociations self, uint32 flags, ASSOCENUM assocenum, char16* pszExtra, in Guid riid, void** ppvOut) GetEnum;
			}
		}
		[CRepr]
		...
		public struct ICredentialProviderCredential : IUnknown
		{
			...
			public HResult SetSelected(out IntBool pbAutoLogon) mut => VT.SetSelected(ref this, out pbAutoLogon);
			...
			public HResult GetStringValue(uint32 dwFieldID, out char16* ppsz) mut => VT.GetStringValue(ref this, dwFieldID, out ppsz);
			public HResult GetBitmapValue(uint32 dwFieldID, out HBitmap phbmp) mut => VT.GetBitmapValue(ref this, dwFieldID, out phbmp);
			public HResult GetCheckboxValue(uint32 dwFieldID, out IntBool pbChecked, out char16* ppszLabel) mut => VT.GetCheckboxValue(ref this, dwFieldID, out pbChecked, out ppszLabel);
			...
			public HResult GetComboBoxValueAt(uint32 dwFieldID, uint32 dwItem, out char16* ppszItem) mut => VT.GetComboBoxValueAt(ref this, dwFieldID, dwItem, out ppszItem);
			public HResult SetStringValue(uint32 dwFieldID, char16* psz) mut => VT.SetStringValue(ref this, dwFieldID, psz);
			public HResult SetCheckboxValue(uint32 dwFieldID, IntBool bChecked) mut => VT.SetCheckboxValue(ref this, dwFieldID, bChecked);
			...
			public HResult GetSerialization(out CREDENTIAL_PROVIDER_GET_SERIALIZATION_RESPONSE pcpgsr, out CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION pcpcs, char16** ppszOptionalStatusText, out CREDENTIAL_PROVIDER_STATUS_ICON pcpsiOptionalStatusIcon) mut => VT.GetSerialization(ref this, out pcpgsr, out pcpcs, ppszOptionalStatusText, out pcpsiOptionalStatusIcon);
			public HResult ReportResult(NTSTATUS ntsStatus, NTSTATUS ntsSubstatus, char16** ppszOptionalStatusText, out CREDENTIAL_PROVIDER_STATUS_ICON pcpsiOptionalStatusIcon) mut => VT.ReportResult(ref this, ntsStatus, ntsSubstatus, ppszOptionalStatusText, out pcpsiOptionalStatusIcon);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, out IntBool pbAutoLogon) SetSelected;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, uint32 dwFieldID, out char16* ppsz) GetStringValue;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, uint32 dwFieldID, out IntBool pbChecked, out char16* ppszLabel) GetCheckboxValue;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, uint32 dwFieldID, uint32 dwItem, out char16* ppszItem) GetComboBoxValueAt;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, uint32 dwFieldID, char16* psz) SetStringValue;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, uint32 dwFieldID, IntBool bChecked) SetCheckboxValue;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, out CREDENTIAL_PROVIDER_GET_SERIALIZATION_RESPONSE pcpgsr, out CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION pcpcs, char16** ppszOptionalStatusText, out CREDENTIAL_PROVIDER_STATUS_ICON pcpsiOptionalStatusIcon) GetSerialization;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential self, NTSTATUS ntsStatus, NTSTATUS ntsSubstatus, char16** ppszOptionalStatusText, out CREDENTIAL_PROVIDER_STATUS_ICON pcpsiOptionalStatusIcon) ReportResult;
			}
		}
		[CRepr]
		public struct IQueryContinueWithStatus : IQueryContinue
		{
			...
			public HResult SetStatusMessage(char16* psz) mut => VT.SetStatusMessage(ref this, psz);

			[CRepr]
			public struct VTable : IQueryContinue.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IQueryContinueWithStatus self, char16* psz) SetStatusMessage;
			}
		}
		[CRepr]
		...
		public struct ICredentialProviderCredentialEvents : IUnknown
		{
			...
			public HResult SetFieldString(ref ICredentialProviderCredential pcpc, uint32 dwFieldID, char16* psz) mut => VT.SetFieldString(ref this, ref pcpc, dwFieldID, psz);
			public HResult SetFieldCheckbox(ref ICredentialProviderCredential pcpc, uint32 dwFieldID, IntBool bChecked, char16* pszLabel) mut => VT.SetFieldCheckbox(ref this, ref pcpc, dwFieldID, bChecked, pszLabel);
			...
			public HResult AppendFieldComboBoxItem(ref ICredentialProviderCredential pcpc, uint32 dwFieldID, char16* pszItem) mut => VT.AppendFieldComboBoxItem(ref this, ref pcpc, dwFieldID, pszItem);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredentialEvents self, ref ICredentialProviderCredential pcpc, uint32 dwFieldID, char16* psz) SetFieldString;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredentialEvents self, ref ICredentialProviderCredential pcpc, uint32 dwFieldID, IntBool bChecked, char16* pszLabel) SetFieldCheckbox;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredentialEvents self, ref ICredentialProviderCredential pcpc, uint32 dwFieldID, char16* pszItem) AppendFieldComboBoxItem;
		...
		public struct ICredentialProvider : IUnknown
		{
			...
			public HResult GetCredentialCount(out uint32 pdwCount, out uint32 pdwDefault, out IntBool pbAutoLogonWithDefault) mut => VT.GetCredentialCount(ref this, out pdwCount, out pdwDefault, out pbAutoLogonWithDefault);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProvider self, out uint32 pdwCount, out uint32 pdwDefault, out IntBool pbAutoLogonWithDefault) GetCredentialCount;
		...
		public struct ICredentialProviderFilter : IUnknown
		{
			...
			public HResult Filter(CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus, uint32 dwFlags, Guid* rgclsidProviders, IntBool* rgbAllow, uint32 cProviders) mut => VT.Filter(ref this, cpus, dwFlags, rgclsidProviders, rgbAllow, cProviders);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderFilter self, CREDENTIAL_PROVIDER_USAGE_SCENARIO cpus, uint32 dwFlags, Guid* rgclsidProviders, IntBool* rgbAllow, uint32 cProviders) Filter;
		...
		public struct ICredentialProviderCredential2 : ICredentialProviderCredential
		{
			...
			public HResult GetUserSid(char16** sid) mut => VT.GetUserSid(ref this, sid);

			[CRepr]
			public struct VTable : ICredentialProviderCredential.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderCredential2 self, char16** sid) GetUserSid;
			}
		}
		[CRepr]
		...
		public struct ICredentialProviderUser : IUnknown
		{
			...
			public HResult GetSid(out char16* sid) mut => VT.GetSid(ref this, out sid);
			public HResult GetProviderID(out Guid providerID) mut => VT.GetProviderID(ref this, out providerID);
			public HResult GetStringValue(in PROPERTYKEY key, out char16* stringValue) mut => VT.GetStringValue(ref this, key, out stringValue);
			public HResult GetValue(in PROPERTYKEY key, out PROPVARIANT value) mut => VT.GetValue(ref this, key, out value);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderUser self, out char16* sid) GetSid;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderUser self, out Guid providerID) GetProviderID;
				public new function [CallingConvention(.Stdcall)] HResult(ref ICredentialProviderUser self, in PROPERTYKEY key, out char16* stringValue) GetStringValue;
		...
		public struct ISyncMgrHandlerCollection : IUnknown
		{
			...
			public HResult BindToHandler(char16* pszHandlerID, in Guid riid, void** ppv) mut => VT.BindToHandler(ref this, pszHandlerID, riid, ppv);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandlerCollection self, char16* pszHandlerID, in Guid riid, void** ppv) BindToHandler;
			}
		}
		[CRepr]
		public struct ISyncMgrHandler : IUnknown
		{
			...
			public HResult GetName(out char16* ppszName) mut => VT.GetName(ref this, out ppszName);
			...
			public HResult Activate(IntBool fActivate) mut => VT.Activate(ref this, fActivate);
			public HResult Enable(IntBool fEnable) mut => VT.Enable(ref this, fEnable);
			public HResult Synchronize(char16** ppszItemIDs, uint32 cItems, HWnd hwndOwner, ref ISyncMgrSessionCreator pSessionCreator, ref IUnknown punk) mut => VT.Synchronize(ref this, ppszItemIDs, cItems, hwndOwner, ref pSessionCreator, ref punk);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandler self, out char16* ppszName) GetName;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandler self, IntBool fActivate) Activate;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandler self, IntBool fEnable) Enable;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandler self, char16** ppszItemIDs, uint32 cItems, HWnd hwndOwner, ref ISyncMgrSessionCreator pSessionCreator, ref IUnknown punk) Synchronize;
			}
		}
		[CRepr]
		public struct ISyncMgrHandlerInfo : IUnknown
		{
			...
			public HResult GetTypeLabel(out char16* ppszTypeLabel) mut => VT.GetTypeLabel(ref this, out ppszTypeLabel);
			public HResult GetComment(out char16* ppszComment) mut => VT.GetComment(ref this, out ppszComment);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandlerInfo self, out char16* ppszTypeLabel) GetTypeLabel;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrHandlerInfo self, out char16* ppszComment) GetComment;
		...
		public struct ISyncMgrSyncItemContainer : IUnknown
		{
			...
			public HResult GetSyncItem(char16* pszItemID, out ISyncMgrSyncItem* ppItem) mut => VT.GetSyncItem(ref this, pszItemID, out ppItem);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItemContainer self, char16* pszItemID, out ISyncMgrSyncItem* ppItem) GetSyncItem;
		...
		public struct ISyncMgrSyncItem : IUnknown
		{
			...
			public HResult GetItemID(out char16* ppszItemID) mut => VT.GetItemID(ref this, out ppszItemID);
			public HResult GetName(out char16* ppszName) mut => VT.GetName(ref this, out ppszName);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItem self, out char16* ppszItemID) GetItemID;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItem self, out char16* ppszName) GetName;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItem self, IntBool fEnable) Enable;
		...
		public struct ISyncMgrSyncItemInfo : IUnknown
		{
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItemInfo self, out char16* ppszTypeLabel) GetTypeLabel;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncItemInfo self, out char16* ppszComment) GetComment;
		...
		public struct ISyncMgrSessionCreator : IUnknown
		{
			...
			public HResult CreateSession(char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems, out ISyncMgrSyncCallback* ppCallback) mut => VT.CreateSession(ref this, pszHandlerID, ppszItemIDs, cItems, out ppCallback);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSessionCreator self, char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems, out ISyncMgrSyncCallback* ppCallback) CreateSession;
			}
		}
		[CRepr]
		public struct ISyncMgrSyncCallback : IUnknown
		{
			...
			public HResult ReportProgress(char16* pszItemID, char16* pszProgressText, SYNCMGR_PROGRESS_STATUS nStatus, uint32 uCurrentStep, uint32 uMaxStep, out SYNCMGR_CANCEL_REQUEST pnCancelRequest) mut => VT.ReportProgress(ref this, pszItemID, pszProgressText, nStatus, uCurrentStep, uMaxStep, out pnCancelRequest);
			public HResult SetHandlerProgressText(char16* pszProgressText, out SYNCMGR_CANCEL_REQUEST pnCancelRequest) mut => VT.SetHandlerProgressText(ref this, pszProgressText, out pnCancelRequest);
			public HResult ReportEvent(char16* pszItemID, SYNCMGR_EVENT_LEVEL nLevel, SYNCMGR_EVENT_FLAGS nFlags, char16* pszName, char16* pszDescription, char16* pszLinkText, char16* pszLinkReference, char16* pszContext, out Guid pguidEventID) mut => VT.ReportEvent(ref this, pszItemID, nLevel, nFlags, pszName, pszDescription, pszLinkText, pszLinkReference, pszContext, out pguidEventID);
			public HResult CanContinue(char16* pszItemID) mut => VT.CanContinue(ref this, pszItemID);
			...
			public HResult AddItemToSession(char16* pszItemID) mut => VT.AddItemToSession(ref this, pszItemID);
			...
			public HResult CommitItem(char16* pszItemID) mut => VT.CommitItem(ref this, pszItemID);
			public HResult ReportManualSync() mut => VT.ReportManualSync(ref this);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszItemID, char16* pszProgressText, SYNCMGR_PROGRESS_STATUS nStatus, uint32 uCurrentStep, uint32 uMaxStep, out SYNCMGR_CANCEL_REQUEST pnCancelRequest) ReportProgress;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszProgressText, out SYNCMGR_CANCEL_REQUEST pnCancelRequest) SetHandlerProgressText;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszItemID, SYNCMGR_EVENT_LEVEL nLevel, SYNCMGR_EVENT_FLAGS nFlags, char16* pszName, char16* pszDescription, char16* pszLinkText, char16* pszLinkReference, char16* pszContext, out Guid pguidEventID) ReportEvent;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszItemID) CanContinue;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszItemID) AddItemToSession;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSyncCallback self, char16* pszItemID) CommitItem;
		...
		public struct ISyncMgrScheduleWizardUIOperation : ISyncMgrUIOperation
		{
			...
			public HResult InitWizard(char16* pszHandlerID) mut => VT.InitWizard(ref this, pszHandlerID);

			[CRepr]
			public struct VTable : ISyncMgrUIOperation.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrScheduleWizardUIOperation self, char16* pszHandlerID) InitWizard;
			}
		}
		[CRepr]
		...
		public struct ISyncMgrControl : IUnknown
		{
			...
			public HResult StartHandlerSync(char16* pszHandlerID, HWnd hwndOwner, ref IUnknown punk, SYNCMGR_SYNC_CONTROL_FLAGS nSyncControlFlags, ref ISyncMgrSyncResult pResult) mut => VT.StartHandlerSync(ref this, pszHandlerID, hwndOwner, ref punk, nSyncControlFlags, ref pResult);
			public HResult StartItemSync(char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems, HWnd hwndOwner, ref IUnknown punk, SYNCMGR_SYNC_CONTROL_FLAGS nSyncControlFlags, ref ISyncMgrSyncResult pResult) mut => VT.StartItemSync(ref this, pszHandlerID, ppszItemIDs, cItems, hwndOwner, ref punk, nSyncControlFlags, ref pResult);
			public HResult StartSyncAll(HWnd hwndOwner) mut => VT.StartSyncAll(ref this, hwndOwner);
			public HResult StopHandlerSync(char16* pszHandlerID) mut => VT.StopHandlerSync(ref this, pszHandlerID);
			public HResult StopItemSync(char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems) mut => VT.StopItemSync(ref this, pszHandlerID, ppszItemIDs, cItems);
			...
			public HResult UpdateHandler(char16* pszHandlerID, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.UpdateHandler(ref this, pszHandlerID, nControlFlags);
			public HResult UpdateItem(char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.UpdateItem(ref this, pszHandlerID, pszItemID, nControlFlags);
			public HResult UpdateEvents(char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.UpdateEvents(ref this, pszHandlerID, pszItemID, nControlFlags);
			public HResult UpdateConflict(char16* pszHandlerID, char16* pszItemID, ref ISyncMgrConflict pConflict, SYNCMGR_UPDATE_REASON nReason) mut => VT.UpdateConflict(ref this, pszHandlerID, pszItemID, ref pConflict, nReason);
			public HResult UpdateConflicts(char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.UpdateConflicts(ref this, pszHandlerID, pszItemID, nControlFlags);
			public HResult ActivateHandler(IntBool fActivate, char16* pszHandlerID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.ActivateHandler(ref this, fActivate, pszHandlerID, hwndOwner, nControlFlags);
			public HResult EnableHandler(IntBool fEnable, char16* pszHandlerID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.EnableHandler(ref this, fEnable, pszHandlerID, hwndOwner, nControlFlags);
			public HResult EnableItem(IntBool fEnable, char16* pszHandlerID, char16* pszItemID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) mut => VT.EnableItem(ref this, fEnable, pszHandlerID, pszItemID, hwndOwner, nControlFlags);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, HWnd hwndOwner, ref IUnknown punk, SYNCMGR_SYNC_CONTROL_FLAGS nSyncControlFlags, ref ISyncMgrSyncResult pResult) StartHandlerSync;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems, HWnd hwndOwner, ref IUnknown punk, SYNCMGR_SYNC_CONTROL_FLAGS nSyncControlFlags, ref ISyncMgrSyncResult pResult) StartItemSync;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, HWnd hwndOwner) StartSyncAll;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID) StopHandlerSync;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16** ppszItemIDs, uint32 cItems) StopItemSync;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, SYNCMGR_CONTROL_FLAGS nControlFlags) UpdateHandler;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) UpdateItem;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) UpdateEvents;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16* pszItemID, ref ISyncMgrConflict pConflict, SYNCMGR_UPDATE_REASON nReason) UpdateConflict;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, char16* pszHandlerID, char16* pszItemID, SYNCMGR_CONTROL_FLAGS nControlFlags) UpdateConflicts;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, IntBool fActivate, char16* pszHandlerID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) ActivateHandler;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, IntBool fEnable, char16* pszHandlerID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) EnableHandler;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrControl self, IntBool fEnable, char16* pszHandlerID, char16* pszItemID, HWnd hwndOwner, SYNCMGR_CONTROL_FLAGS nControlFlags) EnableItem;
			}
		}
		[CRepr]
		...
		public struct ISyncMgrEvent : IUnknown
		{
			...
			public HResult GetHandlerID(char16** ppszHandlerID) mut => VT.GetHandlerID(ref this, ppszHandlerID);
			public HResult GetItemID(char16** ppszItemID) mut => VT.GetItemID(ref this, ppszItemID);
			...
			public HResult GetName(char16** ppszName) mut => VT.GetName(ref this, ppszName);
			public HResult GetDescription(char16** ppszDescription) mut => VT.GetDescription(ref this, ppszDescription);
			public HResult GetLinkText(char16** ppszLinkText) mut => VT.GetLinkText(ref this, ppszLinkText);
			public HResult GetLinkReference(char16** ppszLinkReference) mut => VT.GetLinkReference(ref this, ppszLinkReference);
			public HResult GetContext(char16** ppszContext) mut => VT.GetContext(ref this, ppszContext);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, out Guid pguidEventID) GetEventID;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszHandlerID) GetHandlerID;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszItemID) GetItemID;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszName) GetName;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszDescription) GetDescription;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszLinkText) GetLinkText;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszLinkReference) GetLinkReference;
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrEvent self, char16** ppszContext) GetContext;
			}
		}
		[CRepr]
		...
		public struct ISyncMgrConflictStore : IUnknown
		{
			...
			public HResult EnumConflicts(char16* pszHandlerID, char16* pszItemID, out IEnumSyncMgrConflict* ppEnum) mut => VT.EnumConflicts(ref this, pszHandlerID, pszItemID, out ppEnum);
			...
			public HResult GetCount(char16* pszHandlerID, char16* pszItemID, out uint32 pnConflicts) mut => VT.GetCount(ref this, pszHandlerID, pszItemID, out pnConflicts);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrConflictStore self, char16* pszHandlerID, char16* pszItemID, out IEnumSyncMgrConflict* ppEnum) EnumConflicts;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrConflictStore self, char16* pszHandlerID, char16* pszItemID, out uint32 pnConflicts) GetCount;
			}
		}
		[CRepr]
		...
		public struct ISyncMgrConflictResolveInfo : IUnknown
		{
			...
			public HResult GetPresenterChoice(out SYNCMGR_PRESENTER_CHOICE pnPresenterChoice, out IntBool pfApplyToAll) mut => VT.GetPresenterChoice(ref this, out pnPresenterChoice, out pfApplyToAll);
			...
			public HResult SetPresenterChoice(SYNCMGR_PRESENTER_CHOICE nPresenterChoice, IntBool fApplyToAll) mut => VT.SetPresenterChoice(ref this, nPresenterChoice, fApplyToAll);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrConflictResolveInfo self, out SYNCMGR_PRESENTER_CHOICE pnPresenterChoice, out IntBool pfApplyToAll) GetPresenterChoice;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrConflictResolveInfo self, SYNCMGR_PRESENTER_CHOICE nPresenterChoice, IntBool fApplyToAll) SetPresenterChoice;
		...
		public struct IShellImageDataFactory : IUnknown
		{
			...
			public HResult CreateImageFromFile(char16* pszPath, IShellImageData** ppshimg) mut => VT.CreateImageFromFile(ref this, pszPath, ppshimg);
			...
			public HResult GetDataFormatFromPath(char16* pszPath, out Guid pDataFormat) mut => VT.GetDataFormatFromPath(ref this, pszPath, out pDataFormat);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellImageDataFactory self, char16* pszPath, IShellImageData** ppshimg) CreateImageFromFile;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellImageDataFactory self, char16* pszPath, out Guid pDataFormat) GetDataFormatFromPath;
			}
		}
		[CRepr]
		public struct IShellImageData : IUnknown
		{
			...
			public HResult Draw(HDC hdc, out RectI prcDest, out RectI prcSrc) mut => VT.Draw(ref this, hdc, out prcDest, out prcSrc);
			...
			public HResult DisplayName(char16* wszName, uint32 cch) mut => VT.DisplayName(ref this, wszName, cch);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellImageData self, HDC hdc, out RectI prcDest, out RectI prcSrc) Draw;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IShellImageData self, char16* wszName, uint32 cch) DisplayName;
		...
		public struct IStorageProviderHandler : IUnknown
		{
			...
			public HResult GetPropertyHandlerFromPath(char16* path, out IStorageProviderPropertyHandler* propertyHandler) mut => VT.GetPropertyHandlerFromPath(ref this, path, out propertyHandler);
			public HResult GetPropertyHandlerFromUri(char16* uri, out IStorageProviderPropertyHandler* propertyHandler) mut => VT.GetPropertyHandlerFromUri(ref this, uri, out propertyHandler);
			public HResult GetPropertyHandlerFromFileId(char16* fileId, out IStorageProviderPropertyHandler* propertyHandler) mut => VT.GetPropertyHandlerFromFileId(ref this, fileId, out propertyHandler);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderHandler self, char16* path, out IStorageProviderPropertyHandler* propertyHandler) GetPropertyHandlerFromPath;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderHandler self, char16* uri, out IStorageProviderPropertyHandler* propertyHandler) GetPropertyHandlerFromUri;
				public new function [CallingConvention(.Stdcall)] HResult(ref IStorageProviderHandler self, char16* fileId, out IStorageProviderPropertyHandler* propertyHandler) GetPropertyHandlerFromFileId;
			}
		}
		[CRepr]
		public struct ISyncMgrSynchronizeCallback : IUnknown
		{
			...
			public HResult LogError(uint32 dwErrorLevel, char16* pszErrorText, in SYNCMGRLOGERRORINFO pSyncLogError) mut => VT.LogError(ref this, dwErrorLevel, pszErrorText, pSyncLogError);
			public HResult DeleteLogError(in Guid ErrorID, uint32 dwReserved) mut => VT.DeleteLogError(ref this, ErrorID, dwReserved);
			public HResult EstablishConnection(char16* pwszConnection, uint32 dwReserved) mut => VT.EstablishConnection(ref this, pwszConnection, dwReserved);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSynchronizeCallback self, IntBool fEnable) EnableModeless;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSynchronizeCallback self, uint32 dwErrorLevel, char16* pszErrorText, in SYNCMGRLOGERRORINFO pSyncLogError) LogError;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrSynchronizeCallback self, char16* pwszConnection, uint32 dwReserved) EstablishConnection;
			}
		}
		[CRepr]
		...
		public struct ISyncMgrRegister : IUnknown
		{
			...
			public HResult RegisterSyncMgrHandler(in Guid clsidHandler, char16* pwszDescription, uint32 dwSyncMgrRegisterFlags) mut => VT.RegisterSyncMgrHandler(ref this, clsidHandler, pwszDescription, dwSyncMgrRegisterFlags);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ISyncMgrRegister self, in Guid clsidHandler, char16* pwszDescription, uint32 dwSyncMgrRegisterFlags) RegisterSyncMgrHandler;
		...
		public struct IThumbnailStreamCache : IUnknown
		{
			...
			public HResult GetThumbnailStream(char16* path, uint64 cacheId, ThumbnailStreamCacheOptions options, uint32 requestedThumbnailSize, out SIZE thumbnailSize, out IStream* thumbnailStream) mut => VT.GetThumbnailStream(ref this, path, cacheId, options, requestedThumbnailSize, out thumbnailSize, out thumbnailStream);
			public HResult SetThumbnailStream(char16* path, uint64 cacheId, SIZE thumbnailSize, ref IStream thumbnailStream) mut => VT.SetThumbnailStream(ref this, path, cacheId, thumbnailSize, ref thumbnailStream);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IThumbnailStreamCache self, char16* path, uint64 cacheId, ThumbnailStreamCacheOptions options, uint32 requestedThumbnailSize, out SIZE thumbnailSize, out IStream* thumbnailStream) GetThumbnailStream;
				public new function [CallingConvention(.Stdcall)] HResult(ref IThumbnailStreamCache self, char16* path, uint64 cacheId, SIZE thumbnailSize, ref IStream thumbnailStream) SetThumbnailStream;
			}
		}
		[CRepr]
		public struct ITravelLogEntry : IUnknown
		{
			...
			public HResult GetTitle(out char16* ppszTitle) mut => VT.GetTitle(ref this, out ppszTitle);
			public HResult GetURL(out char16* ppszURL) mut => VT.GetURL(ref this, out ppszURL);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLogEntry self, out char16* ppszTitle) GetTitle;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLogEntry self, out char16* ppszURL) GetURL;
			}
		}
		[CRepr]
		public struct ITravelLogClient : IUnknown
		{
			...
			public HResult LoadHistoryPosition(char16* pszUrlLocation, uint32 dwPosition) mut => VT.LoadHistoryPosition(ref this, pszUrlLocation, dwPosition);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLogClient self, char16* pszUrlLocation, uint32 dwPosition) LoadHistoryPosition;
			}
		}
		[CRepr]
		...
		public struct ITravelLogStg : IUnknown
		{
			...
			public HResult CreateEntry(char16* pszUrl, char16* pszTitle, ref ITravelLogEntry ptleRelativeTo, IntBool fPrepend, out ITravelLogEntry* pptle) mut => VT.CreateEntry(ref this, pszUrl, pszTitle, ref ptleRelativeTo, fPrepend, out pptle);
			...
			public HResult FindEntries(TLENUMF flags, char16* pszUrl, out IEnumTravelLogEntry* ppenum) mut => VT.FindEntries(ref this, flags, pszUrl, out ppenum);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLogStg self, char16* pszUrl, char16* pszTitle, ref ITravelLogEntry ptleRelativeTo, IntBool fPrepend, out ITravelLogEntry* pptle) CreateEntry;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLogStg self, TLENUMF flags, char16* pszUrl, out IEnumTravelLogEntry* ppenum) FindEntries;
		...
		public struct IHlink : IUnknown
		{
			...
			public HResult SetMonikerReference(uint32 grfHLSETF, ref IMoniker pimkTarget, char16* pwzLocation) mut => VT.SetMonikerReference(ref this, grfHLSETF, ref pimkTarget, pwzLocation);
			public HResult GetMonikerReference(uint32 dwWhichRef, IMoniker** ppimkTarget, char16** ppwzLocation) mut => VT.GetMonikerReference(ref this, dwWhichRef, ppimkTarget, ppwzLocation);
			public HResult SetStringReference(uint32 grfHLSETF, char16* pwzTarget, char16* pwzLocation) mut => VT.SetStringReference(ref this, grfHLSETF, pwzTarget, pwzLocation);
			public HResult GetStringReference(uint32 dwWhichRef, char16** ppwzTarget, char16** ppwzLocation) mut => VT.GetStringReference(ref this, dwWhichRef, ppwzTarget, ppwzLocation);
			public HResult SetFriendlyName(char16* pwzFriendlyName) mut => VT.SetFriendlyName(ref this, pwzFriendlyName);
			public HResult GetFriendlyName(uint32 grfHLFNAMEF, out char16* ppwzFriendlyName) mut => VT.GetFriendlyName(ref this, grfHLFNAMEF, out ppwzFriendlyName);
			public HResult SetTargetFrameName(char16* pwzTargetFrameName) mut => VT.SetTargetFrameName(ref this, pwzTargetFrameName);
			public HResult GetTargetFrameName(out char16* ppwzTargetFrameName) mut => VT.GetTargetFrameName(ref this, out ppwzTargetFrameName);
			...
			public HResult SetAdditionalParams(char16* pwzAdditionalParams) mut => VT.SetAdditionalParams(ref this, pwzAdditionalParams);
			public HResult GetAdditionalParams(out char16* ppwzAdditionalParams) mut => VT.GetAdditionalParams(ref this, out ppwzAdditionalParams);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, uint32 grfHLSETF, ref IMoniker pimkTarget, char16* pwzLocation) SetMonikerReference;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, uint32 dwWhichRef, IMoniker** ppimkTarget, char16** ppwzLocation) GetMonikerReference;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, uint32 grfHLSETF, char16* pwzTarget, char16* pwzLocation) SetStringReference;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, uint32 dwWhichRef, char16** ppwzTarget, char16** ppwzLocation) GetStringReference;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, char16* pwzFriendlyName) SetFriendlyName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, uint32 grfHLFNAMEF, out char16* ppwzFriendlyName) GetFriendlyName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, char16* pwzTargetFrameName) SetTargetFrameName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, out char16* ppwzTargetFrameName) GetTargetFrameName;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, char16* pwzAdditionalParams) SetAdditionalParams;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlink self, out char16* ppwzAdditionalParams) GetAdditionalParams;
			}
		}
		[CRepr]
		public struct IHlinkSite : IUnknown
		{
			...
			public HResult OnNavigationComplete(uint32 dwSiteData, uint32 dwreserved, HResult hrError, char16* pwzError) mut => VT.OnNavigationComplete(ref this, dwSiteData, dwreserved, hrError, pwzError);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkSite self, uint32 dwSiteData, uint32 dwreserved, HResult hrError, char16* pwzError) OnNavigationComplete;
			}
		}
		[CRepr]
		public struct IHlinkTarget : IUnknown
		{
			...
			public HResult Navigate(uint32 grfHLNF, char16* pwzJumpLocation) mut => VT.Navigate(ref this, grfHLNF, pwzJumpLocation);
			public HResult GetMoniker(char16* pwzLocation, uint32 dwAssign, out IMoniker* ppimkLocation) mut => VT.GetMoniker(ref this, pwzLocation, dwAssign, out ppimkLocation);
			public HResult GetFriendlyName(char16* pwzLocation, out char16* ppwzFriendlyName) mut => VT.GetFriendlyName(ref this, pwzLocation, out ppwzFriendlyName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkTarget self, uint32 grfHLNF, char16* pwzJumpLocation) Navigate;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkTarget self, char16* pwzLocation, uint32 dwAssign, out IMoniker* ppimkLocation) GetMoniker;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkTarget self, char16* pwzLocation, out char16* ppwzFriendlyName) GetFriendlyName;
			}
		}
		[CRepr]
		public struct IHlinkFrame : IUnknown
		{
			...
			public HResult OnNavigate(uint32 grfHLNF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName, uint32 dwreserved) mut => VT.OnNavigate(ref this, grfHLNF, ref pimkTarget, pwzLocation, pwzFriendlyName, dwreserved);
			public HResult UpdateHlink(uint32 uHLID, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) mut => VT.UpdateHlink(ref this, uHLID, ref pimkTarget, pwzLocation, pwzFriendlyName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkFrame self, uint32 grfHLNF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName, uint32 dwreserved) OnNavigate;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkFrame self, uint32 uHLID, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) UpdateHlink;
			}
		}
		[CRepr]
		...
		public struct IHlinkBrowseContext : IUnknown
		{
			...
			public HResult GetObject(ref IMoniker pimk, IntBool fBindIfRootRegistered, out IUnknown* ppiunk) mut => VT.GetObject(ref this, ref pimk, fBindIfRootRegistered, out ppiunk);
			...
			public HResult SetInitialHlink(ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) mut => VT.SetInitialHlink(ref this, ref pimkTarget, pwzLocation, pwzFriendlyName);
			public HResult OnNavigateHlink(uint32 grfHLNF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName, out uint32 puHLID) mut => VT.OnNavigateHlink(ref this, grfHLNF, ref pimkTarget, pwzLocation, pwzFriendlyName, out puHLID);
			public HResult UpdateHlink(uint32 uHLID, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) mut => VT.UpdateHlink(ref this, uHLID, ref pimkTarget, pwzLocation, pwzFriendlyName);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkBrowseContext self, ref IMoniker pimk, IntBool fBindIfRootRegistered, out IUnknown* ppiunk) GetObject;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkBrowseContext self, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) SetInitialHlink;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkBrowseContext self, uint32 grfHLNF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName, out uint32 puHLID) OnNavigateHlink;
				public new function [CallingConvention(.Stdcall)] HResult(ref IHlinkBrowseContext self, uint32 uHLID, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName) UpdateHlink;
		...
		public struct IExtensionServices : IUnknown
		{
			...
			public HResult SetAdditionalHeaders(char16* pwzAdditionalHeaders) mut => VT.SetAdditionalHeaders(ref this, pwzAdditionalHeaders);
			public HResult SetAuthenticateData(HWnd phwnd, char16* pwzUsername, char16* pwzPassword) mut => VT.SetAuthenticateData(ref this, phwnd, pwzUsername, pwzPassword);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtensionServices self, char16* pwzAdditionalHeaders) SetAdditionalHeaders;
				public new function [CallingConvention(.Stdcall)] HResult(ref IExtensionServices self, HWnd phwnd, char16* pwzUsername, char16* pwzPassword) SetAuthenticateData;
			}
		}
		[CRepr]
		public struct ITravelEntry : IUnknown
		{
			...
			public HResult Update(IUnknown* punk, IntBool fIsLocalAnchor) mut => VT.Update(ref this, punk, fIsLocalAnchor);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelEntry self, IUnknown* punk, IntBool fIsLocalAnchor) Update;
		...
		public struct ITravelLog : IUnknown
		{
			...
			public HResult AddEntry(IUnknown* punk, IntBool fIsLocalAnchor) mut => VT.AddEntry(ref this, punk, fIsLocalAnchor);
			public HResult UpdateEntry(IUnknown* punk, IntBool fIsLocalAnchor) mut => VT.UpdateEntry(ref this, punk, fIsLocalAnchor);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLog self, IUnknown* punk, IntBool fIsLocalAnchor) AddEntry;
				public new function [CallingConvention(.Stdcall)] HResult(ref ITravelLog self, IUnknown* punk, IntBool fIsLocalAnchor) UpdateEntry;
		...
		public struct CIE4ConnectionPoint : IConnectionPoint
		{
			...
			public HResult DoInvokeIE4(out IntBool pf, void** ppv, int32 dispid, out DISPPARAMS pdispparams) mut => VT.DoInvokeIE4(ref this, out pf, ppv, dispid, out pdispparams);
			public HResult DoInvokePIDLIE4(int32 dispid, out ITEMIDLIST pidl, IntBool fCanCancel) mut => VT.DoInvokePIDLIE4(ref this, dispid, out pidl, fCanCancel);

			[CRepr]
			public struct VTable : IConnectionPoint.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref CIE4ConnectionPoint self, out IntBool pf, void** ppv, int32 dispid, out DISPPARAMS pdispparams) DoInvokeIE4;
				public new function [CallingConvention(.Stdcall)] HResult(ref CIE4ConnectionPoint self, int32 dispid, out ITEMIDLIST pidl, IntBool fCanCancel) DoInvokePIDLIE4;
			}
		}
		[CRepr]
		...
		public struct IBrowserService : IUnknown
		{
			...
			public HResult SetTitle(ref IShellView psv, char16* pszName) mut => VT.SetTitle(ref this, ref psv, pszName);
			...
			public HResult ShowControlWindow(uint32 id, IntBool fShow) mut => VT.ShowControlWindow(ref this, id, fShow);
			public HResult IsControlWindowShown(uint32 id, out IntBool pfShown) mut => VT.IsControlWindowShown(ref this, id, out pfShown);
			public HResult IEGetDisplayName(ref ITEMIDLIST pidl, char16* pwszName, uint32 uFlags) mut => VT.IEGetDisplayName(ref this, ref pidl, pwszName, uFlags);
			public HResult IEParseDisplayName(uint32 uiCP, char16* pwszPath, out ITEMIDLIST* ppidlOut) mut => VT.IEParseDisplayName(ref this, uiCP, pwszPath, out ppidlOut);
			public HResult DisplayParseError(HResult hres, char16* pwszPath) mut => VT.DisplayParseError(ref this, hres, pwszPath);
			...
			public HResult NotifyRedirect(ref IShellView psv, ref ITEMIDLIST pidl, out IntBool pfDidBrowse) mut => VT.NotifyRedirect(ref this, ref psv, ref pidl, out pfDidBrowse);
			...
			public HResult SetHistoryObject(ref IOleObject pole, IntBool fIsLocalAnchor) mut => VT.SetHistoryObject(ref this, ref pole, fIsLocalAnchor);
			...
			public HResult OnHttpEquiv(ref IShellView psv, IntBool fDone, ref VARIANT pvarargIn, out VARIANT pvarargOut) mut => VT.OnHttpEquiv(ref this, ref psv, fDone, ref pvarargIn, out pvarargOut);
			public HResult GetPalette(out HPALETTE hpal) mut => VT.GetPalette(ref this, out hpal);
			public HResult RegisterWindow(IntBool fForceRegister, int32 swc) mut => VT.RegisterWindow(ref this, fForceRegister, swc);
			...
			public struct VTable : IUnknown.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, ref IShellView psv, char16* pszName) SetTitle;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, uint32 id, IntBool fShow) ShowControlWindow;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, uint32 id, out IntBool pfShown) IsControlWindowShown;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, ref ITEMIDLIST pidl, char16* pwszName, uint32 uFlags) IEGetDisplayName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, uint32 uiCP, char16* pwszPath, out ITEMIDLIST* ppidlOut) IEParseDisplayName;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, HResult hres, char16* pwszPath) DisplayParseError;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, ref IShellView psv, ref ITEMIDLIST pidl, out IntBool pfDidBrowse) NotifyRedirect;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, ref IOleObject pole, IntBool fIsLocalAnchor) SetHistoryObject;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, ref IShellView psv, IntBool fDone, ref VARIANT pvarargIn, out VARIANT pvarargOut) OnHttpEquiv;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, out HPALETTE hpal) GetPalette;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService self, IntBool fForceRegister, int32 swc) RegisterWindow;
			}
		}
		[CRepr]
		...
		public struct IBrowserService2 : IBrowserService
		{
			...
			public HResult GetViewRect(out RectI prc) mut => VT.GetViewRect(ref this, out prc);
			...
			public HResult OnFrameWindowActivateBS(IntBool fActive) mut => VT.OnFrameWindowActivateBS(ref this, fActive);
			...
			public HResult CreateViewWindow(ref IShellView psvNew, ref IShellView psvOld, ref RectI prcView, out HWnd phwnd) mut => VT.CreateViewWindow(ref this, ref psvNew, ref psvOld, ref prcView, out phwnd);
			...
			public HResult AllowViewResize(IntBool f) mut => VT.AllowViewResize(ref this, f);
			...
			public HResult _PauseOrResumeView(IntBool fPaused) mut => VT._PauseOrResumeView(ref this, fPaused);
			...
			public HResult _ExecChildren(ref IUnknown punkBar, IntBool fBroadcast, Guid* pguidCmdGroup, uint32 nCmdID, uint32 nCmdexecopt, VARIANT* pvarargIn, VARIANT* pvarargOut) mut => VT._ExecChildren(ref this, ref punkBar, fBroadcast, pguidCmdGroup, nCmdID, nCmdexecopt, pvarargIn, pvarargOut);
			public HResult _SendChildren(HWnd hwndBar, IntBool fBroadcast, uint32 uMsg, WPARAM wParam, LPARAM lParam) mut => VT._SendChildren(ref this, hwndBar, fBroadcast, uMsg, wParam, lParam);
			...
			public HResult v_ShowHideChildWindows(IntBool fChildOnly) mut => VT.v_ShowHideChildWindows(ref this, fChildOnly);
			...
			public HResult _GetViewBorderRect(out RectI prc) mut => VT._GetViewBorderRect(ref this, out prc);
			...
			public HResult _GetEffectiveClientArea(out RectI lprectBorder, HMONITOR hmon) mut => VT._GetEffectiveClientArea(ref this, out lprectBorder, hmon);
			public IStream* v_GetViewStream(out ITEMIDLIST pidl, uint32 grfMode, char16* pwszName) mut => VT.v_GetViewStream(ref this, out pidl, grfMode, pwszName);
			...
			public HResult _CloseAndReleaseToolbars(IntBool fClose) mut => VT._CloseAndReleaseToolbars(ref this, fClose);
			...
			public HResult _ResizeNextBorderHelper(uint32 itb, IntBool bUseHmonitor) mut => VT._ResizeNextBorderHelper(ref this, itb, bUseHmonitor);
			...
			public HResult _GetBorderDWHelper(ref IUnknown punkSrc, out RectI lprectBorder, IntBool bUseHmonitor) mut => VT._GetBorderDWHelper(ref this, ref punkSrc, out lprectBorder, bUseHmonitor);
			...
			public struct VTable : IBrowserService.VTable
			{
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, out RectI prc) GetViewRect;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, IntBool fActive) OnFrameWindowActivateBS;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, ref IShellView psvNew, ref IShellView psvOld, ref RectI prcView, out HWnd phwnd) CreateViewWindow;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, IntBool f) AllowViewResize;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, IntBool fPaused) _PauseOrResumeView;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, ref IUnknown punkBar, IntBool fBroadcast, Guid* pguidCmdGroup, uint32 nCmdID, uint32 nCmdexecopt, VARIANT* pvarargIn, VARIANT* pvarargOut) _ExecChildren;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, HWnd hwndBar, IntBool fBroadcast, uint32 uMsg, WPARAM wParam, LPARAM lParam) _SendChildren;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, IntBool fChildOnly) v_ShowHideChildWindows;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, out RectI prc) _GetViewBorderRect;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, out RectI lprectBorder, HMONITOR hmon) _GetEffectiveClientArea;
				public new function [CallingConvention(.Stdcall)] IStream*(ref IBrowserService2 self, out ITEMIDLIST pidl, uint32 grfMode, char16* pwszName) v_GetViewStream;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, IntBool fClose) _CloseAndReleaseToolbars;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, uint32 itb, IntBool bUseHmonitor) _ResizeNextBorderHelper;
				...
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService2 self, ref IUnknown punkSrc, out RectI lprectBorder, IntBool bUseHmonitor) _GetBorderDWHelper;
		...
		public struct IBrowserService3 : IBrowserService2
		{
			...
			public HResult _PositionViewWindow(HWnd hwnd, ref RectI prc) mut => VT._PositionViewWindow(ref this, hwnd, ref prc);
			public HResult IEParseDisplayNameEx(uint32 uiCP, char16* pwszPath, uint32 dwFlags, out ITEMIDLIST* ppidlOut) mut => VT.IEParseDisplayNameEx(ref this, uiCP, pwszPath, dwFlags, out ppidlOut);

			[CRepr]
			public struct VTable : IBrowserService2.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService3 self, HWnd hwnd, ref RectI prc) _PositionViewWindow;
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService3 self, uint32 uiCP, char16* pwszPath, uint32 dwFlags, out ITEMIDLIST* ppidlOut) IEParseDisplayNameEx;
			}
		}
		[CRepr]
		public struct IBrowserService4 : IBrowserService3
		{
			...
			public HResult ActivateView(IntBool fPendingView) mut => VT.ActivateView(ref this, fPendingView);
			public HResult SaveViewState() mut => VT.SaveViewState(ref this);
			...
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IBrowserService4 self, IntBool fPendingView) ActivateView;
		...
		public struct IUniformResourceLocatorA : IUnknown
		{
			...
			public HResult SetURL(char8* pcszURL, uint32 dwInFlags) mut => VT.SetURL(ref this, pcszURL, dwInFlags);
			public HResult GetURL(out char8* ppszURL) mut => VT.GetURL(ref this, out ppszURL);
			public HResult InvokeCommand(out urlinvokecommandinfoA purlici) mut => VT.InvokeCommand(ref this, out purlici);

			[CRepr]
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IUniformResourceLocatorA self, char8* pcszURL, uint32 dwInFlags) SetURL;
				public new function [CallingConvention(.Stdcall)] HResult(ref IUniformResourceLocatorA self, out char8* ppszURL) GetURL;
		...
		public struct IUniformResourceLocatorW : IUnknown
		{
			...
			public HResult SetURL(char16* pcszURL, uint32 dwInFlags) mut => VT.SetURL(ref this, pcszURL, dwInFlags);
			public HResult GetURL(out char16* ppszURL) mut => VT.GetURL(ref this, out ppszURL);
			...
			public struct VTable : IUnknown.VTable
			{
				public new function [CallingConvention(.Stdcall)] HResult(ref IUniformResourceLocatorW self, char16* pcszURL, uint32 dwInFlags) SetURL;
				public new function [CallingConvention(.Stdcall)] HResult(ref IUniformResourceLocatorW self, out char16* ppszURL) GetURL;
		...
		public static extern IntBool LoadUserProfileA(Handle hToken, out PROFILEINFOA lpProfileInfo);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool LoadUserProfileW(Handle hToken, out PROFILEINFOW lpProfileInfo);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UnloadUserProfile(Handle hToken, Handle hProfile);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetProfilesDirectoryA(uint8* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetProfilesDirectoryW(char16* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetProfileType(out uint32 dwFlags);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DeleteProfileA(char8* lpSidString, char8* lpProfilePath, char8* lpComputerName);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DeleteProfileW(char16* lpSidString, char16* lpProfilePath, char16* lpComputerName);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult CreateProfile(char16* pszUserSid, char16* pszUserName, char16* pszProfilePath, uint32 cchProfilePath);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetDefaultUserProfileDirectoryA(uint8* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetDefaultUserProfileDirectoryW(char16* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetAllUsersProfileDirectoryA(uint8* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetAllUsersProfileDirectoryW(char16* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetUserProfileDirectoryA(Handle hToken, uint8* lpProfileDir, out uint32 lpcchSize);
		[Import("userenv.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetUserProfileDirectoryW(Handle hToken, char16* lpProfileDir, out uint32 lpcchSize);
		[Import("comctl32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SetWindowSubclass(HWnd hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass, uint dwRefData);
		[Import("comctl32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetWindowSubclass(HWnd hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass, uint* pdwRefData);
		[Import("comctl32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool RemoveWindowSubclass(HWnd hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass);
		[Import("comctl32.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LRESULT DefSubclassProc(HWnd hWnd, uint32 uMsg, WPARAM wParam, LPARAM lParam);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SetWindowContextHelpId(HWnd param0, uint32 param1);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 GetWindowContextHelpId(HWnd param0);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SetMenuContextHelpId(HMENU param0, uint32 param1);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 GetMenuContextHelpId(HMENU param0);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool WinHelpA(HWnd hWndMain, char8* lpszHelp, uint32 uCommand, uint dwData);
		[Import("user32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool WinHelpW(HWnd hWndMain, char16* lpszHelp, uint32 uCommand, uint dwData);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern ITEMIDLIST* SHSimpleIDListFromPath(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateItemFromIDList(ref ITEMIDLIST pidl, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateItemFromParsingName(char16* pszPath, IBindCtx* pbc, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateItemFromRelativeName(ref IShellItem psiParent, char16* pszName, IBindCtx* pbc, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateItemInKnownFolder(in Guid kfid, uint32 dwKFFlags, char16* pszItem, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetNameFromIDList(ref ITEMIDLIST pidl, SIGDN sigdnName, out char16* ppszName);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SetCurrentProcessExplicitAppUserModelID(char16* AppID);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult GetCurrentProcessExplicitAppUserModelID(out char16* AppID);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHShowManageLibraryUI(ref IShellItem psiLibrary, HWnd hwndOwner, char16* pszTitle, char16* pszInstruction, LIBRARYMANAGEDIALOGOPTIONS lmdOptions);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHResolveLibrary(ref IShellItem psiLibrary);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHAssocEnumHandlers(char16* pszExtra, ASSOC_FILTER afFilter, out IEnumAssocHandlers* ppEnumHandler);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHAssocEnumHandlersForProtocolByApplication(char16* protocol, in Guid riid, void** enumHandlers);
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHGetIconOverlayIndexA(char8* pszIconPath, int32 iIconIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHGetIconOverlayIndexW(char16* pszIconPath, int32 iIconIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ILRemoveLastID(ITEMIDLIST* pidl);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ILIsEqual(ref ITEMIDLIST pidl1, ref ITEMIDLIST pidl2);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ILIsParent(ref ITEMIDLIST pidl1, ref ITEMIDLIST pidl2, IntBool fImmediate);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern ITEMIDLIST* ILCreateFromPathA(char8* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern ITEMIDLIST* ILCreateFromPathW(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHILCreateFromPath(char16* pszPath, out ITEMIDLIST* ppidl, uint32* rgfInOut);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern ITEMIDLIST* ILAppendID(ITEMIDLIST* pidl, ref SHITEMID pmkid, IntBool fAppend);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetPathFromIDListEx(ref ITEMIDLIST pidl, char16* pszPath, uint32 cchPath, int32 uOpts);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetPathFromIDListA(ref ITEMIDLIST pidl, uint8* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetPathFromIDListW(ref ITEMIDLIST pidl, char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHCreateDirectory(HWnd hwnd, char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHCreateDirectoryExA(HWnd hwnd, char8* pszPath, SecurityAttributes* psa);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHCreateDirectoryExW(HWnd hwnd, char16* pszPath, SecurityAttributes* psa);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern ITEMIDLIST* SHCloneSpecialIDList(HWnd hwnd, int32 csidl, IntBool fCreate);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetSpecialFolderPathA(HWnd hwnd, uint8* pszPath, int32 csidl, IntBool fCreate);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetSpecialFolderPathW(HWnd hwnd, char16* pszPath, int32 csidl, IntBool fCreate);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHSetFolderPathA(int32 csidl, Handle hToken, uint32 dwFlags, char8* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHSetFolderPathW(int32 csidl, Handle hToken, uint32 dwFlags, char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetFolderPathAndSubDirA(HWnd hwnd, int32 csidl, Handle hToken, uint32 dwFlags, char8* pszSubDir, uint8* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetFolderPathAndSubDirW(HWnd hwnd, int32 csidl, Handle hToken, uint32 dwFlags, char16* pszSubDir, char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetKnownFolderIDList(in Guid rfid, uint32 dwFlags, Handle hToken, out ITEMIDLIST* ppidl);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHSetKnownFolderPath(in Guid rfid, uint32 dwFlags, Handle hToken, char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetKnownFolderPath(in Guid rfid, uint32 dwFlags, Handle hToken, out char16* ppszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetSetFolderCustomSettings(out SHFOLDERCUSTOMSETTINGS pfcs, char16* pszPath, uint32 dwReadWrite);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void SHUpdateImageA(char8* pszHashItem, int32 iIndex, uint32 uFlags, int32 iImageIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void SHUpdateImageW(char16* pszHashItem, int32 iIndex, uint32 uFlags, int32 iImageIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHChangeNotifyDeregister(uint32 ulID);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHChangeNotification_Unlock(Handle hLock);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 RestartDialog(HWnd hwnd, char16* pszPrompt, uint32 dwReturn);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 RestartDialogEx(HWnd hwnd, char16* pszPrompt, uint32 dwReturn, uint32 dwReasonCode);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCoCreateInstance(char16* pszCLSID, Guid* pclsid, IUnknown* pUnkOuter, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_SetDragImage(HIMAGELIST him, out POINT pptOffset);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_DragEnterEx(HWnd hwndTarget, POINT ptStart);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_DragEnterEx2(HWnd hwndTarget, POINT ptStart, IDataObject* pdtObject);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_ShowDragImage(IntBool fShow);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_DragMove(POINT pt);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_DragLeave();
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DAD_AutoScroll(HWnd hwnd, out AUTO_SCROLL_DATA pad, in POINT pptNow);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ReadCabinetState(out CABINETSTATE pcs, int32 cLength);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool WriteCabinetState(ref CABINETSTATE pcs);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMakeUniqueName(char16* pszUniqueName, uint32 cchMax, char16* pszTemplate, char16* pszLongPlate, char16* pszDir);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsExe(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern PCS_RET PathCleanupSpec(char16* pszDir, char16* pszSpec);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathResolve(char16* pszPath, uint16** dirs, PRF_FLAGS fFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool GetFileNameFromBrowse(HWnd hwnd, char16* pszFilePath, uint32 cchFilePath, char16* pszWorkingDir, char16* pszDefExt, char16* pszFilters, char16* pszTitle);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 DriveType(int32 iDrive);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 RealDriveType(int32 iDrive, IntBool fOKToHitNet);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHObjectProperties(HWnd hwnd, SHOP_TYPE shopObjectType, char16* pszObjectName, char16* pszPropertyPage);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IStream* OpenRegStream(HKey hkey, char16* pszSubkey, char16* pszValue, uint32 grfMode);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHFindFiles(ITEMIDLIST* pidlFolder, ITEMIDLIST* pidlSaveFile);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathGetShortPath(char16* pszLongPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathYetAnotherMakeUniqueName(char16* pszUniqueName, char16* pszPath, char16* pszShort, char16* pszFileSpec);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool Win32DeleteFile(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 SHRestricted(RESTRICTIONS rest);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SignalFileOpen(ref ITEMIDLIST pidl);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocGetDetailsOfPropKey(ref IShellFolder psf, ref ITEMIDLIST pidl, in PROPERTYKEY pkey, out VARIANT pv, IntBool* pfFoundPropKey);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHStartNetConnectionDialogW(HWnd hwnd, char16* pszRemoteName, uint32 dwType);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHDefExtractIconA(char8* pszIconFile, int32 iIndex, uint32 uFlags, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHDefExtractIconW(char16* pszIconFile, int32 iIndex, uint32 uFlags, HICON* phiconLarge, HICON* phiconSmall, uint32 nIconSize);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHOpenWithDialog(HWnd hwndParent, in OPENASINFO poainfo);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool Shell_GetImageLists(HIMAGELIST* phiml, HIMAGELIST* phimlSmall);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 Shell_GetCachedImageIndex(char16* pwszIconPath, int32 iIconIndex, uint32 uIconFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 Shell_GetCachedImageIndexA(char8* pszIconPath, int32 iIconIndex, uint32 uIconFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 Shell_GetCachedImageIndexW(char16* pszIconPath, int32 iIconIndex, uint32 uIconFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHValidateUNC(HWnd hwndOwner, char16* pszFile, VALIDATEUNC_OPTION fConnect);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void SHSetInstanceExplorer(IUnknown* punk);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsUserAnAdmin();
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void SHGetSetSettings(SHELLSTATEA* lpss, SSF_MASK dwMask, IntBool bSet);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHParseDisplayName(char16* pszName, IBindCtx* pbc, out ITEMIDLIST* ppidl, uint32 sfgaoIn, uint32* psfgaoOut);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHPathPrepareForWriteA(HWnd hwnd, IUnknown* punkEnableModless, char8* pszPath, uint32 dwFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHPathPrepareForWriteW(HWnd hwnd, IUnknown* punkEnableModless, char16* pszPath, uint32 dwFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateFileExtractIconW(char16* pszFile, uint32 dwFileAttributes, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCLSIDFromString(char16* psz, out Guid pclsid);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PickIconDlg(HWnd hwnd, char16* pszIconPath, uint32 cchIconPath, int32* piIconIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult StgMakeUniqueName(ref IStorage pstgParent, char16* pszFileSpec, uint32 grfMode, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void SHChangeNotifyRegisterThread(SCNRT_STATUS status);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathQualify(char16* psz);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSlowA(char8* pszFile, uint32 dwAttr);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSlowW(char16* pszFile, uint32 dwAttr);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HPSXA SHCreatePropSheetExtArray(HKey hKey, char16* pszSubKey, uint32 max_iface);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHOpenPropSheetW(char16* pszCaption, HKey* ahkeys, uint32 ckeys, Guid* pclsidDefault, ref IDataObject pdtobj, IShellBrowser* psb, char16* pStartPage);
		[Import("shdocvw.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 SoftwareUpdateMessageBox(HWnd hWnd, char16* pszDistUnit, uint32 dwFlags, SOFTDISTINFO* psdi);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shdocvw.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ImportPrivacySettings(char16* pszFilename, out IntBool pfParsePrivacyPreferences, out IntBool pfParsePerSiteRules);
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern char16** CommandLineToArgvW(char16* lpCmdLine, out int32 pNumArgs);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool DragQueryPoint(HDROP hDrop, out POINT ppt);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void DragFinish(HDROP hDrop);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern void DragAcceptFiles(HWnd hWnd, IntBool fAccept);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HInstance ShellExecuteA(HWnd hwnd, char8* lpOperation, char8* lpFile, char8* lpParameters, char8* lpDirectory, int32 nShowCmd);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HInstance ShellExecuteW(HWnd hwnd, char16* lpOperation, char16* lpFile, char16* lpParameters, char16* lpDirectory, int32 nShowCmd);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HInstance FindExecutableA(char8* lpFile, char8* lpDirectory, uint8* lpResult);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HInstance FindExecutableW(char16* lpFile, char16* lpDirectory, char16* lpResult);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ShellAboutA(HWnd hWnd, char8* szApp, char8* szOtherStuff, HICON hIcon);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ShellAboutW(HWnd hWnd, char16* szApp, char16* szOtherStuff, HICON hIcon);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HICON ExtractIconA(HInstance hInst, char8* pszExeFileName, uint32 nIconIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HICON ExtractIconW(HInstance hInst, char16* pszExeFileName, uint32 nIconIndex);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 ExtractIconExA(char8* lpszFile, int32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIcons);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 ExtractIconExW(char16* lpszFile, int32 nIconIndex, HICON* phiconLarge, HICON* phiconSmall, uint32 nIcons);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ShellExecuteExA(out SHELLEXECUTEINFOA pExecInfo);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ShellExecuteExW(out SHELLEXECUTEINFOW pExecInfo);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHCreateProcessAsUserW(out SHCREATEPROCESSINFOW pscpi);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHEvaluateSystemCommandTemplate(char16* pszCmdTemplate, out char16* ppszApplication, char16** ppszCommandLine, char16** ppszParameters);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocCreateForClasses(ASSOCIATIONELEMENT* rgClasses, uint32 cClasses, in Guid riid, void** ppv);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHQueryRecycleBinA(char8* pszRootPath, out SHQUERYRBINFO pSHQueryRBInfo);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHQueryRecycleBinW(char16* pszRootPath, out SHQUERYRBINFO pSHQueryRBInfo);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHEmptyRecycleBinA(HWnd hwnd, char8* pszRootPath, uint32 dwFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHEmptyRecycleBinW(HWnd hwnd, char16* pszRootPath, uint32 dwFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHQueryUserNotificationState(out QUERY_USER_NOTIFICATION_STATE pquns);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool Shell_NotifyIconA(NOTIFY_ICON_MESSAGE dwMessage, ref NOTIFYICONDATAA lpData);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool Shell_NotifyIconW(NOTIFY_ICON_MESSAGE dwMessage, ref NOTIFYICONDATAW lpData);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult Shell_NotifyIconGetRect(in NOTIFYICONIDENTIFIER identifier, out RectI iconLocation);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint SHGetFileInfoA(char8* pszPath, FILE_FLAGS_AND_ATTRIBUTES dwFileAttributes, SHFILEINFOA* psfi, uint32 cbFileInfo, SHGFI_FLAGS uFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern uint SHGetFileInfoW(char16* pszPath, FILE_FLAGS_AND_ATTRIBUTES dwFileAttributes, SHFILEINFOW* psfi, uint32 cbFileInfo, SHGFI_FLAGS uFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetStockIconInfo(SHSTOCKICONID siid, uint32 uFlags, out SHSTOCKICONINFO psii);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetDiskFreeSpaceExA(char8* pszDirectoryName, ULARGE_INTEGER* pulFreeBytesAvailableToCaller, ULARGE_INTEGER* pulTotalNumberOfBytes, ULARGE_INTEGER* pulTotalNumberOfFreeBytes);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetDiskFreeSpaceExW(char16* pszDirectoryName, ULARGE_INTEGER* pulFreeBytesAvailableToCaller, ULARGE_INTEGER* pulTotalNumberOfBytes, ULARGE_INTEGER* pulTotalNumberOfFreeBytes);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetNewLinkInfoA(char8* pszLinkTo, char8* pszDir, uint8* pszName, out IntBool pfMustCopy, uint32 uFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHGetNewLinkInfoW(char16* pszLinkTo, char16* pszDir, char16* pszName, out IntBool pfMustCopy, uint32 uFlags);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHInvokePrinterCommandA(HWnd hwnd, uint32 uAction, char8* lpBuf1, char8* lpBuf2, IntBool fModal);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHInvokePrinterCommandW(HWnd hwnd, uint32 uAction, char16* lpBuf1, char16* lpBuf2, IntBool fModal);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHLoadNonloadedIconOverlayIdentifiers();
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHIsFileAvailableOffline(char16* pwszPath, uint32* pdwStatus);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHSetLocalizedName(char16* pszPath, char16* pszResModule, int32 idsRes);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHRemoveLocalizedName(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetLocalizedName(char16* pszPath, char16* pszResModule, uint32 cch, out int32 pidsRes);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ShellMessageBoxA(HInstance hAppInst, HWnd hWnd, char8* lpcText, char8* lpcTitle, uint32 fuStyle);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 ShellMessageBoxW(HInstance hAppInst, HWnd hWnd, char16* lpcText, char16* lpcTitle, uint32 fuStyle);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsLFNDriveA(char8* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsLFNDriveW(char16* pszPath);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetUnreadMailCountW(HKey hKeyUser, char16* pszMailAddress, uint32* pdwCount, FileTime* pFileTime, char16* pszShellExecuteCommand, int32 cchShellExecuteCommand);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHSetUnreadMailCountW(char16* pszMailAddress, uint32 dwCount, char16* pszShellExecuteCommand);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHTestTokenMembership(Handle hToken, uint32 ulRID);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetImageList(int32 iImageList, in Guid riid, void** ppvObj);
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool InitNetworkAddressControl();
		[Import("shell32.lib"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetDriveMedia(char16* pszDrive, out uint32 pdwMediaContent);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrChrA(char8* pszStart, uint16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrChrW(char16* pszStart, char16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrChrIA(char8* pszStart, uint16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrChrIW(char16* pszStart, char16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrChrNW(char16* pszStart, char16 wMatch, uint32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrChrNIW(char16* pszStart, char16 wMatch, uint32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNA(char8* psz1, char8* psz2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNW(char16* psz1, char16* psz2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNIA(char8* psz1, char8* psz2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNIW(char16* psz1, char16* psz2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCSpnA(char8* pszStr, char8* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCSpnW(char16* pszStr, char16* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCSpnIA(char8* pszStr, char8* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCSpnIW(char16* pszStr, char16* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrDupA(char8* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrDupW(char16* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult StrFormatByteSizeEx(uint64 ull, SFBS_FLAGS flags, char16* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrFormatByteSizeA(uint32 dw, uint8* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrFormatByteSize64A(int64 qdw, uint8* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrFormatByteSizeW(int64 qdw, char16* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrFormatKBSizeW(int64 qdw, char16* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrFormatKBSizeA(int64 qdw, uint8* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrIsIntlEqualA(IntBool fCaseSens, char8* pszString1, char8* pszString2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrIsIntlEqualW(IntBool fCaseSens, char16* pszString1, char16* pszString2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrNCatA(uint8* psz1, char8* psz2, int32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrNCatW(char16* psz1, char16* psz2, int32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrPBrkA(char8* psz, char8* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrPBrkW(char16* psz, char16* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrRChrA(char8* pszStart, char8* pszEnd, uint16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrRChrW(char16* pszStart, char16* pszEnd, char16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrRChrIA(char8* pszStart, char8* pszEnd, uint16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrRChrIW(char16* pszStart, char16* pszEnd, char16 wMatch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrRStrIA(char8* pszSource, char8* pszLast, char8* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrRStrIW(char16* pszSource, char16* pszLast, char16* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrSpnA(char8* psz, char8* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrSpnW(char16* psz, char16* pszSet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrStrA(char8* pszFirst, char8* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrStrW(char16* pszFirst, char16* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrStrIA(char8* pszFirst, char8* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrStrIW(char16* pszFirst, char16* pszSrch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrStrNW(char16* pszFirst, char16* pszSrch, uint32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrStrNIW(char16* pszFirst, char16* pszSrch, uint32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrToIntA(char8* pszSrc);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrToIntW(char16* pszSrc);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrToIntExA(char8* pszString, int32 dwFlags, out int32 piRet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrToIntExW(char16* pszString, int32 dwFlags, out int32 piRet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrToInt64ExA(char8* pszString, int32 dwFlags, out int64 pllRet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrToInt64ExW(char16* pszString, int32 dwFlags, out int64 pllRet);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrTrimA(char8* psz, char8* pszTrimChars);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool StrTrimW(char16* psz, char16* pszTrimChars);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrCatW(char16* psz1, char16* psz2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpW(char16* psz1, char16* psz2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpIW(char16* psz1, char16* psz2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrCpyW(char16* psz1, char16* psz2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrCpyNW(char16* pszDst, char16* pszSrc, int32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* StrCatBuffW(char16* pszDest, char16* pszSrc, int32 cchDestBuffSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* StrCatBuffA(uint8* pszDest, char8* pszSrc, int32 cchDestBuffSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ChrCmpIA(uint16 w1, uint16 w2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool ChrCmpIW(char16 w1, char16 w2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 wvnsprintfA(uint8* pszDest, int32 cchDest, char8* pszFmt, ref int8 arglist);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 wvnsprintfW(char16* pszDest, int32 cchDest, char16* pszFmt, ref int8 arglist);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 wnsprintfA(uint8* pszDest, int32 cchDest, char8* pszFmt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 wnsprintfW(char16* pszDest, int32 cchDest, char16* pszFmt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult StrRetToStrA(out STRRET pstr, ITEMIDLIST* pidl, out char8* ppsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult StrRetToStrW(out STRRET pstr, ITEMIDLIST* pidl, out char16* ppsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHStrDupA(char8* psz, out char16* ppwsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHStrDupW(char16* psz, out char16* ppwsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpLogicalW(char16* psz1, char16* psz2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 StrCatChainW(char16* pszDst, uint32 cchDst, uint32 ichAt, char16* pszSrc);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult StrRetToBSTR(out STRRET pstr, ITEMIDLIST* pidl, out char16* pbstr);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHLoadIndirectString(char16* pszSource, char16* pszOutBuf, uint32 cchOutBuf, void** ppvReserved);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsCharSpaceA(char8 wch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsCharSpaceW(char16 wch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpCA(char8* pszStr1, char8* pszStr2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpCW(char16* pszStr1, char16* pszStr2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpICA(char8* pszStr1, char8* pszStr2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpICW(char16* pszStr1, char16* pszStr2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNCA(char8* pszStr1, char8* pszStr2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNCW(char16* pszStr1, char16* pszStr2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNICA(char8* pszStr1, char8* pszStr2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 StrCmpNICW(char16* pszStr1, char16* pszStr2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IntlStrEqWorkerA(IntBool fCaseSens, uint8* lpString1, uint8* lpString2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IntlStrEqWorkerW(IntBool fCaseSens, char16* lpString1, char16* lpString2, int32 nChar);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathAddBackslashA(uint8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathAddBackslashW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathAddExtensionA(uint8* pszPath, char8* pszExt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathAddExtensionW(char16* pszPath, char16* pszExt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathAppendA(uint8* pszPath, char8* pszMore);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathAppendW(char16* pszPath, char16* pszMore);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathBuildRootA(uint8* pszRoot, int32 iDrive);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathBuildRootW(char16* pszRoot, int32 iDrive);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCanonicalizeA(uint8* pszBuf, char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCanonicalizeW(char16* pszBuf, char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathCombineA(uint8* pszDest, char8* pszDir, char8* pszFile);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathCombineW(char16* pszDest, char16* pszDir, char16* pszFile);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCompactPathA(HDC hDC, uint8* pszPath, uint32 dx);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCompactPathW(HDC hDC, char16* pszPath, uint32 dx);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCompactPathExA(uint8* pszOut, char8* pszSrc, uint32 cchMax, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCompactPathExW(char16* pszOut, char16* pszSrc, uint32 cchMax, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathCommonPrefixA(char8* pszFile1, char8* pszFile2, uint8* achPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathCommonPrefixW(char16* pszFile1, char16* pszFile2, char16* achPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathFileExistsA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathFileExistsW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathFindExtensionA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathFindExtensionW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathFindFileNameA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathFindFileNameW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathFindNextComponentA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathFindNextComponentW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathFindOnPathA(uint8* pszPath, int8** ppszOtherDirs);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathFindOnPathW(char16* pszPath, uint16** ppszOtherDirs);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathFindSuffixArrayA(char8* pszPath, char8** apszSuffix, int32 iArraySize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathFindSuffixArrayW(char16* pszPath, char16** apszSuffix, int32 iArraySize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathGetArgsA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathGetArgsW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsLFNFileSpecA(char8* pszName);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsLFNFileSpecW(char16* pszName);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PathGetCharTypeA(uint8 ch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 PathGetCharTypeW(char16 ch);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathGetDriveNumberA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathGetDriveNumberW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsDirectoryA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsDirectoryW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsDirectoryEmptyA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsDirectoryEmptyW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsFileSpecA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsFileSpecW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsPrefixA(char8* pszPrefix, char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsPrefixW(char16* pszPrefix, char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsRelativeA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsRelativeW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsRootA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsRootW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSameRootA(char8* pszPath1, char8* pszPath2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSameRootW(char16* pszPath1, char16* pszPath2);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsNetworkPathA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsNetworkPathW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCServerA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCServerW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCServerShareA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCServerShareW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsContentTypeA(char8* pszPath, char8* pszContentType);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsContentTypeW(char16* pszPath, char16* pszContentType);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsURLA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsURLW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMakePrettyA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMakePrettyW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMatchSpecA(char8* pszFile, char8* pszSpec);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMatchSpecW(char16* pszFile, char16* pszSpec);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathMatchSpecExA(char8* pszFile, char8* pszSpec, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathMatchSpecExW(char16* pszFile, char16* pszSpec, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathParseIconLocationA(char8* pszIconFile);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 PathParseIconLocationW(char16* pszIconFile);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathQuoteSpacesA(uint8* lpsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathQuoteSpacesW(char16* lpsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRelativePathToA(uint8* pszPath, char8* pszFrom, uint32 dwAttrFrom, char8* pszTo, uint32 dwAttrTo);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRelativePathToW(char16* pszPath, char16* pszFrom, uint32 dwAttrFrom, char16* pszTo, uint32 dwAttrTo);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveArgsA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveArgsW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathRemoveBackslashA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathRemoveBackslashW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveBlanksA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveBlanksW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveExtensionA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathRemoveExtensionW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRemoveFileSpecA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRemoveFileSpecW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRenameExtensionA(uint8* pszPath, char8* pszExt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathRenameExtensionW(char16* pszPath, char16* pszExt);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathSearchAndQualifyA(char8* pszPath, uint8* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathSearchAndQualifyW(char16* pszPath, char16* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathSetDlgItemPathA(HWnd hDlg, int32 id, char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathSetDlgItemPathW(HWnd hDlg, int32 id, char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* PathSkipRootA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* PathSkipRootW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathStripPathA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathStripPathW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathStripToRootA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathStripToRootW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnquoteSpacesA(char8* lpsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnquoteSpacesW(char16* lpsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMakeSystemFolderA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathMakeSystemFolderW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnmakeSystemFolderA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnmakeSystemFolderW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSystemFolderA(char8* pszPath, uint32 dwAttrb);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsSystemFolderW(char16* pszPath, uint32 dwAttrb);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathUndecorateA(char8* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void PathUndecorateW(char16* pszPath);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnExpandEnvStringsA(char8* pszPath, uint8* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathUnExpandEnvStringsW(char16* pszPath, char16* pszBuf, uint32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 UrlCompareA(char8* psz1, char8* psz2, IntBool fIgnoreSlash);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 UrlCompareW(char16* psz1, char16* psz2, IntBool fIgnoreSlash);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCombineA(char8* pszBase, char8* pszRelative, uint8* pszCombined, out uint32 pcchCombined, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCombineW(char16* pszBase, char16* pszRelative, char16* pszCombined, out uint32 pcchCombined, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCanonicalizeA(char8* pszUrl, uint8* pszCanonicalized, out uint32 pcchCanonicalized, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCanonicalizeW(char16* pszUrl, char16* pszCanonicalized, out uint32 pcchCanonicalized, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsOpaqueA(char8* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsOpaqueW(char16* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsNoHistoryA(char8* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsNoHistoryW(char16* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsA(char8* pszUrl, URLIS UrlIs);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool UrlIsW(char16* pszUrl, URLIS UrlIs);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8* UrlGetLocationA(char8* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16* UrlGetLocationW(char16* pszURL);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlUnescapeA(char8* pszUrl, uint8* pszUnescaped, uint32* pcchUnescaped, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlUnescapeW(char16* pszUrl, char16* pszUnescaped, uint32* pcchUnescaped, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlEscapeA(char8* pszUrl, uint8* pszEscaped, out uint32 pcchEscaped, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlEscapeW(char16* pszUrl, char16* pszEscaped, out uint32 pcchEscaped, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCreateFromPathA(char8* pszPath, uint8* pszUrl, out uint32 pcchUrl, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlCreateFromPathW(char16* pszPath, char16* pszUrl, out uint32 pcchUrl, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCreateFromUrlA(char8* pszUrl, uint8* pszPath, out uint32 pcchPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCreateFromUrlW(char16* pszUrl, char16* pszPath, out uint32 pcchPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCreateFromUrlAlloc(char16* pszIn, out char16* ppszOut, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlHashA(char8* pszUrl, out uint8 pbHash, uint32 cbHash);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlHashW(char16* pszUrl, out uint8 pbHash, uint32 cbHash);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlGetPartW(char16* pszIn, char16* pszOut, out uint32 pcchOut, uint32 dwPart, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlGetPartA(char8* pszIn, uint8* pszOut, out uint32 pcchOut, uint32 dwPart, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlApplySchemeA(char8* pszIn, uint8* pszOut, out uint32 pcchOut, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlApplySchemeW(char16* pszIn, char16* pszOut, out uint32 pcchOut, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HashData(ref uint8 pbData, uint32 cbData, out uint8 pbHash, uint32 cbHash);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult UrlFixupW(char16* pcszUrl, char16* pszTranslatedUrl, uint32 cchMax);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult ParseURLA(char8* pcszURL, out PARSEDURLA ppu);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult ParseURLW(char16* pcszURL, out PARSEDURLW ppu);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteEmptyKeyA(HKey hkey, char8* pszSubKey);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteEmptyKeyW(HKey hkey, char16* pszSubKey);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteKeyA(HKey hkey, char8* pszSubKey);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteKeyW(HKey hkey, char16* pszSubKey);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HKey SHRegDuplicateHKey(HKey hkey);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteValueA(HKey hkey, char8* pszSubKey, char8* pszValue);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHDeleteValueW(HKey hkey, char16* pszSubKey, char16* pszValue);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHGetValueA(HKey hkey, char8* pszSubKey, char8* pszValue, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHGetValueW(HKey hkey, char16* pszSubKey, char16* pszValue, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHSetValueA(HKey hkey, char8* pszSubKey, char8* pszValue, uint32 dwType, void* pvData, uint32 cbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHSetValueW(HKey hkey, char16* pszSubKey, char16* pszValue, uint32 dwType, void* pvData, uint32 cbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetValueA(HKey hkey, char8* pszSubKey, char8* pszValue, int32 srrfFlags, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetValueW(HKey hkey, char16* pszSubKey, char16* pszValue, int32 srrfFlags, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetValueFromHKCUHKLM(char16* pwszKey, char16* pwszValue, int32 srrfFlags, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHQueryValueExA(HKey hkey, char8* pszValue, out uint32 pdwReserved, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHQueryValueExW(HKey hkey, char16* pszValue, out uint32 pdwReserved, uint32* pdwType, void* pvData, uint32* pcbData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHCopyKeyA(HKey hkeySrc, char8* pszSrcSubKey, HKey hkeyDest, uint32 fReserved);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHCopyKeyW(HKey hkeySrc, char16* pszSrcSubKey, HKey hkeyDest, uint32 fReserved);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetPathA(HKey hKey, char8* pcszSubKey, char8* pcszValue, uint8* pszPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetPathW(HKey hKey, char16* pcszSubKey, char16* pcszValue, char16* pszPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegSetPathA(HKey hKey, char8* pcszSubKey, char8* pcszValue, char8* pcszPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegSetPathW(HKey hKey, char16* pcszSubKey, char16* pcszValue, char16* pcszPath, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegCreateUSKeyA(char8* pszPath, uint32 samDesired, int hRelativeUSKey, out int phNewUSKey, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegCreateUSKeyW(char16* pwzPath, uint32 samDesired, int hRelativeUSKey, out int phNewUSKey, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegOpenUSKeyA(char8* pszPath, uint32 samDesired, int hRelativeUSKey, out int phNewUSKey, IntBool fIgnoreHKCU);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegOpenUSKeyW(char16* pwzPath, uint32 samDesired, int hRelativeUSKey, out int phNewUSKey, IntBool fIgnoreHKCU);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegQueryUSValueA(int hUSKey, char8* pszValue, uint32* pdwType, void* pvData, uint32* pcbData, IntBool fIgnoreHKCU, void* pvDefaultData, uint32 dwDefaultDataSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegQueryUSValueW(int hUSKey, char16* pszValue, uint32* pdwType, void* pvData, uint32* pcbData, IntBool fIgnoreHKCU, void* pvDefaultData, uint32 dwDefaultDataSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegWriteUSValueA(int hUSKey, char8* pszValue, uint32 dwType, void* pvData, uint32 cbData, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegWriteUSValueW(int hUSKey, char16* pwzValue, uint32 dwType, void* pvData, uint32 cbData, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegDeleteUSValueA(int hUSKey, char8* pszValue, SHREGDEL_FLAGS delRegFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegDeleteUSValueW(int hUSKey, char16* pwzValue, SHREGDEL_FLAGS delRegFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegDeleteEmptyUSKeyW(int hUSKey, char16* pwzSubKey, SHREGDEL_FLAGS delRegFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegDeleteEmptyUSKeyA(int hUSKey, char8* pszSubKey, SHREGDEL_FLAGS delRegFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetUSValueA(char8* pszSubKey, char8* pszValue, uint32* pdwType, void* pvData, uint32* pcbData, IntBool fIgnoreHKCU, void* pvDefaultData, uint32 dwDefaultDataSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegGetUSValueW(char16* pszSubKey, char16* pszValue, uint32* pdwType, void* pvData, uint32* pcbData, IntBool fIgnoreHKCU, void* pvDefaultData, uint32 dwDefaultDataSize);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegSetUSValueA(char8* pszSubKey, char8* pszValue, uint32 dwType, void* pvData, uint32 cbData, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern LSTATUS SHRegSetUSValueW(char16* pwzSubKey, char16* pwzValue, uint32 dwType, void* pvData, uint32 cbData, uint32 dwFlags);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHRegGetIntW(HKey hk, char16* pwzKey, int32 iDefault);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHRegGetBoolUSValueA(char8* pszSubKey, char8* pszValue, IntBool fIgnoreHKCU, IntBool fDefault);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHRegGetBoolUSValueW(char16* pszSubKey, char16* pszValue, IntBool fIgnoreHKCU, IntBool fDefault);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocCreate(Guid clsid, in Guid riid, void** ppv);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryStringA(uint32 flags, ASSOCSTR str, char8* pszAssoc, char8* pszExtra, uint8* pszOut, out uint32 pcchOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryStringW(uint32 flags, ASSOCSTR str, char16* pszAssoc, char16* pszExtra, char16* pszOut, out uint32 pcchOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryStringByKeyA(uint32 flags, ASSOCSTR str, HKey hkAssoc, char8* pszExtra, uint8* pszOut, out uint32 pcchOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryStringByKeyW(uint32 flags, ASSOCSTR str, HKey hkAssoc, char16* pszExtra, char16* pszOut, out uint32 pcchOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryKeyA(uint32 flags, ASSOCKEY key, char8* pszAssoc, char8* pszExtra, out HKey phkeyOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocQueryKeyW(uint32 flags, ASSOCKEY key, char16* pszAssoc, char16* pszExtra, out HKey phkeyOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool AssocIsDangerous(char16* pszAssoc);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult AssocGetPerceivedType(char16* pszExt, out PERCEIVED ptype, out uint32 pflag, char16** ppszType);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IStream* SHOpenRegStreamA(HKey hkey, char8* pszSubkey, char8* pszValue, uint32 grfMode);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IStream* SHOpenRegStreamW(HKey hkey, char16* pszSubkey, char16* pszValue, uint32 grfMode);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IStream* SHOpenRegStream2A(HKey hkey, char8* pszSubkey, char8* pszValue, uint32 grfMode);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IStream* SHOpenRegStream2W(HKey hkey, char16* pszSubkey, char16* pszValue, uint32 grfMode);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateStreamOnFileA(char8* pszFile, uint32 grfMode, out IStream* ppstm);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateStreamOnFileW(char16* pszFile, uint32 grfMode, out IStream* ppstm);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHCreateStreamOnFileEx(char16* pszFile, uint32 grfMode, uint32 dwAttributes, IntBool fCreate, IStream* pstmTemplate, out IStream* ppstm);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult ConnectToConnectionPoint(IUnknown* punk, in Guid riidEvent, IntBool fConnect, ref IUnknown punkTarget, out uint32 pdwCookie, IConnectionPoint** ppcpOut);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult IStream_ReadStr(ref IStream pstm, out char16* ppsz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult IStream_WriteStr(ref IStream pstm, char16* psz);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult IStream_Copy(ref IStream pstmFrom, ref IStream pstmTo, uint32 cb);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult SHGetViewStatePropertyBag(ITEMIDLIST* pidl, char16* pszBagName, uint32 dwFlags, in Guid riid, void** ppv);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHAnsiToUnicode(char8* pszSrc, char16* pwszDst, int32 cwchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHAnsiToAnsi(char8* pszSrc, uint8* pszDst, int32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHUnicodeToAnsi(char16* pwszSrc, uint8* pszDst, int32 cchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHUnicodeToUnicode(char16* pwzSrc, char16* pwzDst, int32 cwchBuf);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHMessageBoxCheckA(HWnd hwnd, char8* pszText, char8* pszCaption, uint32 uType, int32 iDefault, char8* pszRegVal);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern int32 SHMessageBoxCheckW(HWnd hwnd, char16* pszText, char16* pszCaption, uint32 uType, int32 iDefault, char16* pszRegVal);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char8 SHStripMneumonicA(char8* pszMenu);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern char16 SHStripMneumonicW(char16* pszMenu);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsOS(OS dwOS);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHFreeShared(Handle hData, uint32 dwProcessId);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern void* SHLockShared(Handle hData, uint32 dwProcessId);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHUnlockShared(void* pvData);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHIsLowMemoryMachine(uint32 dwType);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHSkipJunction(IBindCtx* pbc, in Guid pclsid);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHCreateThread(LPTHREAD_START_ROUTINE pfnThreadProc, void* pData, uint32 flags, LPTHREAD_START_ROUTINE pfnCallback);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool SHCreateThreadWithHandle(LPTHREAD_START_ROUTINE pfnThreadProc, void* pData, uint32 flags, LPTHREAD_START_ROUTINE pfnCallback, Handle* pHandle);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern uint32 ColorAdjustLuma(uint32 clrRGB, int32 n, IntBool fScale);
		[Import("shlwapi.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool IsInternetESCEnabled();
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateFromMoniker(ref IMoniker pimkTrgt, char16* pwzLocation, char16* pwzFriendlyName, ref IHlinkSite pihlsite, uint32 dwSiteData, ref IUnknown piunkOuter, in Guid riid, void** ppvObj);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateFromString(char16* pwzTarget, char16* pwzLocation, char16* pwzFriendlyName, ref IHlinkSite pihlsite, uint32 dwSiteData, ref IUnknown piunkOuter, in Guid riid, void** ppvObj);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkNavigateToStringReference(char16* pwzTarget, char16* pwzLocation, ref IHlinkSite pihlsite, uint32 dwSiteData, ref IHlinkFrame pihlframe, uint32 grfHLNF, ref IBindCtx pibc, ref IBindStatusCallback pibsc, ref IHlinkBrowseContext pihlbc);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkOnNavigate(ref IHlinkFrame pihlframe, ref IHlinkBrowseContext pihlbc, uint32 grfHLNF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzFriendlyName, out uint32 puHLID);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkUpdateStackItem(ref IHlinkFrame pihlframe, ref IHlinkBrowseContext pihlbc, uint32 uHLID, ref IMoniker pimkTrgt, char16* pwzLocation, char16* pwzFriendlyName);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		...
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkResolveStringForData(char16* pwzReference, uint32 reserved, ref IBindCtx pibc, uint32 cFmtetc, out FORMATETC rgFmtetc, ref IBindStatusCallback pibsc, ref IMoniker pimkBase);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkParseDisplayName(ref IBindCtx pibc, char16* pwzDisplayName, IntBool fNoForceAbs, out uint32 pcchEaten, out IMoniker* ppimk);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateExtensionServices(char16* pwzAdditionalHeaders, HWnd phwnd, char16* pszUsername, char16* pszPassword, ref IUnknown piunkOuter, in Guid riid, void** ppvObj);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkPreprocessMoniker(ref IBindCtx pibc, ref IMoniker pimkIn, out IMoniker* ppimkOut);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult OleSaveToStreamEx(ref IUnknown piunk, ref IStream pistm, IntBool fClearDirty);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkSetSpecialReference(uint32 uReference, char16* pwzReference);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkGetSpecialReference(uint32 uReference, out char16* ppwzReference);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateShortcut(uint32 grfHLSHORTCUTF, ref IHlink pihl, char16* pwzDir, char16* pwzFileName, out char16* ppwzShortcutFile, uint32 dwReserved);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateShortcutFromMoniker(uint32 grfHLSHORTCUTF, ref IMoniker pimkTarget, char16* pwzLocation, char16* pwzDir, char16* pwzFileName, out char16* ppwzShortcutFile, uint32 dwReserved);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkCreateShortcutFromString(uint32 grfHLSHORTCUTF, char16* pwzTarget, char16* pwzLocation, char16* pwzDir, char16* pwzFileName, out char16* ppwzShortcutFile, uint32 dwReserved);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkResolveShortcut(char16* pwzShortcutFileName, ref IHlinkSite pihlsite, uint32 dwSiteData, ref IUnknown piunkOuter, in Guid riid, void** ppvObj);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkResolveShortcutToMoniker(char16* pwzShortcutFileName, out IMoniker* ppimkTarget, out char16* ppwzLocation);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkResolveShortcutToString(char16* pwzShortcutFileName, out char16* ppwzTarget, out char16* ppwzLocation);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkIsShortcut(char16* pwzFileName);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkGetValueFromParams(char16* pwzParams, char16* pwzName, out char16* ppwzValue);
		[Import("hlink.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult HlinkTranslateURL(char16* pwzURL, uint32 grfFlags, out char16* ppwzTranslatedURL);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathIsUNCEx(char16* pszPath, char16** ppszServer);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern IntBool PathCchIsRoot(char16* pszPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchAddBackslashEx(char16* pszPath, uint cchPath, char16** ppszEnd, uint* pcchRemaining);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchAddBackslash(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchRemoveBackslashEx(char16* pszPath, uint cchPath, char16** ppszEnd, uint* pcchRemaining);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchRemoveBackslash(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchSkipRoot(char16* pszPath, out char16* ppszRootEnd);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchStripToRoot(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchRemoveFileSpec(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchFindExtension(char16* pszPath, uint cchPath, out char16* ppszExt);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchAddExtension(char16* pszPath, uint cchPath, char16* pszExt);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchRenameExtension(char16* pszPath, uint cchPath, char16* pszExt);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchRemoveExtension(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchCanonicalizeEx(char16* pszPathOut, uint cchPathOut, char16* pszPathIn, uint32 dwFlags);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchCanonicalize(char16* pszPathOut, uint cchPathOut, char16* pszPathIn);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchCombineEx(char16* pszPathOut, uint cchPathOut, char16* pszPathIn, char16* pszMore, uint32 dwFlags);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchCombine(char16* pszPathOut, uint cchPathOut, char16* pszPathIn, char16* pszMore);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchAppendEx(char16* pszPath, uint cchPath, char16* pszMore, uint32 dwFlags);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchAppend(char16* pszPath, uint cchPath, char16* pszMore);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathCchStripPrefix(char16* pszPath, uint cchPath);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathAllocCombine(char16* pszPathIn, char16* pszMore, uint32 dwFlags, out char16* ppszPathOut);
		[Import("api-ms-win-core-path-l1-1-0.dll"), CLink, CallingConvention(.Stdcall)]
		public static extern HResult PathAllocCanonicalize(char16* pszPathIn, uint32 dwFlags, out char16* ppszPathOut);
