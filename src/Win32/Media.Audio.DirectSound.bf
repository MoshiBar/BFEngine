...
namespace Win32
{
	extension Win32
	{
		...
		public enum BufferCapabilityFlags : uint32
		{
		...
		{
			public uint32 dwSize;
			public BufferCapabilityFlags dwFlags;
			public uint32 dwBufferBytes;
			public uint32 dwReserved;
			public WaveFormatEx* lpwfxFormat;
			public Guid guid3DAlgorithm;

			public this(BufferCapabilityFlags dwFlags, uint32 dwBufferBytes, WaveFormatEx* lpwfxFormat, Guid guid3DAlgorithm = default)
			{
